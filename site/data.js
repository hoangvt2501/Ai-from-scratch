...
// Last built: 2026-07-14T08:50:36.572Z
    ...
    "lessons": [
      {
        ...
        "summaryVi": "Các công cụ của bạn định hình suy nghĩ của bạn. Thiết lập chúng một lần, thiết lập đúng.",
        "keywordsVi": "Bước 1: Nền tảng hệ thống · Bước 2: Python với uv · Bước 3: Node.js với pnpm · Bước 4: Rust · Bước 5: Julia (Tùy chọn) · Bước 6: Thiết lập GPU (nếu có) · Bước 7: Xác minh mọi thứ"
      },
      {
        ...
        "summaryVi": "Kiểm soát phiên bản không phải là tùy chọn. Mọi thử nghiệm, mọi model, mọi bài học bạn xây dựng ở đây đều được theo dõi.",
        "keywordsVi": "Bước 1: Cấu hình git · Bước 2: Quy trình làm việc hàng ngày · Bước 3: Phân nhánh cho thử nghiệm · Bước 4: Làm việc với khóa học này repo"
      },
      {
        ...
        "summaryVi": "Training trên CPU là tốt cho việc học. Training thực sự cần một GPU.",
        "keywordsVi": "Lựa chọn 1: NVIDIA GPU địa phương · Tùy chọn 2: Google Colab · Lựa chọn 3: Cloud GPU · Không GPU? Không vấn đề gì."
      },
      {
        "name": "APIs & Keys",
        "status": "complete",
        ...
        "summaryVi": "Mọi AI API đều hoạt động theo cùng một cách: gửi yêu cầu, nhận phản hồi. Các chi tiết thay đổi, mô hình thì không.",
        "keywordsVi": "Bước 1: Lưu trữ chìa khóa API an toàn · Bước 2: Cuộc gọi API đầu tiên (Python) · Bước 3: Cuộc gọi API đầu tiên (TypeScript) · Bước 4: HTTP thô (không SDK)"
      },
      {
        ...
        "summaryVi": "Máy tính xách tay là băng ghế phòng thí nghiệm của kỹ thuật AI. Bạn tạo nguyên mẫu ở đây, sau đó chuyển những gì hoạt động vào production.",
        "keywordsVi": "Bước 1: Chọn giao diện của bạn · Bước 2: Các phím tắt quan trọng · Bước 3: Loại ô · Bước 4: Lệnh ma thuật · Bước 5: Hiển thị đầu ra phong phú nội tuyến · Bước 6: Google Colab · Máy tính xách tay so với Scripts: Khi nào sử dụng · Bẫy thường gặp"
      },
      {
        ...
        "summaryVi": "Địa ngục phụ thuộc là có thật. Môi trường ảo là phương thuốc chữa bệnh.",
        "keywordsVi": "Tùy chọn 1: uv venv (Khuyến nghị) · Tùy chọn 2: venv (Tích hợp) · Tùy chọn 3: conda (Khi bạn cần) · Đối với khóa học này: Chiến lược mỗi giai đoạn · 1. Cài đặt toàn cầu · 2. Trộn pip và conda · 3. Quên kích hoạt · 4. Cam kết .venv vào git · 5. Phiên bản CUDA không khớp"
      },
      {
        "name": "Docker for AI",
        "status": "complete",
        ...
        "summaryVi": "Containers biến \"hoạt động trên máy của tôi\" thành dĩ vãng.",
        "keywordsVi": "Tại sao các dự án AI cần Docker nhiều hơn hầu hết · Từ vựng chính · Các mẫu container phổ biến trong AI · Bước 1: Cài đặt Docker · Bước 2: Cài đặt NVIDIA Container Toolkit (Linux với NVIDIA GPU) · Bước 3: Tìm hiểu hình ảnh cơ sở · Bước 4: Viết Dockerfile để phát triển AI · Bước 5: Volume gắn kết cho dữ liệu và models · Bước 6: Docker Compose cho các ứng dụng AI đa dịch vụ · Bước 7: Các lệnh Docker hữu ích cho công việc AI · Không GPU?"
      },
      {
        "name": "Editor Setup",
        "status": "complete",
        ...
        "summaryVi": "Biên tập viên của bạn là phi công phụ của bạn. Cấu hình nó một lần để nó tránh xa bạn và bắt đầu kéo trọng lượng của nó.",
        "keywordsVi": "Bước 1: Cài đặt VS Code · Bước 2: Cài đặt tiện ích mở rộng cần thiết · Bước 3: Cấu hình cài đặt · Bước 4: Tích hợp thiết bị đầu cuối · Bước 5: Phát triển từ xa (SSH vào GPU Box) · Con trỏ · Lướt ván buồm · Vim/Neovim"
      },
      {
        ...
        "summaryVi": "Dữ liệu là nhiên liệu. Cách bạn quản lý nó quyết định tốc độ bạn đi.",
        "keywordsVi": "Bước 1: Cài đặt thư viện datasets · Bước 2: Tải dataset · Bước 3: Phát trực tuyến datasets lớn · Bước 4: Dataset định dạng · Bước 5: Phân tách dữ liệu · Bước 6: Tải xuống và lưu trữ models · Bước 7: Xử lý các tệp lớn · Bước 8: Mẫu lưu trữ"
      },
      {
        "name": "Terminal & Shell",
        "status": "complete",
        ...
        "summaryVi": "Nhà ga là nơi các kỹ sư AI sinh sống. Hãy thoải mái ở đây.",
        "keywordsVi": "Bước 1: Biết vỏ của bạn · Bước 2: Đường ống và chuyển hướng · Bước 3: processes nền · Bước 4: tmux · Bước 5: Giám sát bằng htop và nvtop · Bước 6: SSH cho hộp GPU từ xa · Bước 7: Bí danh hữu ích cho công việc AI · Bước 8: Các mẫu thiết bị đầu cuối AI phổ biến"
      },
      {
        "name": "Linux for AI",
        "status": "complete",
        ...
        "summaryVi": "Hầu hết AI chạy trên Linux. Bạn cần biết đủ để không bị mắc kẹt.",
        "keywordsVi": "Di chuyển xung quanh · Tệp và thư mục · Đọc tệp · Tìm kiếm"
      },
      {
        ...
        "summaryVi": "Lỗi AI tồi tệ nhất không gặp sự cố. Họ âm thầm huấn luyện về rác và báo cáo một đường cong loss tuyệt đẹp.",
        "keywordsVi": "Phần 1: Gỡ lỗi in (Có, nó hoạt động) · Phần 2: Python Debugger (pdb và điểm ngắt) · Phần 3: Ghi nhật ký số Python · Phần 4: Phần mã thời gian · Phần 5: cProfile và line_profiler · Phần 6: Lập hồ sơ bộ nhớ · Phần 7: Các lỗi AI thường gặp và cách phát hiện chúng · Phần 8: Khái niệm cơ bản về TensorBoard · Phần 9: Trình gỡ lỗi mã VS"
      }
    ]
  },
  {
    ...
    "lessons": [
      {
        ...
        "summaryVi": "Mỗi AI model chỉ là toán ma trận đội một chiếc mũ lạ mắt.",
        "keywordsVi": "Vectors là điểm (và hướng) · Ma trận là phép biến đổi · Sản phẩm Dot đo lường sự tương đồng · Độc lập tuyến tính · Cơ sở và cấp bậc · Chiếu · Gram-Schmidt Process · Bước 1: Vectors từ đầu (Python) · Bước 2: Ma trận từ đầu (Python) · Bước 3: Tại sao điều này lại quan trọng đối với AI · Bước 4: Phiên bản Julia · Bước 5: Độc lập tuyến tính và chiếu từ đầu (Python) · Xếp hạng, Chiếu và QR với NumPy · PyTorch -- Tensors Vectors với Autodiff"
      },
      {
        ...
        "summaryVi": "Mỗi mạng nơ-ron chỉ là phép nhân ma trận với các bước bổ sung.",
        "keywordsVi": "Vectors: danh sách các số được sắp xếp theo thứ tự · Ma trận: lưới số · Tại sao hình dạng lại quan trọng · Bản đồ hoạt động · Phép nhân theo nguyên tố so với ma trận · Phát thanh truyền hình · Bước 1: Vector class · Bước 2: Ma trận class với các hoạt động cốt lõi · Bước 3: Xem nó hoạt động · Bước 4: Kết nối với mạng nơ-ron"
      },
      {
        ...
        "summaryVi": "Ma trận là một cỗ máy định hình lại không gian. Tìm hiểu những gì nó làm cho mọi điểm, và bạn hiểu toàn bộ sự biến đổi.",
        "keywordsVi": "Biến đổi dưới dạng ma trận · Xoay · Mở rộng quy mô · Cắt · Suy ngẫm · Thành phần: chuyển đổi chuỗi · Giá trị riêng và vectơ riêng · Phân hủy riêng · Tại sao các giá trị riêng lại quan trọng · Yếu tố quyết định là volume yếu tố tỷ lệ · Bước 1: Ma trận biến đổi từ đầu (Python) · Bước 2: Thành phần của các phép biến đổi · Bước 3: Giá trị riêng từ đầu (2x2) · Bước 4: Quyết định là volume yếu tố tỷ lệ · Xoay 3D với NumPy"
      },
      {
        ...
        "summaryVi": "Các công cụ phái sinh cho bạn biết con đường nào là xuống dốc. Đó là tất cả những gì một mạng nơ-ron cần học.",
        "keywordsVi": "Phái sinh là gì? · Đạo hàm từng phần: một biến tại một thời điểm · Các gradient: vector của tất cả các đạo hàm từng phần · Kết nối với tối ưu hóa · Đạo hàm số và đạo hàm phân tích · Dẫn xuất bằng tay cho các hàm đơn giản · Quy tắc chuỗi · Ma trận Hessian · Xấp xỉ dòng Taylor · Tích phân trong ML · Quy tắc chuỗi đa biến trong biểu đồ tính toán · Ma trận Jacobian · Tại sao điều này lại quan trọng đối với mạng nơ-ron · Bước 1: Đạo hàm số từ đầu · Bước 2: Phái sinh từng phần và gradients · Bước 3: Gradient descent để tìm giá trị tối thiểu của f(x) = x^2 · Bước 4: Gradient descent trên chức năng 2D · Bước 5: So sánh đạo hàm số và phái sinh phân tích · Bước 6: Tính toán Hessian bằng số · Bước 7: Xấp xỉ Taylor trong thực tế · Bước 8: Tại sao điều này lại quan trọng đối với mạng nơ-ron"
      },
      {
        ...
        "summaryVi": "Quy tắc chuỗi là công cụ đằng sau mọi mạng nơ-ron học hỏi.",
        "keywordsVi": "Quy tắc chuỗi · Đồ thị tính toán · Chế độ chuyển tiếp so với chế độ đảo ngược · Số kép cho chế độ chuyển tiếp · Xây dựng động cơ Autograd · Cách hoạt động của Autograd PyTorch · Bước 1: Giá trị class · Bước 2: Các phép toán số học với theo dõi gradient · Bước 3: Công backward pass · Bước 4: Nhiều thao tác hơn cho một động cơ hoàn chỉnh · Bước 5: Mini MLP từ đầu · Bước 6: Gradient kiểm tra · Bước 7: Xác minh dựa trên tính toán thủ công · Xác minh dựa trên PyTorch · Biểu thức phức tạp hơn"
      },
      {
        ...
        "summaryVi": "Xác suất là ngôn ngữ AI sử dụng để thể hiện sự không chắc chắn.",
        "keywordsVi": "Sự kiện, không gian mẫu và xác suất · Xác suất có điều kiện và tính độc lập · Hàm khối lượng xác suất so với hàm mật độ xác suất · Phân phối phổ biến · Giá trị và Variance kỳ vọng · Phân phối chung và cận biên · Tại sao phân phối chuẩn hiển thị ở khắp mọi nơi · Log Probabilities · Softmax như một phân phối xác suất · Sampling · Bước 1: Khái niệm cơ bản về xác suất · Bước 2: PMF và PDF từ đầu · Bước 3: Giá trị kỳ vọng và variance · Bước 4: Sampling từ các bản phân phối · Bước 5: Softmax và log probabilities · Bước 6: Trình diễn Định lý giới hạn trung tâm · Bước 7: Trực quan hóa"
      },
      {
        ...
        "summaryVi": "Xác suất là về những gì bạn mong đợi. Định lý Bayes là về những gì bạn học.",
        "keywordsVi": "Từ xác suất chung đến Bayes · Bốn phần · Ví dụ về xét nghiệm y tế · Ví dụ về bộ lọc thư rác · Naive Bayes: giả định độc lập · Ước tính likelihood tối đa (MLE) · Tối đa một hậu (MAP) · Bayes và thường xuyên: sự khác biệt thực tế · Tại sao tư duy Bayes lại quan trọng đối với ML · Bước 1: Hàm định lý Bayes · Bước 2: Bộ phân loại Naive Bayes · Bước 3: Huấn luyện về dữ liệu spam · Bước 4: Kiểm tra xác suất đã học · Liên hợp Priors · Cập nhật Bayes tuần tự · Kết nối với thử nghiệm A/B"
      },
      {
        ...
        "summaryVi": "Training một mạng nơ-ron không gì khác hơn là tìm đáy của một thung lũng.",
        "keywordsVi": "Tối ưu hóa có nghĩa là gì · Gradient descent (vani) · Learning rate: hyperparameter quan trọng nhất · SGD so với batch và mini-batch · Động lượng: quả bóng lăn xuống dốc · Adam: tỷ lệ học tập thích ứng · Learning rate lịch trình · Lồi vs không lồi · Loss hình ảnh cảnh quan · Bước 1: Xác định hàm kiểm tra · Bước 2: gradient descent vani · Bước 3: SGD với động lượng · Bước 4: Adam · Bước 5: Chạy và so sánh"
      },
      {
        ...
        "summaryVi": "Lý thuyết thông tin đo lường sự bất ngờ. Loss chức năng được xây dựng trên đó.",
        "keywordsVi": "Nội dung thông tin (Bất ngờ) · Entropy (Bất ngờ trung bình) · Cross-entropy (hàm Loss bạn sử dụng hàng ngày) · Phân kỳ KL (Khoảng cách giữa các phân phối) · Thông tin lẫn nhau · Entropy có điều kiện · Entropy chung · Thông tin lẫn nhau (Deep Dive) · Làm mịn nhãn và Cross-Entropy · Tại sao entropy chéo là phân loại Loss · Bits so với Nats · Perplexity · Bước 1: Nội dung thông tin và entropy · Bước 2: Phân kỳ entropy chéo và KL · Bước 3: Entropy chéo để phân loại loss · Bước 4: Entropy chéo bằng log-likelihood âm · Bước 5: Thông tin lẫn nhau"
      },
      {
        ...
        "summaryVi": "High-dimensional dữ liệu có cấu trúc. Bạn tìm thấy nó bằng cách nhìn từ góc độ phù hợp.",
        "keywordsVi": "Lời nguyền của không gian · PCA: tìm hướng quan trọng · Giải thích tỷ lệ variance · Chọn số lượng thành phần · t-SNE: bảo tồn các khu vực lân cận · UMAP: cấu trúc toàn cầu nhanh hơn, tốt hơn · Khi nào sử dụng · Hạt nhân PCA · Lỗi tái tạo · Bước 1: PCA từ đầu · Bước 2: Kiểm tra trên dữ liệu tổng hợp · Bước 3: Các chữ số MNIST ở dạng 2D · Bước 4: So sánh với sklearn · Bước 5: So sánh UMAP"
      },
      {
        ...
        "summaryVi": "SVD là con dao của Quân đội Thụy Sĩ về đại số tuyến tính. Mỗi ma trận đều có một. Mọi nhà khoa học dữ liệu đều cần một.",
        "keywordsVi": "SVD làm gì về mặt hình học · Sự phân hủy đầy đủ · vectors số ít bên trái, giá trị số ít, số ít bên phải vectors · Hình thức sản phẩm bên ngoài · Mối quan hệ với phân rã riêng · SVD bị cắt bớt: xấp xỉ xếp hạng thấp · Nén hình ảnh bằng SVD · SVD cho hệ thống đề xuất · SVD trong NLP: Phân tích ngữ nghĩa tiềm ẩn · SVD để giảm nhiễu · Nghịch đảo giả qua SVD · Ưu điểm ổn định số · Kết nối với PCA · Bước 1: SVD từ đầu bằng cách sử dụng lặp lại nguồn · Bước 2: Kiểm tra và so sánh với NumPy · Bước 3: Demo nén hình ảnh · Bước 4: Giảm nhiễu · Bước 5: Giả nghịch đảo"
      },
      {
        ...
        "summaryVi": "Tensors là ngôn ngữ chung giữa dữ liệu và học sâu. Mọi hình ảnh, từng câu, mọi gradient đều chảy qua chúng.",
        "keywordsVi": "tensor là gì · Tensor hình dạng trong deep learning · Cách hoạt động của bố cục bộ nhớ · Quy tắc phát sóng · Einsum: hoạt động tensor phổ quát · Bước 1: Tensor lưu trữ và sải bước · Bước 2: Định hình lại, bóp, bóp · Bước 3: Chuyển vị và hoán vị · Bước 4: Các hoạt động và rút gọn theo nguyên tố · Bước 5: Phát sóng bằng NumPy · Bước 6: Thao tác Einsum · Bước 7: Attention cơ chế thông qua einsum · Scratch so với NumPy · Scratch so với PyTorch · Mỗi lớp mạng nơ-ron như một hoạt động tensor"
      },
      {
        ...
        "summaryVi": "Dấu phẩy động là một trừu tượng bị rò rỉ. Nó sẽ cắn bạn trong training, và bạn sẽ không thấy nó đến.",
        "keywordsVi": "IEEE 754: Cách máy tính lưu trữ số thực · Tại sao lại là 0,1 + 0,2 != 0,3 · Hủy bỏ thảm họa · Tràn và tràn · Thủ thuật Log-Sum-Exp · Tại sao Softmax cần thủ thuật trừ tối đa · NaN và Inf: Phát hiện và Phòng ngừa · Kiểm tra Gradient số · Mixed Precision Training · bfloat16 vs float16: Tại sao bfloat16 thắng Training · Gradient Cắt · Các lớp chuẩn hóa làm chất ổn định số · Lỗi số ML phổ biến · Bước 1: Chứng minh giới hạn precision dấu phẩy động · Bước 2: Triển khai softmax ngây thơ và ổn định · Bước 3: Triển khai log-sum-exp ổn định · Bước 4: Triển khai entropy chéo ổn định · Bước 5: Kiểm tra Gradient · Mô phỏng Mixed precision · Gradient cắt · Phát hiện NaN/Inf"
      },
      {
        ...
        "summaryVi": "Hàm khoảng cách của bạn xác định ý nghĩa của \"tương tự\". Chọn sai và mọi thứ xuôi dòng bị hỏng.",
        "keywordsVi": "Định mức: đo vector độ lớn · L1 Norm (khoảng cách Manhattan) · L2 Norm (khoảng cách Euclid) · Định mức Lp: gia đình chung · L-infinity Norm (khoảng cách Chebyshev) · Độ tương đồng cosin và khoảng cách cosin · Điểm giống sản phẩm so với Cosine · Khỏang cách Mahalanobis · Jaccard Similarity (dành cho bộ) · Chỉnh sửa khoảng cách (Khoảng cách Levenshtein) · Phân kỳ KL (không phải khoảng cách, nhưng được sử dụng như một) · Khoảng cách Wasserstein (Khoảng cách của Earth Mover) · Tại sao các nhiệm vụ khác nhau cần khoảng cách khác nhau · Kết nối với các chức năng Loss · Kết nối với chính quy hóa · Tìm kiếm hàng xóm gần nhất · Bước 1: Tất cả các hàm định mức và khoảng cách · Bước 2: Cùng dữ liệu, khoảng cách khác nhau, hàng xóm khác nhau · Bước 3: Embedding tìm kiếm điểm tương đồng"
      },
      {
        ...
        "summaryVi": "Thống kê là cách bạn biết liệu model của bạn có thực sự hoạt động hay chỉ may mắn.",
        "keywordsVi": "Thống kê mô tả: Tóm tắt dữ liệu của bạn · Tương quan: Cách các biến di chuyển cùng nhau · Ma trận hiệp phương sai · Kiểm tra giả thuyết · Bài kiểm tra t · Kiểm tra chi bình phương · A/B Kiểm tra ML Models · Ý nghĩa thống kê vs Ý nghĩa thực tế · Nhiều vấn đề so sánh · Phương pháp Bootstrap · Kiểm tra tham số so với không tham số · Định lý giới hạn trung tâm: Ý nghĩa thực tế · Những sai lầm thống kê phổ biến trong các bài báo ML"
      },
      {
        ...
        "summaryVi": "Sampling là cách AI khám phá không gian của các khả năng.",
        "keywordsVi": "Tại sao Sampling lại quan trọng · Đồng phục ngẫu nhiên Sampling · Phương pháp CDF nghịch đảo (Biến đổi nghịch đảo Sampling) · Từ chối Sampling · Tầm quan trọng Sampling · Ước tính Monte Carlo · Chuỗi Markov Monte Carlo (MCMC): Metropolis-Hastings · Gibbs Sampling · Temperature Sampling (Được sử dụng trong LLMs) · Top-k Sampling · Top-p (nhân) Sampling · Thủ thuật tái tham số hóa (được sử dụng trong VAE) · Gumbel-Softmax (Sampling phân loại có thể phân biệt) · Phân tầng Sampling · Kết nối với Models khuếch tán · Bước 1: sampling CDF đồng đều và nghịch đảo · Bước 2: Từ chối sampling · Bước 3: Tầm quan trọng sampling · Bước 4: Ước tính Monte Carlo của pi · Bước 5: MCMC Metropolis-Hastings · Bước 6: Gibbs sampling · Bước 7: Temperature sampling · Bước 8: Top-k và top-p sampling · Bước 9: Thủ thuật tái tham số hóa · Bước 10: Kẹo cao su-Softmax"
      },
      {
        "name": "Linear Systems",
        "status": "complete",
        ...
        "summaryVi": "Giải Axe = b là bài toán lâu đời nhất vẫn chạy mạng nơ-ron của bạn.",
        "keywordsVi": "Ax = b có nghĩa là gì về mặt hình học · Hình ảnh cột so với hình ảnh hàng · Loại bỏ Gaussian · Xoay một phần: tại sao nó lại quan trọng · Phân hủy LU · Phân hủy QR · Phân hủy Cholesky · Bình phương nhỏ nhất: khi Ax = b không có lời giải chính xác · Phương trình chuẩn = hồi quy tuyến tính · Giả nghịch đảo (Moore-Penrose) · Số điều kiện · Phương pháp lặp lại: liên hợp gradient · Bức tranh toàn cảnh: phương pháp nào khi · Kết nối với ML · Bước 1: Loại bỏ Gaussian với trục một phần · Bước 2: Phân hủy LU · Bước 3: Phân hủy Cholesky · Bước 4: Bình phương nhỏ nhất thông qua phương trình bình thường · Bước 5: Số điều kiện"
      },
      {
        ...
        "summaryVi": "Các vấn đề lồi có một thung lũng. Mạng nơ-ron có hàng triệu. Biết sự khác biệt rất quan trọng.",
        "keywordsVi": "Bộ lồi · Chức năng lồi · Kiểm tra độ lồi · Tại sao độ lồi lại quan trọng · Lồi và không lồi trong ML · Ma trận Hessian · Phương pháp Newton · Tối ưu hóa hạn chế · Hệ số Lagrange · Điều kiện KKT · Chính quy hóa dưới dạng tối ưu hóa bị ràng buộc · Tính nhị nguyên · Tại sao deep learning hoạt động mặc dù không lồi · Phương pháp bậc hai trong thực tế · Bước 1: Trình kiểm tra độ lồi · Bước 2: Phương pháp Newton cho 2D · Bước 3: Bộ giải số nhân Lagrange · Bước 4: So sánh thứ nhất và thứ hai"
      },
      {
        ...
        "summaryVi": "Căn bậc hai của -1 không phải là ảo. Nó là chìa khóa cho vòng quay, tần số và một nửa quá trình xử lý tín hiệu.",
        "keywordsVi": "Số phức là gì? · Số học phức · Mặt phẳng phức tạp · Dạng cực · Công thức Euler · Tại sao công thức Euler lại quan trọng đối với ML · Kết nối với vòng quay 2D · Phasor và tín hiệu quay · Gốc rễ của sự đoàn kết · Kết nối với DFT · Tại sao tôi không tưởng tượng · Hàm mũ phức và hàm lượng giác · Kết nối với transformers · Bước 1: class phức tạp · Bước 2: Chuyển đổi cực và công thức Euler · Bước 3: Xoay · Bước 4: DFT từ số học phức · Bước 5: DFT nghịch đảo · Bước 6: Gốc rễ của sự thống nhất"
      },
      {
        ...
        "summaryVi": "Mỗi tín hiệu là một tổng của sóng sin. Biến đổi Fourier cho bạn biết cái nào.",
        "keywordsVi": "Định nghĩa DFT · Ý nghĩa của mỗi hệ số · DFT nghịch đảo · FFT: làm cho nó nhanh chóng · Phân tích quang phổ · Độ phân giải tần số · Định lý tích chập · Cửa sổ · Thuộc tính DFT · Kết nối với mã hóa vị trí · Kết nối với CNN · Quang phổ và biến đổi Fourier thời gian ngắn · Răng cưa · Zero-padding không làm tăng độ phân giải · Bước 1: DFT từ đầu · Bước 2: DFT nghịch đảo · Bước 3: FFT (Cooley-Tukey) · Bước 4: Trình trợ giúp phân tích quang phổ"
      },
      {
        ...
        "summaryVi": "Đồ thị là cấu trúc dữ liệu của các mối quan hệ. Nếu dữ liệu của bạn có kết nối, bạn cần lý thuyết đồ thị.",
        "keywordsVi": "Đồ thị: Nút và Cạnh · Ma trận liền kề · Bằng cấp · BFS và DFS · Đồ thị Laplacian · Thuộc tính quang phổ · Chuyển tin nhắn · Khái niệm và ứng dụng ML · Bước 1: Vẽ đồ thị class từ đầu · Bước 2: BFS và DFS · Bước 3: Các thành phần được kết nối và các giá trị riêng của Laplacian · Bước 4: Phân cụm quang phổ · Bước 5: Chuyển tin nhắn · numpy phân tích quang phổ"
      },
      {
        ...
        "summaryVi": "Tính ngẫu nhiên với cấu trúc. Toán học đằng sau những bước đi ngẫu nhiên, chuỗi Markov và models khuếch tán.",
        "keywordsVi": "Đi bộ ngẫu nhiên · Xích Markov · Kết nối với Models ngôn ngữ · Chuyển động Brown · Động lực học Langevin · MCMC: Chuỗi Markov Monte Carlo · Stochastic Processes trong AI · Bước 1: Mô phỏng đi bộ ngẫu nhiên · Bước 2: Xích Markov · Bước 3: Động lực học Langevin · Bước 4: Metropolis-Hastings · numpy cho ma trận chuyển tiếp · Kết nối với frameworks thực · Xác minh sự hội tụ chuỗi Markov"
      }
    ]
  },
  {
    ...
    "lessons": [
      {
        ...
        "summaryVi": "Học máy là dạy máy tính tìm các mẫu trong dữ liệu thay vì viết các quy tắc bằng tay.",
        "keywordsVi": "Học hỏi từ dữ liệu, không phải quy tắc · Ba loại máy học · Ngoài ba Big Three · Phân loại vs Hồi quy · Quy trình làm việc ML · Phân tách Training, xác thực và thử nghiệm · Overfitting so với Underfitting · Sự đánh đổi Bias-Variance · Không có định lý bữa trưa miễn phí · Khi nào KHÔNG sử dụng Machine Learning · Bước 1: Bộ phân loại Centroid gần nhất từ đầu · Bước 2: Huấn luyện về dữ liệu tổng hợp · Bước 3: So sánh với đường cơ sở · Tại sao điều này lại quan trọng · Bước 4: Bộ phân loại Centroid không thể làm gì"
      },
      {
        ...
        "summaryVi": "Hồi quy tuyến tính vẽ đường thẳng tốt nhất qua dữ liệu của bạn. Đó là \"thế giới xin chào\" của học máy.",
        "keywordsVi": "Các Model · Hàm chi phí (Sai số bình phương trung bình) · Gradient Descent · Phương trình bình thường (giải pháp dạng đóng) · Hồi quy tuyến tính đa · Hồi quy đa thức · Điểm R bình phương · Xem trước chính quy hóa (hồi quy Ridge) · Bước 1: Tạo dữ liệu mẫu · Bước 2: Hồi quy tuyến tính từ đầu với gradient descent · Bước 3: Phương trình chuẩn (nghiệm dạng đóng) · Bước 4: Hồi quy tuyến tính nhiều · Bước 5: Hồi quy đa thức · Bước 6: Hồi quy sườn núi (chính quy hóa L2)"
      },
      {
        ...
        "summaryVi": "Hồi quy logistic uốn cong một đường thẳng thành đường cong chữ S để trả lời các câu hỏi có hoặc không với xác suất.",
        "keywordsVi": "Tại sao hồi quy tuyến tính không được phân loại · Chức năng Sigmoid · Hồi quy logistic = Model tuyến tính + Sigmoid · Nhị phân Cross-Entropy Loss · Gradient Descent cho hồi quy logistic · Ranh giới quyết định · Phân loại đa Class với Softmax · Chỉ số đánh giá · Bước 1: Chức năng Sigmoid và tạo dữ liệu · Bước 2: Hồi quy logistic từ đầu · Bước 3: Ma trận và số liệu nhầm lẫn từ đầu · Bước 4: Phân tích ranh giới quyết định · Bước 5: Đa class với softmax · Bước 6: Điều chỉnh ngưỡng"
      },
      {
        ...
        "summaryVi": "Cây quyết định chỉ là một sơ đồ. Nhưng một khu rừng của chúng là một trong những công cụ mạnh mẽ nhất trong ML.",
        "keywordsVi": "Cây quyết định làm gì · Tiêu chí phân chia: đo tạp chất · Cách hoạt động của tính năng tách · Điều kiện dừng · Cây quyết định hồi quy · Rừng ngẫu nhiên: sức mạnh của quần thể · Feature quan trọng · Khi cây cối đánh bại mạng nơ-ron · Bước 1: Tạp chất Gini và entropy · Bước 2: Tìm phần tách tốt nhất · Bước 3: Xây dựng DecisionTree class · Bước 4: Xây dựng class RandomForest"
      },
      {
        ...
        "summaryVi": "Tìm con đường rộng nhất giữa hai classes. Đó là toàn bộ ý tưởng.",
        "keywordsVi": "Bộ phân loại ký quỹ tối đa · Hỗ trợ vectors: một số ít quan trọng · Lề mềm: xử lý nhiễu với C parameter · loss bản lề: chức năng loss SVM · Training SVM tuyến tính với gradient descent · Công thức kép và thủ thuật hạt nhân · SVM cho hồi quy (SVR) · Tại sao SVM thua deep learning (và khi họ vẫn thắng) · Bước 1: Bản lề loss và gradient · Bước 2: SVM tuyến tính qua gradient descent · Bước 3: Chức năng hạt nhân · Bước 4: Ký quỹ và hỗ trợ nhận dạng vector"
      },
      {
        ...
        "summaryVi": "Lưu trữ mọi thứ. Dự đoán bằng cách nhìn vào hàng xóm của bạn. Thuật toán đơn giản nhất thực sự hoạt động.",
        "keywordsVi": "Cách thức hoạt động của KNN · Chọn K · Chỉ số khoảng cách · KNN có trọng số · Lời nguyền của không gian · KD-trees: tìm kiếm hàng xóm gần nhất nhanh chóng · Cây bóng: tốt hơn cho kích thước vừa phải · Lười học vs háo hức học · KNN cho hồi quy · Bước 1: Chức năng khoảng cách · Bước 2: Bộ phân loại và hồi quy KNN · Bước 3: KD-tree để tìm kiếm hiệu quả · Bước 4: Feature tỷ lệ"
      },
      {
        ...
        "summaryVi": "Không có nhãn, không có giáo viên. Thuật toán tự tìm thấy cấu trúc.",
        "keywordsVi": "Phân cụm: Nhóm những thứ tương tự lại với nhau · K-Means: Con ngựa làm việc · Chọn K · DBSCAN: Phân cụm dựa trên mật độ · Phân cụm phân cấp · Hỗn hợp Gaussian Models (GMM) · Khi nào sử dụng · Phát hiện bất thường với phân cụm · Bước 1: K-Means từ đầu · Bước 2: Phương pháp khuỷu tay và điểm bóng · Bước 3: DBSCAN từ đầu · Bước 4: Hỗn hợp Gaussian Model (thuật toán EM) · Bước 5: Tạo dữ liệu thử nghiệm và chạy mọi thứ"
      },
      {
        ...
        "summaryVi": "Một feature tốt có giá trị một nghìn điểm dữ liệu.",
        "keywordsVi": "Các Feature Pipeline · Features số · Phân loại Features · Features văn bản · Giá trị còn thiếu · Tương tác Feature · Feature Lựa chọn · Bước 1: Biến đổi số từ đầu · Bước 2: Mã hóa phân loại từ đầu · Bước 3: features văn bản từ đầu · Bước 4: Thiếu gán giá trị từ đầu · Bước 5: Feature lựa chọn từ đầu · Bước 6: Toàn bộ pipeline và demo"
      },
      {
        ...
        "summaryVi": "Một model chỉ tốt bằng cách bạn đo lường nó.",
        "keywordsVi": "Huấn luyện, xác nhận, kiểm tra · Xác thực chéo K-Fold · Chỉ số phân loại · Chỉ số hồi quy · Đường cong học tập · Đường cong xác thực · Những sai lầm đánh giá phổ biến · Bước 1: Train/validation/test tách · Bước 2: Xác thực chéo K-fold và phân tầng · Bước 3: Ma trận nhầm lẫn và chỉ số phân loại · Bước 4: Chỉ số hồi quy · Bước 5: Đường cong học tập · Bước 6: Một bộ phân loại đơn giản để thử nghiệm, cộng với bản demo đầy đủ"
      },
      {
        ...
        "summaryVi": "Mọi lỗi model đều đến từ một trong ba nguồn: bias, variance hoặc nhiễu. Bạn chỉ có thể kiểm soát hai cái đầu tiên.",
        "keywordsVi": "Bias: Lỗi hệ thống · Variance: Độ nhạy với dữ liệu Training · Sự phân hủy · Model Độ phức tạp vs Lỗi · Chính quy hóa như kiểm soát Variance Bias · Double Descent: Góc nhìn hiện đại · Chẩn đoán Model của bạn · Chiến lược thực tế · Phương pháp tổng hợp và giảm Variance · Đường cong học tập · Cách tạo đường cong học tập · Bước 1: Tạo dữ liệu tổng hợp từ một hàm đã biết · Bước 2: Bootstrap Sampling và khớp đa thức · Bước 3: Tính toán Bias^2, Variance Phân tách · Bước 4: Đường cong học tập · Bước 5: Quét chính quy hóa · Đường cong xác thực: Quét Model độ phức tạp · Đường cong học tập: Quét Training kích thước đặt · Xác thực chéo với Regularization Sweep · Kết hợp tất cả lại với nhau: Quy trình chẩn đoán hoàn chỉnh"
      },
      {
        ...
        "summaryVi": "Một nhóm những người học yếu, kết hợp một cách chính xác, trở thành một người học giỏi. Đây không phải là một phép ẩn dụ. Nó là một định lý.",
        "keywordsVi": "Tại sao Ensembles hoạt động · Đóng bao (Bootstrap Aggregating) · Boosting (Sửa lỗi tuần tự) · AdaBoost · Gradient Tăng cường · XGBoost: Tại sao nó thống trị dữ liệu dạng bảng · Xếp chồng (Meta-Learning) · Bỏ phiếu · Bước 1: Gốc cây quyết định (Base Learner) · Bước 2: AdaBoost từ đầu · Bước 3: Gradient Tăng cường từ đầu · Bước 4: So sánh với sklearn · Khi nào nên sử dụng từng phương pháp · Production Stack cho dữ liệu dạng bảng"
      },
      {
        ...
        "summaryVi": "Hyperparameters là các núm bạn xoay trước khi training bắt đầu. Biến chúng tốt là sự khác biệt giữa model tầm thường và tuyệt vời.",
        "keywordsVi": "Parameters so với Hyperparameters · Tìm kiếm lưới · Tìm kiếm ngẫu nhiên · Tối ưu hóa Bayes · Dừng sớm · Bộ lập lịch Learning Rate · Hyperparameter Tầm quan trọng · Chiến lược thực tế · Tích hợp xác thực chéo · Mẹo thực tế · Bước 1: Tìm kiếm lưới từ đầu · Bước 2: Tìm kiếm ngẫu nhiên từ đầu · Bước 3: Tối ưu hóa Bayes (Đơn giản hóa) · Bước 4: So sánh tất cả các phương pháp · Optuna trong thực tế · Optuna với cắt tỉa · Bộ dò tích hợp của sklearn · Những sai lầm thường gặp trong điều chỉnh Hyperparameter"
      },
      {
        ...
        "summaryVi": "Một model không phải là một sản phẩm. Một pipeline là. pipeline là tất cả mọi thứ từ dữ liệu thô đến dự đoán được triển khai và mọi bước đều phải có thể tái tạo.",
        "keywordsVi": "Pipeline là gì · Rò rỉ dữ liệu: Kẻ giết người thầm lặng · Pipeline sklearn · ColumnTransformer: Các Pipelines khác nhau cho các cột khác nhau · Theo dõi thử nghiệm · Phiên bản Model · Phiên bản dữ liệu với DVC · Thí nghiệm có thể tái tạo · Từ máy tính xách tay đến Production Pipeline · Những sai lầm Pipeline thường gặp · Bước 1: Tùy chỉnh Transformer · Bước 2: Pipeline từ đầu · Bước 3: Xác thực chéo với Pipeline · Bước 4: Làm đầy đủ Production Pipeline với sklearn"
      },
      {
        "name": "Naive Bayes",
        "status": "complete",
        ...
        "summaryVi": "Giả định \"ngây thơ\" là sai, và dù sao nó cũng hoạt động. Đó là vẻ đẹp của nó.",
        "keywordsVi": "Định lý Bayes (Đánh giá nhanh) · Giả định độc lập ngây thơ · Tại sao nó vẫn hoạt động · Toán học từng bước · Ba biến thể · Trường hợp sử dụng từng mẫu mã · Làm mịn Laplace · Tính toán không gian nhật ký · Naive Bayes so với hồi quy logistic · Phân loại Pipeline · Đa thứcNB · GaussianNB · Demo: Phân loại văn bản · Demo: Features liên tục · Tốc độ dự đoán · TF-IDF với Naive Bayes · BernoulliNB cho văn bản ngắn · Hiệu chỉnh xác suất NB · Những sai lầm phổ biến · Khi Bayes ngây thơ thất bại"
      },
      {
        ...
        "summaryVi": "Hiệu suất trong quá khứ dự đoán kết quả trong tương lai - nếu bạn kiểm tra độ tĩnh trước.",
        "keywordsVi": "Điều gì làm cho chuỗi thời gian khác biệt · Các thành phần của chuỗi thời gian · Văn phòng phẩm · Tự tương quan · Lag Features: Biến chuỗi thời gian thành học tập có giám sát · Xác thực Walk-Forward · Trực giác ARIMA · Khi nào sử dụng nội dung · Chân trời và chiến lược dự báo · Những sai lầm thường gặp trong chuỗi thời gian · Lag Feature Creator · Xác thực chéo Walk-Forward · Model tự hồi quy đơn giản · Kiểm tra độ tĩnh · Tự tương quan · sklearn TimeSeriesSplit · Chỉ số đánh giá · Lăn Features · Đường cơ sở bạn phải đánh bại · Mẹo thực tế"
      },
      {
        ...
        "summaryVi": "Bình thường rất dễ xác định. Bất thường là bất cứ điều gì không phù hợp.",
        "keywordsVi": "Các loại dị thường · Khung hình không giám sát · Được giám sát và không được giám sát: Sự đánh đổi · Phương pháp Z-Score · Phương pháp IQR · Rừng cô lập · Hệ số ngoại lệ cục bộ (LOF) · So sánh · Thách thức đánh giá · Phát hiện bất thường Pipeline · Máy dò điểm Z · Máy dò IQR · Khu rừng cô lập từ đầu · Kịch bản demo · Parameter ô nhiễm sklearn · SVM một Class · Phương pháp tiếp cận Autoencoder (Xem trước) · Phát hiện bất thường của Ensemble · Production Cân nhắc · Chọn một ngưỡng · Mở rộng quy mô lên Production"
      },
      {
        ...
        "summaryVi": "Khi 99% dữ liệu của bạn là \"bình thường\", accuracy đó là một lời nói dối.",
        "keywordsVi": "Tại sao Accuracy thất bại · Số liệu tốt hơn · Dữ liệu mất cân bằng Pipeline · SMOTE: Kỹ thuật lấy mẫu quá mức thiểu số tổng hợp · Sampling chiến lược được so sánh · Class Trọng lượng · Điều chỉnh ngưỡng · Học tập nhạy cảm về chi phí · Sơ đồ quyết định · Bước 1: Tạo dataset mất cân bằng · Bước 2: SMOTE từ đầu · Bước 3: Lấy mẫu quá mức và lấy mẫu thiếu ngẫu nhiên · Bước 4: Hồi quy logistic với trọng số class · Bước 5: Điều chỉnh ngưỡng · Bước 6: Chức năng đánh giá · Bước 7: So sánh tất cả các phương pháp"
      },
      {
        ...
        "summaryVi": "Nhiều features hơn không tốt hơn. Đúng features là tốt hơn.",
        "keywordsVi": "Ba loại lựa chọn Feature · Variance Ngưỡng · Thông tin lẫn nhau · Loại bỏ Feature đệ quy (RFE) · Chính quy hóa L1 (Lasso) · Tầm quan trọng của Feature dựa trên cây · Tầm quan trọng của hoán vị · Bảng so sánh · Sơ đồ quyết định · Bước 1: Tạo dữ liệu tổng hợp với cấu trúc feature đã biết · Bước 2: Variance ngưỡng · Bước 3: Thông tin lẫn nhau (rời rạc) · Bước 4: Loại bỏ Feature đệ quy · Bước 5: Lựa chọn feature L1 · Bước 6: Tầm quan trọng dựa trên cây (cây quyết định đơn giản) · Bước 7: Chạy tất cả các phương thức và so sánh"
      }
    ]
  },
  {
    ...
    "lessons": [
      {
        ...
        "summaryVi": "Perceptron là nguyên tử của mạng nơ-ron. Chia nó ra và bạn tìm thấy trọng lượng, bias và quyết định.",
        "keywordsVi": "Một tế bào thần kinh, một quyết định · Ranh giới quyết định · Quy tắc học tập · Vấn đề XOR · Bước 1: Máy class Perceptron · Bước 2: Huấn luyện trên cổng logic · Bước 3: Xem XOR không thành công · Bước 4: Giải XOR với hai layer · Bước 5: Huấn luyện mạng hai lớp"
      },
      {
        ...
        "summaryVi": "Một tế bào thần kinh vẽ một đường thẳng. Stack chúng, và bạn có thể vẽ bất cứ thứ gì.",
        "keywordsVi": "Lớp: Đầu vào, Ẩn, Đầu ra · Tế bào thần kinh và kích hoạt · Forward Pass: Cách dữ liệu chảy · Kích thước ma trận · Định lý xấp xỉ phổ quát · Khả năng kết hợp · Bước 1: Kích hoạt Sigmoid · Bước 2: Lớp Class · Bước 3: Class mạng · Bước 4: XOR với trọng lượng được điều chỉnh bằng tay · Bước 5: Phân loại vòng tròn"
      },
      {
        ...
        "summaryVi": "Backpropagation là thuật toán giúp việc học trở nên khả thi. Nếu không có nó, mạng nơ-ron chỉ là máy tạo số ngẫu nhiên đắt tiền.",
        "keywordsVi": "Quy tắc chuỗi, áp dụng cho mạng · Đồ thị tính toán · Tiến vs Lùi · Gradient Luồng qua mạng · Biến mất Gradients · Suy ra Gradients cho mạng 2 lớp · Bước 1: Nút giá trị · Bước 2: Thao tác với các chức năng ngược · Bước 3: Sigmoid và Loss · Bước 4: Backward Pass · Bước 5: Lớp và mạng · Bước 6: Huấn luyện trên XOR · Bước 7: Phân loại vòng tròn"
      },
      {
        ...
        "summaryVi": "Nếu không có tính phi tuyến, mạng 100 lớp của bạn là một ma trận lạ mắt nhân lên. Kích hoạt là cổng cho phép mạng nơ-ron suy nghĩ theo đường cong.",
        "keywordsVi": "Tại sao tính phi tuyến tính là cần thiết · Sigmoid · Tín · ReLU: Bước đột phá · Rò rỉ ReLU · GELU: Mặc định hiện đại · Swish / SiLU · Softmax: Kích hoạt đầu ra · So sánh các hình dạng · So sánh Gradient Flow · Kích hoạt nào khi · Bước 1: Triển khai tất cả các chức năng kích hoạt với các công cụ phái sinh · Bước 2: Hình dung nơi Gradients chết · Bước 3: Thí nghiệm Gradient biến mất · Bước 4: Máy dò tế bào thần kinh chết · Bước 5: So sánh Training - Sigmoid vs ReLU vs GELU"
      },
      {
        ...
        "summaryVi": "Mạng của bạn đưa ra dự đoán. ground truth nói khác. Nó sai như thế nào? Con số đó là loss. Chọn sai chức năng loss và model của bạn sẽ tối ưu hóa hoàn toàn sai.",
        "keywordsVi": "Sai số bình phương trung bình (MSE) · Loss entropy chéo · Tại sao MSE không được phân loại · Làm mịn nhãn · Loss tương phản · Tiêu điểm Loss · Loss Cây quyết định hàm · Loss Phong cảnh · Bước 1: MSE và Gradient của nó · Bước 2: Entropy chéo nhị phân · Bước 3: Phân loại Cross-Entropy với Softmax · Bước 4: Làm mịn nhãn · Bước 5: Loss tương phản (InfoNCE đơn giản) · Bước 6: MSE vs Cross-Entropy về phân loại"
      },
      {
        ...
        "summaryVi": "Gradient descent cho bạn biết nên di chuyển theo hướng nào. Nó không nói gì về khoảng cách hay tốc độ như thế nào. SGD là một la bàn. Adam là GPS với dữ liệu giao thông.",
        "keywordsVi": "Gradient Descent ngẫu nhiên (SGD) · Động lượng · RMSProp · Adam: Động lượng + RMSProp · AdamW: Giảm cân đúng cách · Learning Rate: Hyperparameter quan trọng nhất · So sánh Optimizer · Khi mỗi Optimizer chiến thắng · Bước 1: SGD vani · Bước 2: SGD với Momentum · Bước 3: Adam · Bước 4: AdamW · Bước 5: So sánh Training"
      },
      {
        ...
        "summaryVi": "model của bạn nhận được 99% dữ liệu training và 60% dữ liệu thử nghiệm. Nó ghi nhớ thay vì học. Chính quy hóa là thuế bạn áp đặt vào sự phức tạp để buộc khái quát hóa.",
        "keywordsVi": "Quang phổ Overfitting · Dropout · Phân rã trọng lượng (Chính quy hóa L2) · Batch Chuẩn hóa · Chuẩn hóa lớp · RMSNorm · So sánh chuẩn hóa · Tăng cường dữ liệu dưới dạng chính quy hóa · Dừng sớm · Khi nào áp dụng những gì · Bước 1: Dropout (Chế độ huấn luyện và đánh giá) · Bước 2: Phân rã trọng lượng L2 · Bước 3: Chuẩn hóa Batch · Bước 4: Chuẩn hóa lớp · Bước 5: RMSNorm · Bước 6: Training có và không có quy tắc hóa"
      },
      {
        ...
        "summaryVi": "Khởi tạo sai và training không bao giờ khởi động. Khởi tạo bên phải và 50 layer huấn luyện mượt mà như 3.",
        "keywordsVi": "Vấn đề đối xứng · Variance Nhân giống qua các lớp · Xavier/Glorot Khởi tạo · Kaiming/He Khởi tạo · Transformer Khởi tạo · Độ lớn kích hoạt qua 50 lớp · Chọn Init phù hợp · Bước 1: Chiến lược khởi tạo · Bước 2: Chức năng kích hoạt · Bước 3: Forward Pass qua 50 lớp · Bước 4: Thử nghiệm · Bước 5: Trình diễn đối xứng · Bước 6: Báo cáo độ lớn từng lớp"
      },
      {
        ...
        "summaryVi": "learning rate là hyperparameter quan trọng nhất. Không phải kiến trúc. Không phải là kích thước dataset. Không phải chức năng kích hoạt. Các learning rate. Nếu bạn không điều ch…",
        "keywordsVi": "Learning Rate liên tục · Phân rã bước · Ủ cosine · Khởi động: Tại sao bạn bắt đầu từ nhỏ · Khởi động tuyến tính + Phân rã Cosin · 1 chu kỳ Policy · Lên lịch hình dạng · Sơ đồ quyết định · Số thực từ Models đã xuất bản · Bước 1: Lên lịch chức năng · Bước 2: Trực quan hóa tất cả các lịch trình · Bước 3: Training mạng · Bước 4: So sánh tất cả các lịch trình · Bước 5: LR quá cao và quá thấp"
      },
      {
        ...
        "summaryVi": "Bạn đã xây dựng các tế bào thần kinh, lớp, mạng, backprop, kích hoạt, chức năng loss, optimizers, chính quy hóa, khởi tạo và lịch trình LR. Tất cả dưới dạng các mảnh riêng biệt.…",
        "keywordsVi": "Mô-đun trừu tượng hóa · Container tuần tự · Training so với chế độ đánh giá · Optimizer · DataLoader · Framework Kiến trúc · Vòng lặp Training · Hệ thống phân cấp mô-đun · Bước 1: Cơ sở mô-đun Class · Bước 2: Lớp tuyến tính · Bước 3: Mô-đun kích hoạt · Bước 4: Mô-đun Dropout · Bước 5: BatchNorm mô-đun · Bước 6: Container tuần tự · Bước 7: Loss chức năng · Bước 8: SGD và Adam Optimizers · Bước 9: DataLoader · Bước 10: Huấn luyện mạng 4 lớp về phân loại vòng tròn"
      },
      {
        ...
        "summaryVi": "Bạn đã chế tạo động cơ từ piston và trục khuỷu. Bây giờ hãy tìm hiểu cái mà mọi người thực sự lái xe.",
        "keywordsVi": "Tại sao PyTorch thắng · Tensors · Autograd · nn. Mô-đun · Loss Chức năng và Optimizers · Vòng lặp Training · Dataset và DataLoader · GPU Training · So sánh: Mini Framework vs PyTorch vs JAX · Bước 1: Tải MNIST từ tệp thô · Bước 2: Xác định Model · Bước 3: Vòng lặp Training · Bước 4: Nối mọi thứ lại với nhau · So sánh nhanh: Mini Framework vs PyTorch · Lưu và tải Models · Learning Rate Lập lịch"
      },
      {
        ...
        "summaryVi": "PyTorch đột biến tensors. TensorFlow xây dựng đồ thị. JAX biên dịch các hàm thuần túy. Điều cuối cùng đó thay đổi cách bạn nghĩ về deep learning.",
        "keywordsVi": "Triết lý JAX · jax. numpy: Bề mặt quen thuộc · jax.grad: Autodiff chức năng · jit: Biên dịch thành XLA · vmap: Vector hóa tự động · pmap: Dữ liệu song song trên các thiết bị · Pytrees: Cấu trúc dữ liệu phổ quát · Chức năng so với hướng đối tượng · Hệ sinh thái JAX · Khi nào nên sử dụng JAX so với PyTorch · Số ngẫu nhiên trong JAX · Bước 1: Thiết lập và dữ liệu · Bước 2: Khởi tạo Parameters · Bước 3: Forward Pass · Bước 4: Bước Training biên dịch JIT · Bước 5: Vòng lặp Training · Lanh: Tiêu chuẩn của Google · Equinox: Giải pháp thay thế Pythonic · Optax: Optimizers có khả năng kết hợp"
      },
      {
        ...
        "summaryVi": "Mạng của bạn đã được biên dịch. Nó chạy. Nó tạo ra một con số. Con số bị sai và không có gì bị sập. Chào mừng bạn đến với loại gỡ lỗi khó nhất - loại không có thông báo lỗi.",
        "keywordsVi": "Tư duy gỡ lỗi · Triệu chứng 1: Loss không giảm · Triệu chứng 2: Loss giảm nhưng Model là xấu · Triệu chứng 3: NaN hoặc Inf trong Loss · Kỹ thuật 1: Kiểm tra Gradient · Kỹ thuật 2: Thống kê kích hoạt · Kỹ thuật 3: Trực quan hóa luồng Gradient · Kỹ thuật 4: Thử nghiệm Overfit-One-Batch · Kỹ thuật 5: Công cụ tìm Learning Rate · Lỗi PyTorch thường gặp · Bảng gỡ lỗi chính · Bước 1: Trình gỡ lỗi NetworkDebugger Class · Bước 2: Kiểm tra Overfit-One-Batch · Bước 3: Learning Rate Finder · Bước 4: Trình kiểm tra Gradient · Bước 5: Cố tình phá vỡ mạng · PyTorch Công cụ tích hợp · Tích hợp trọng lượng & thiên vị · Bảng TensorBoard · Danh sách kiểm tra gỡ lỗi (trước khi Training đầy đủ)"
      }
    ]
  },
  {
    ...
    "lessons": [
      {
        ...
        "summaryVi": "Hình ảnh là một tensor của các mẫu ánh sáng. Mọi tầm nhìn model bạn sẽ sử dụng đều bắt đầu từ một thực tế này.",
        "keywordsVi": "Sơ chế đầy đủ pipeline trong nháy mắt · Pixel là mẫu, không phải hình vuông · Tại sao lại có ba kênh · Hai quy ước bố trí: HWC và CHW · Phạm vi byte và dtype · Không gian màu và lý do tại sao chúng tồn tại · Tỷ lệ khung hình, thay đổi kích thước và nội suy · Bước 1: Tải hình ảnh và kiểm tra hình dạng của nó · Bước 2: Chia kênh và sắp xếp lại bố cục · Bước 3: Chuyển đổi thang độ xám và HSV · Bước 4: Chuẩn hóa, chuẩn hóa và đảo ngược nó · Bước 5: Thay đổi kích thước bằng ba phương pháp nội suy"
      },
      {
        ...
        "summaryVi": "Tích chập là một lớp dày đặc nhỏ mà bạn trượt trên một hình ảnh, chia sẻ cùng một trọng lượng ở mọi vị trí.",
        "keywordsVi": "Một nhân, trượt · Công thức kích thước đầu ra · Đệm · Sải bước · Nhiều kênh đầu vào · Thủ thuật im2col · Trường tiếp nhận · Bước 1: Đệm một mảng · Bước 2: Tích chập 2D với các vòng lặp lồng nhau · Bước 3: Xác minh bằng hạt nhân được thiết kế thủ công · Bước 4: im2col · Bước 5: Chuyển đổi nhanh qua im2col + matmul · Bước 6: Một ngân hàng hạt nhân được thiết kế thủ công"
      },
      {
        ...
        "summaryVi": "Mọi CNN lớn trong ba mươi năm qua đều là cùng một công thức conv-phi tuyến tính-downsample với một ý tưởng mới được gắn kết. Tìm hiểu các ý tưởng theo thứ tự.",
        "keywordsVi": "Bốn ý tưởng thay đổi tầm nhìn · LeNet-5 (1998) · · AlexNet (2012) · VGG (2014) · Thành lập (2014, cùng năm) · Vấn đề xuống cấp · ResNet (2015) · Tại sao dư lại quan trọng ngoài tầm nhìn · Bước 1: LeNet-5 · Bước 2: Khối VGG · Bước 3: ResNet BasicBlock · Bước 4: Một ResNet nhỏ · Bước 5: So sánh hiệu quả parameter-feature"
      },
      {
        ...
        "summaryVi": "Bộ phân loại là một hàm từ pixel đến phân phối xác suất trên classes. Mọi thứ khác đều là hệ thống ống nước.",
        "keywordsVi": "Phân loại pipeline · Entropy chéo, logits và softmax · Tại sao tăng cường hoạt động · Trộn và cắt · Làm mịn nhãn · Đánh giá ngoài accuracy · Bước 1: Một dataset tổng hợp xác định · Bước 2: Chuẩn hóa và tăng cường · Bước 3: Trộn · Bước 4: Vòng lặp training · Bước 5: Kết hợp nó lại với nhau · Bước 6: Đọc ma trận nhầm lẫn"
      },
      {
        ...
        "summaryVi": "Một người khác đã dành một triệu GPU giờ để dạy một mạng lưới các cạnh, kết cấu và các bộ phận đối tượng trông như thế nào. Bạn nên mượn những features đó trước khi training của…",
        "keywordsVi": "Trích xuất Feature so với fine-tuning · Tại sao đông lạnh hoạt động · Tỷ lệ học tập phân biệt đối xử · Vấn đề BatchNorm · Thiết kế đầu · Phân rã LR theo lớp · Đánh giá những gì · Bước 1: Tải đường trục pretrained và kiểm tra nó · Bước 2: Feature chiết xuất - đông lạnh mọi thứ, thay đầu · Bước 3: Phân biệt đối xử fine-tuning · Bước 4: Xử lý BatchNorm · Bước 5: Vòng lặp fine-tuning đầu cuối tối thiểu · Bước 6: Giải phóng dần dần"
      },
      {
        ...
        "summaryVi": "Phát hiện là phân loại cộng với hồi quy, chạy ở mọi vị trí trong bản đồ feature, sau đó được dọn dẹp với sự triệt tiêu không tối đa.",
        "keywordsVi": "Phát hiện như dự đoán dày đặc · Tại sao nên sử dụng lưới và neo · Giải mã dự đoán · IoU · Ngăn chặn không tối đa · Các loss · Chỉ số phát hiện · Bước 1: IoU · Bước 2: Ngăn chặn không tối đa · Bước 3: Mã hóa và giải mã hộp · Bước 4: Đầu YOLO tối thiểu · Bước 5: Phân công cơ sở · Bước 6: Ba trận thua · Bước 7: Inference pipeline"
      },
      {
        ...
        "summaryVi": "Phân đoạn là phân loại ở mỗi pixel. U-Net làm cho nó hoạt động bằng cách ghép nối encoder lấy mẫu xuống với decoder lấy mẫu lên và kết nối bỏ qua dây giữa chúng.",
        "keywordsVi": "Ngữ nghĩa so với phiên bản so với toàn cảnh · Hình dạng U-Net · Chuyển vị so với mẫu lên hai tuyến tính · Entropy chéo trên lưới pixel · Xúc xắc loss và tại sao bạn cần nó · Chỉ số đánh giá · Đánh đổi độ phân giải đầu vào · Bước 1: Encoder chặn · Bước 2: Khối xuống và lên · Bước 3: U-Net · Bước 4: Thua lỗ · Bước 5: Chỉ số IoU · Bước 6: dataset tổng hợp để xác minh từ đầu đến cuối · Bước 7: Training vòng lặp"
      },
      {
        ...
        "summaryVi": "Thêm một mặt nạ nhỏ branch vào trình phát hiện R-CNN nhanh hơn và bạn có thể phân đoạn phiên bản. Phần khó là RoIAlign, và nó khó hơn vẻ ngoài của nó.",
        "keywordsVi": "Kiến trúc · Tại sao lại là RoIAlign, không phải RoIPool · RPN trong một đoạn văn · Đầu mặt nạ · Thua lỗ · Định dạng đầu ra · Bước 1: RoIAlign từ đầu · Bước 2: So sánh với RoIAlign của torchvision · Bước 3: Tải mặt nạ pretrained R-CNN · Bước 4: Chạy inference · Bước 5: Hoán đổi các đầu cho số lượng class tùy chỉnh · Bước 6: Đông lạnh những gì không cần training"
      },
      {
        ...
        "summaryVi": "GAN là hai mạng nơ-ron trong một trò chơi cố định. Một người hòa, một người chỉ trích. Họ trở nên tốt hơn với nhau cho đến khi những bức vẽ đánh lừa nhà phê bình.",
        "keywordsVi": "Hai mạng · Trò chơi · loss không bão hòa · Quy tắc kiến trúc DCGAN · Chế độ thất bại và chữ ký của chúng · Đánh giá · Bước 1: Máy phát điện · Bước 2: Phân biệt đối xử · Bước 3: Bước Training · Bước 4: Vòng lặp training đầy đủ trên các hình dạng tổng hợp · Bước 5: Sampling · Bước 6: Chuẩn hóa quang phổ"
      },
      {
        ...
        "summaryVi": "Một model khuếch tán học cách khử nhiễu. Huấn luyện nó để loại bỏ một chút nhiễu từ hình ảnh nhiễu, lặp lại điều đó ngược lại hàng nghìn lần và bạn có một trình tạo hình ảnh.",
        "keywordsVi": "Tiền đạo process · Bước nhảy dạng khép kín · Ngược lại process · Các training loss · Bộ lấy mẫu (DDPM) · Tại sao 1000 bước · DDIM: sampling nhanh hơn 20 lần · Điều kiện thời gian · Bước 1: Lịch trình nhiễu · Bước 2: Khuếch tán chuyển tiếp (q_sample) · Bước 3: Một U-Net nhỏ có điều kiện thời gian · Bước 4: Training vòng lặp · Bước 5: Bộ lấy mẫu (DDPM) · Bước 6: Bộ lấy mẫu DDIM (xác định, nhanh hơn ~20 lần)"
      },
      {
        ...
        "summaryVi": "Khuếch tán ổn định là DDPM chạy trong không gian tiềm ẩn của VAE pretrained, điều kiện dựa trên văn bản qua cross-attention, được lấy mẫu bằng bộ giải ODE xác định nhanh và được…",
        "keywordsVi": "Các pipeline · Classifier-free guidance (CFG) · Hình học không gian tiềm ẩn · Kiến trúc U-Net · LoRA fine-tuning · Bộ lập lịch bạn sẽ thấy · Bước 1: Chuyển văn bản thành hình ảnh · Bước 2: Hoán đổi bộ lập lịch · Bước 3: Chuyển hình ảnh thành hình ảnh · Bước 4: Sơn lại · Bước 5: Tải LoRA · Bước 6: LoRA training (phác thảo)"
      },
      {
        ...
        "summaryVi": "Video là một chuỗi hình ảnh cộng với vật lý kết nối chúng. Mỗi video model coi thời gian như một trục phụ (chuyển đổi 3D), một trình tự để tham dự (transformer) hoặc một feature…",
        "keywordsVi": "Ba gia đình kiến trúc · 2D + hồ bơi · Tích chập 3D · transformers không gian-thời gian · Khung sampling · Đánh giá · Datasets bạn sẽ gặp · Bước 1: Bộ lấy mẫu khung · Bước 2: Đường cơ sở 2D + hồ bơi · Bước 3: Chuyển đổi 3D thổi phồng theo phong cách I3D · Bước 4: Chuyển đổi phân tích (2 + 1) D"
      },
      {
        ...
        "summaryVi": "Tầm nhìn 3D có hai hương vị. Đám mây điểm là đầu ra thô của cảm biến. NeRF là trường thể tích đã học. Cả hai đều trả lời \"cái gì ở đâu trong không gian\".",
        "keywordsVi": "Đám mây điểm · Kiến trúc PointNet · Trường bức xạ thần kinh (NeRF) · Mã hóa vị trí trong NeRF · Kết xuất thể tích · Điều gì đã thay thế NeRF · Datasets và benchmarks · Bước 1: Bộ phân loại PointNet · Bước 2: Mã hóa vị trí · Bước 3: NeRF MLP tí hon · Bước 4: Kết xuất thể tích dọc theo một tia"
      },
      {
        ...
        "summaryVi": "Cắt hình ảnh thành các bản vá, coi mỗi bản vá như một từ, chạy một transformer tiêu chuẩn. Đừng nhìn lại.",
        "keywordsVi": "Các pipeline · Bản vá embedding · Class token · embedding vị trí · Transformer encoder khối · Tại sao pre-LN · Đánh đổi kích thước bản vá · Công thức của DeiT cho training ViT trên ImageNet-1k · Swin so với ConvNeXt · MAE pretraining · Bước 1: Vá embedding · Bước 2: Transformer chặn · Bước 3: ViT · Bước 4: Kiểm tra sự tỉnh táo - inference hình ảnh đơn lẻ"
      },
      {
        ...
        "summaryVi": "Edge inference là kỷ luật làm cho 90-accuracy model chạy ở tốc độ 30 khung hình / giây trên thiết bị có 2 GB RAM. Mỗi điểm phần trăm của accuracy được giao dịch với độ trễ mili …",
        "keywordsVi": "Ba ngân sách · Kỷ luật đo lường · FLOPs như một proxy · Định lượng trong một đoạn văn · Cắt tỉa và distillation · Các inference runtimes · Bộ chọn kiến trúc biên · Bước 1: Đo độ trễ chính xác · Bước 2: Số lượng Parameter và FLOP · Bước 3: Lượng tử tĩnh sau training · Bước 4: Xuất sang ONNX · Bước 5: Benchmark và so sánh chế độ"
      },
      {
        ...
        "summaryVi": "Hệ thống thị giác production là một chuỗi các models và quy tắc được khâu với các hợp đồng dữ liệu. Các mảnh đã ở giai đoạn này; capstone nối chúng lại với nhau từ đầu đến cuối.",
        "keywordsVi": "Các pipeline · Hợp đồng dữ liệu với Pydantic · Độ trễ đi đến đâu · Chế độ thất bại · Lô · Bước 1: Hợp đồng dữ liệu · Bước 2: Một Pipeline class tối thiểu · Bước 3: Nối dây máy dò và bộ phân loại · Bước 4: Dịch vụ FastAPI · Bước 5: Benchmark pipeline"
      },
      {
        ...
        "summaryVi": "Nhãn là nút thắt cổ chai của tầm nhìn có giám sát. pretraining tự giám sát loại bỏ chúng: tìm hiểu features trực quan từ 100 triệu hình ảnh không được gắn nhãn, fine-tune trên 1…",
        "keywordsVi": "Ba gia đình · Học tương phản (SimCLR) · Giáo viên-học sinh (DINO) · Tái tạo mặt nạ (MAE) · Tại sao lại là 75% chứ không phải 15% · Đánh giá đầu dò tuyến tính · Bước 1: Tăng cường hai chế độ xem pipeline · Bước 2: Thông tin NCE loss · Bước 3: Kiểm tra sự tỉnh táo InfoNCE · Bước 4: Mặt nạ kiểu MAE"
      },
      {
        ...
        "summaryVi": "Huấn luyện encoder hình ảnh và văn bản encoder với nhau để các cặp khớp (hình ảnh, chú thích) hạ cánh tại cùng một điểm trong không gian chung. Đó là toàn bộ mánh khóe.",
        "keywordsVi": "Hai tòa tháp · Mục tiêu · SigLIP: một loss tốt hơn · Phân loại Zero-shot · Nơi sử dụng models kiểu CLIP vào năm 2026 · Bước 1: Một model hai tháp nhỏ · Bước 2: loss tương phản · Bước 3: Zero-shot bộ phân loại · Bước 4: Kiểm tra sự tỉnh táo"
      },
      {
        ...
        "summaryVi": "OCR là một pipeline ba giai đoạn - phát hiện các hộp văn bản, nhận dạng các ký tự, sau đó bố trí chúng. Mọi hệ thống OCR hiện đại đều sắp xếp lại các giai đoạn này hoặc merges c…",
        "keywordsVi": "pipeline cổ điển · CTC trong một đoạn văn · models đầu cuối hiện đại · Phân tích cú pháp bố cục · Chỉ số đánh giá · Bước 1: CTC loss + decoder tham lam · Bước 2: Bộ nhận dạng CRNN tí hon · Bước 3: OCR tổng hợp · Bước 4: Training phác thảo"
      },
      {
        ...
        "summaryVi": "Một hệ thống truy xuất xếp hạng các ứng viên theo khoảng cách trong không gian embedding. Học số liệu là kỷ luật định hình không gian đó để khoảng cách có nghĩa là những gì bạn …",
        "keywordsVi": "Truy xuất trong nháy mắt · Bốn loss gia đình · Bộ ba loss chính thức · Độ tương đồng cosin so với L2 · Recall@K · FAISS trong một đoạn văn · Truy xuất cấp phiên bản so với cấp danh mục · Bước 1: loss bộ ba · Bước 2: Khai thác bán cứng · Bước 3: Recall@K · Bước 4: Ghép nó lại với nhau"
      },
      {
        ...
        "summaryVi": "Tư thế là một tập hợp các điểm chính được sắp xếp. Máy dò điểm chính là một hồi quy bản đồ nhiệt. Mọi thứ khác là sổ sách.",
        "keywordsVi": "Từ trên xuống so với từ dưới lên · Hồi quy bản đồ nhiệt · Bản địa hóa pixel phụ · Trường mối quan hệ một phần (PAF) · Điểm chính của COCO · 2D so với 3D · Bước 1: Mục tiêu bản đồ nhiệt Gaussian · Bước 2: Đầu keypoint nhỏ · Bước 3: Inference - trích xuất tọa độ điểm chính · Bước 4: Điểm chính tổng hợp dataset · Bước 5: Training"
      },
      {
        ...
        "summaryVi": "Một cảnh là một cloud của hàng triệu Gaussian 3D. Mỗi cái có một vị trí, hướng, tỷ lệ, độ mờ và màu sắc phụ thuộc vào hướng nhìn. Rasterize chúng, backprop thông qua rasterizati…",
        "keywordsVi": "Những gì một Gaussian mang theo · Rasterization, không phải ray diễu hành · Bước chiếu · Quy tắc tổng hợp alpha · Tại sao điều này có thể phân biệt được · Mật độ và cắt tỉa · Sóng hài hình cầu trong một đoạn văn · The 2026 production stack · Các biến thể 4D và tổng quát · Bước 1: Gaussian 2D · Bước 2: Rasteriser bắn tung tóe 2D · Bước 3: Cảnh bắn tung tóe 2D có thể huấn luyện · Bước 4: Lắp Gaussian 2D vào ảnh mục tiêu · Bước 5: Từ 2D sang 3D · Bước 6: Đánh giá sóng hài hình cầu"
      },
      {
        ...
        "summaryVi": "U-Net không phải là bí mật của sự khuếch tán. Thay thế nó bằng một transformer, hoán đổi lịch trình nhiễu cho luồng đường thẳng và đột nhiên bạn có SD3, FLUX và mọi model chuyển…",
        "keywordsVi": "Từ U-Net đến transformer · Luồng được chỉnh sửa trong một đoạn văn · Điều hòa AdaLN · encoders văn bản trong SD3 và FLUX · Classifier-free guidance vẫn giữ nguyên · Tính nhất quán, Turbo, Schnell, LCM · Model cảnh quan vào năm 2026 · Tại sao sự thay đổi giai đoạn này lại quan trọng · Bước 1: Khối DiT với AdaLN · Bước 2: Một DiT nhỏ · Bước 3: Chỉnh lưu training · Bước 4: Bộ lấy mẫu Euler · Bước 5: Kiểm tra khói từ đầu đến cuối"
      },
      {
        ...
        "summaryVi": "Cung cấp cho model một prompt văn bản và một hình ảnh và nhận mặt nạ cho mọi đối tượng phù hợp. SAM 3 đã biến nó thành một forward pass duy nhất.",
        "keywordsVi": "Ba thế hệ · Phân đoạn khái niệm nhanh chóng · Các công trình kiến trúc chính · Training trên quy mô lớn · Ghép kênh đối tượng SAM 3.1 · Nơi SAM nối đất vẫn quan trọng vào năm 2026 · YOLO-World so với SAM 3 · Hiệu quả SAM-MI · Định dạng đầu ra cho ba models · Bước 1: Prompt thi công · Bước 2: Trình trợ giúp xử lý hậu kỳ · Bước 3: Giao diện phân đoạn từ vựng mở thống nhất · Bước 4: Hugging Face cách sử dụng SAM 3 (tham khảo) · Bước 5: Đo lường những gì Grounded SAM 2 cung cấp cho bạn miễn phí"
      },
      {
        ...
        "summaryVi": "Tầm nhìn encoder chuyển đổi hình ảnh thành tokens. Máy chiếu MLP ánh xạ những tokens đó vào không gian embedding của LLM. Một ngôn ngữ model thực hiện rest. Mô hình đó - ViT-MLP…",
        "keywordsVi": "Kiến trúc ViT-MLP-LLM · Ngăn xếp sâu · Ba giai đoạn training · So sánh gia đình Model (đầu năm 2026) · agents trực quan · Khả năng Agentic + các biến thể RoPE · Vấn đề alignment · Fine-tuning với LoRA / QLoRA · Lý luận không gian còn yếu · Bước 1: Máy chiếu · Bước 2: Lắp ráp ViT-MLP-LLM đầu cuối · Bước 3: Tính toán CMER · Bước 4: Bộ phân loại VLM đồ chơi (có thể chạy)"
      },
      {
        ...
        "summaryVi": "Bản đồ độ sâu là hình ảnh một kênh trong đó mỗi pixel cách máy ảnh một khoảng cách. Dự đoán nó từ một khung RGB từng là không thể nếu không có âm thanh nổi hoặc LiDAR. Vào năm 2…",
        "keywordsVi": "Độ sâu tương đối so với số liệu · Mô hình encoder-decoder · Tại sao một hình ảnh duy nhất tạo ra chiều sâu · Những gì độ sâu một mắt không thể làm được · Depth Anything V3 vào năm 2026 · Cúc vạn thọ - khuếch tán cho chiều sâu · Nội tại và máy ảnh lỗ kim · Đánh giá · Bước 1: Chỉ số độ sâu · Bước 2: Mở rộng quy mô và dịch chuyển alignment · Bước 3: Nâng độ sâu đến một điểm cloud · Bước 4: Kiểm tra khói với cảnh độ sâu tổng hợp · Bước 5: Sử dụng Depth Anything V3 (tham khảo)"
      },
      {
        ...
        "summaryVi": "Theo dõi là phát hiện cộng với liên kết. Phát hiện mọi khung hình. Khớp các phát hiện của khung hình này với các rãnh của khung hình cuối cùng theo mã nhận dạng.",
        "keywordsVi": "Theo dõi bằng cách phát hiện · Bộ lọc Kalman trong một đoạn văn · Thuật toán Hungary · Ý tưởng chính của ByteTrack · Theo dõi dựa trên bộ nhớ SAM 2 · Ghép kênh đối tượng SAM 3.1 · Ba số liệu cần biết · Bước 1: Ma trận chi phí dựa trên IoU · Bước 2: Trình theo dõi kiểu SORT tối thiểu · Bước 3: Kiểm tra quỹ đạo tổng hợp · Bước 4: Chỉ số chuyển đổi ID"
      },
      {
        ...
        "summaryVi": "Một model video dự đoán những giây tiếp theo của một cảnh là một trình mô phỏng thế giới. Điều kiện dự đoán về hành động và bạn có một công cụ trò chơi đã học.",
        "keywordsVi": "Ba gia đình mô hình hóa thế giới · Kiến trúc Video DiT · Điều kiện về hành động: hành động tiềm ẩn models · Tính hợp lý vật lý · Thế giới lái xe tự động models · stack robot: VLM + model video + động lực học nghịch đảo · Đánh giá · Model cảnh quan vào năm 2026 · Bước 1: Vá lỗi 3D cho video · Bước 2: Mã hóa vị trí quay 3D · Bước 3: Chia khối attention · Bước 4: Soạn một video nhỏ DiT · Bước 5: Kiểm tra hình dạng"
      }
    ]
  },
  {
    ...
    "lessons": [
      {
        ...
        "summaryVi": "Ngôn ngữ là liên tục. Models là rời rạc. Tiền xử lý là cầu nối.",
        "keywordsVi": "Bước 1: một từ regex tokenizer · Bước 2: Porter stemmer (chỉ bước 1a) · Bước 3: một lemmatizer dựa trên tra cứu · Bước 4: nối chúng lại với nhau · NLTK · SpaCy · Khi nào nên chọn cái nào · Hai chế độ hỏng hóc không ai cảnh báo bạn"
      },
      {
        ...
        "summaryVi": "Đếm trước, suy nghĩ sau. TF-IDF vẫn đánh bại embeddings trong các nhiệm vụ được xác định rõ ràng vào năm 2026.",
        "keywordsVi": "Bước 1: xây dựng vốn từ vựng · Bước 2: túi từ · Bước 3: tần suất thuật ngữ và tần suất tài liệu · Bước 4: TF-IDF · Bước 5: Chuẩn hóa các hàng L2 · Khi TF-IDF vẫn thắng (tính đến năm 2026) · Khi TF-IDF thất bại · Kết hợp: embeddings trọng số TF-IDF"
      },
      {
        ...
        "summaryVi": "Một từ là công ty mà nó giữ. Huấn luyện một mạng nông về ý tưởng đó và hình học rơi ra.",
        "keywordsVi": "Bước 1: training cặp từ kho dữ liệu · Bước 2: embedding bảng · Bước 3: tiêu cực sampling mục tiêu · Bước 4: huấn luyện trên kho đồ chơi · Bước 5: thủ thuật tương tự · Khi Word2Vec vẫn thắng vào năm 2026 · Nơi Word2Vec không thành công"
      },
      {
        ...
        "summaryVi": "Word2Vec huấn luyện một embedding cho mỗi từ. GloVe đã phân tích ma trận đồng xuất hiện. FastText đã nhúng các mảnh. BPE nối với transformers.",
        "keywordsVi": "GloVe: phân tích ma trận đồng xuất hiện · FastText: embeddings nhận biết từ phụ · BPE: từ vựng phụ đã học · Khi nào nên chọn cái nào"
      },
      {
        ...
        "summaryVi": "Nhiệm vụ NLP chính tắc. Hầu hết những gì bạn cần biết về phân loại văn bản cổ điển đều hiển thị ở đây.",
        "keywordsVi": "Bước 1: một dataset nhỏ thực sự · Bước 2: Naive Bayes đa thức từ đầu · Bước 3: hồi quy logistics từ đầu · Bước 4: xử lý phủ định (chế độ lỗi) · Bước 5: Các chỉ số đánh giá quan trọng · Khi nào nên lấy transformer · Bẫy khả năng tái tạo (một lần nữa)"
      },
      {
        ...
        "summaryVi": "Kéo tên ra. Nghe có vẻ dễ dàng cho đến khi bạn đối phó với các ranh giới mơ hồ, các thực thể lồng nhau và biệt ngữ miền.",
        "keywordsVi": "Bước 1: Trình trợ giúp gắn thẻ BIO · Bước 2: features thủ công · Bước 3: một đường cơ sở dựa trên quy tắc + từ điển đơn giản · Bước 4: bước CRF (phác thảo, không đầy đủ) · Bước 5: BiLSTM-CRF bổ sung gì · NER dựa trên LLM (tùy chọn 2026) · Nơi NER cổ điển vẫn chiến thắng · Nơi nó sụp đổ"
      },
      {
        ...
        "summaryVi": "Ngữ pháp đã không hợp thời trong một thời gian. Sau đó, mọi LLM pipeline cần xác thực trích xuất có cấu trúc và nó đã quay trở lại.",
        "keywordsVi": "Bước 1: Đường cơ sở thẻ thường xuyên nhất · Bước 2: trình gắn thẻ bigram HMM · Bước 3: tại sao những người gắn thẻ hiện đại đánh bại điều này · Bước 4: phác thảo phân tích cú pháp phụ thuộc · Điều này vẫn quan trọng ở đâu vào năm 2026"
      },
      {
        ...
        "summaryVi": "Tích chập học n-gram. Tái phát ghi nhớ. Cả hai đều được thay thế bởi attention. Cả hai vẫn quan trọng trên phần cứng bị hạn chế.",
        "keywordsVi": "Bước 1: Nhắn tinCNN bằng PyTorch · Bước 2: Bộ phân loại LSTM · Bước 3: bản demo gradient biến mất (trực giác) · Bước 4: tại sao điều này vẫn chưa đủ"
      },
      {
        ...
        "summaryVi": "Hai RNN giả vờ là một phiên dịch. Nút thắt cổ chai mà họ gặp phải là lý do attention tồn tại.",
        "keywordsVi": "Bước 1: encoder · Bước 2: decoder · Bước 3: training vòng lặp với giáo viên ép buộc · Bước 4: inference vòng lặp (tham lam) · Bước 5: nút thắt cổ chai, được chứng minh · Khi nào vẫn nên tiếp cận seq2seq dựa trên RNN · bias phơi nhiễm và các biện pháp giảm thiểu"
      },
      {
        ...
        "summaryVi": "Người decoder ngừng nheo mắt vào một bản tóm tắt nén và bắt đầu xem toàn bộ nguồn. Mọi thứ sau này đều attention cộng với kỹ thuật.",
        "keywordsVi": "Bước 1: phụ gia (Bahdanau) attention · Bước 2: Hàm chấm và tổng quát · Bước 3: một ví dụ số đã làm việc · Bước 4: tại sao đây là cầu nối đến transformers · Khi attention cổ điển vẫn quan trọng · Bẫy attention trọng lượng như lời giải thích"
      },
      {
        ...
        "summaryVi": "Dịch thuật là nhiệm vụ đã trả tiền cho NLP nghiên cứu trong ba mươi năm và tiếp tục được trả tiền cho đến bây giờ.",
        "keywordsVi": "Bước 1: Cuộc gọi MT pretrained · Bước 2: BLEU và chrF · Hệ thống phân cấp đánh giá ba cấp (2026) · Bước 3: những gì phá vỡ production · Bước 4: fine-tuning cho một miền"
      },
      {
        ...
        "summaryVi": "Hệ thống trích xuất cho bạn biết tài liệu nói gì. Hệ thống trừu tượng cho bạn biết ý của tác giả. Nhiệm vụ khác nhau, cạm bẫy khác nhau.",
        "keywordsVi": "Bước 1: TextRank (trích xuất) · Bước 2: trừu tượng hóa với BART · Bước 3: Đánh giá ROUGE · Beyond ROUGE (đánh giá tóm tắt năm 2026) · Bước 4: bài toán thực tế"
      },
      {
        ...
        "summaryVi": "Ba hệ thống định hình QA hiện đại. Chiết xuất được tìm thấy spans. Tăng cường truy xuất đã đặt chúng vào các tài liệu. Generative tạo ra câu trả lời. Mỗi trợ lý AI hiện đại là s…",
        "keywordsVi": "Bước 1: khai thác QA với pretrained model · Bước 2: pipeline tăng cường truy xuất (phác thảo) · Bước 3: tạo ra với RAG · Bước 4: đánh giá phản ánh thế giới thực · RAGAS: framework đánh giá production năm 2026"
      },
      {
        ...
        "summaryVi": "BM25 chính xác nhưng giòn. Dense giăng một lưới rộng nhưng bỏ lỡ các từ khóa. Hybrid là mặc định năm 2026. Mọi thứ khác đều đang điều chỉnh.",
        "keywordsVi": "Bước 1: BM25 từ đầu · Bước 2: truy xuất dày đặc với bi-encoder · Bước 3: Hợp nhất xếp hạng đối ứng · Bước 4: tìm kiếm kết hợp + xếp hạng lại · Bước 5: đánh giá · Những bài học khó có được từ năm 2026 production RAG"
      },
      {
        ...
        "summaryVi": "LDA: tài liệu là hỗn hợp của các chủ đề, chủ đề là sự phân phối trên các từ. BERTopic: cụm tài liệu trong không gian embedding, cụm là chủ đề. Cùng một mục tiêu, sự phân hủy khá…",
        "keywordsVi": "Bước 1: LDA qua scikit-learn · Bước 2: BERTopic (production) · Bước 3: đánh giá"
      },
      {
        ...
        "summaryVi": "Nếu một từ đáng ngạc nhiên, model là xấu. Perplexity tạo ra một con số bất ngờ. Làm mịn giữ cho nó hữu hạn.",
        "keywordsVi": "Bước 1: đếm trigram · Bước 2: Làm mịn Laplace · Bước 3: Kneser-Ney (bigram, nội suy) · Bước 4: tạo văn bản bằng sampling · Bước 5: perplexity"
      },
      {
        ...
        "summaryVi": "ELIZA trả lời bằng các mẫu phù hợp. DialogFlow đã ánh xạ ý định. GPT trả lời từ tạ. Claude chạy các công cụ và xác minh. Mỗi thời đại giải quyết thất bại tồi tệ nhất của thời đạ…",
        "keywordsVi": "Bước 1: khớp mẫu dựa trên quy tắc · Bước 2: dựa trên truy xuất (Câu hỏi thường gặp) · Bước 3: tạo thần kinh (đường cơ sở) · Bước 4: LLM agent vòng lặp · Bước 5: định tuyến kết hợp"
      },
      {
        ...
        "summaryVi": "Một model, 100+ ngôn ngữ, không training dữ liệu cho hầu hết chúng. Chuyển giao đa ngôn ngữ là phép màu thực tế của những năm 2020.",
        "keywordsVi": "Bước 1: zero-shot phân loại đa ngôn ngữ · Bước 2: Không gian embedding đa ngôn ngữ · Bước 3: few-shot fine-tuning chiến lược · Thuế tokenization (điều gì xảy ra đối với các ngôn ngữ tài nguyên thấp)"
      },
      {
        ...
        "summaryVi": "Lời nói tokenizers nghẹn ngào những từ vô hình. Nhân vật tokenizers thổi bay độ dài trình tự. Subword tokenizers phân chia sự khác biệt. Mọi LLM ships hiện đại đều có trên một.",
        "keywordsVi": "Bước 1: BPE lại từ đầu · Bước 2: mã hóa với merges đã học · Bước 3: SentencePiece vào thực tế · Bước 4: tiktoken cho từ vựng tương thích với OpenAI"
      },
      {
        ...
        "summaryVi": "Yêu cầu một LLM cho JSON. Nhận JSON hầu hết thời gian. Trong production, \"hầu hết\" là vấn đề. Giải mã hạn chế biến \"hầu hết\" thành \"luôn luôn\" bằng cách chỉnh sửa logits trước k…",
        "keywordsVi": "Kết quả phản trực giác · Cạm bẫy khiến bạn phải trả giá · Bước 1: tạo regex hạn chế từ đầu · Bước 2: Đề cương cho JSON Schema · Bước 3: Người hướng dẫn cho Pydantic bất khả tri của nhà cung cấp · Bước 4: APIs nhà cung cấp gốc"
      },
      {
        ...
        "summaryVi": "\"T đòi hỏi h\" có nghĩa là cách đọc của con người t sẽ kết luận h là đúng. NLI là nhiệm vụ dự đoán sự lôi kéo / mâu thuẫn / trung lập. Nhàm chán trên bề mặt, chịu lực production.",
        "keywordsVi": "Bước 1: chạy model pretrained NLI · Bước 2: Phân loại zero-shot · Bước 3: Kiểm tra độ trung thực của RAG · Bước 4: Bộ phân loại NLI cuộn tay (khái niệm)"
      },
      {
        ...
        "summaryVi": "Word2Vec cung cấp cho bạn một vector cho mỗi từ. embedding models hiện đại cung cấp cho bạn vector trên mỗi đoạn văn, đa ngôn ngữ, với các chế độ xem thưa thớt, dày đặc và nhiều…",
        "keywordsVi": "Bảng xếp hạng MTEB kể một phần câu chuyện · Mô hình ba tầng · Bước 1: đường cơ sở - embeddings dày đặc với Sentence-BERT · Bước 2: Cắt bớt Matryoshka · Bước 3: Đa chức năng BGE-M3 · Bước 4: Đánh giá MTEB đối với một tác vụ tùy chỉnh · Bước 5: cosine cuộn bằng tay từ đầu"
      },
      {
        ...
        "summaryVi": "Chunking configuration ảnh hưởng đến chất lượng truy xuất nhiều như việc lựa chọn embedding model (Vectara NAACL 2025). Phân đoạn sai và không có số lần xếp hạng lại nào cứu bạn.",
        "keywordsVi": "Quy tắc đánh bại mọi mặc định · Bước 1: phân đoạn cố định và đệ quy · Bước 2: phân đoạn ngữ nghĩa · Bước 3: tài liệu cha mẹ · Bước 4: truy xuất theo ngữ cảnh (mẫu Anthropic) · Bước 5: Đánh giá"
      },
      {
        ...
        "summaryVi": "\"Cô ấy đã gọi cho anh ấy. Anh ta không trả lời. Bác sĩ đang ăn trưa.\" Ba đề cập đến hai người và không ai được nêu tên. Độ phân giải đồng tham chiếu tìm ra ai là ai.",
        "keywordsVi": "Bước 1: pretrained đồng tham chiếu thần kinh (AllenNLP / spaCy-experimental) · Bước 2: trình phân giải đại từ dựa trên quy tắc (giảng dạy) · Bước 3: sử dụng LLMs để đồng tham khảo · Bước 4: đánh giá"
      },
      {
        ...
        "summaryVi": "NER tìm thấy \"Paris\". Liên kết thực thể quyết định: Paris, Pháp? Paris Hilton? Paris, Texas? Paris (hoàng tử thành Troy)? Nếu không liên kết, biểu đồ tri thức của bạn vẫn mơ hồ.",
        "keywordsVi": "Hai phép đo · Bước 1: xây dựng chỉ mục bí danh từ chuyển hướng Wikipedia · Bước 2: định hướng dựa trên ngữ cảnh · Bước 3: Dựa trên embedding (kiểu BLINK) · Bước 4: liên kết thực thể tổng quát (khái niệm) · Bước 5: đánh giá trên AIDA-CoNLL"
      },
      {
        ...
        "summaryVi": "NER đã tìm thấy các thực thể. Liên kết thực thể neo họ. Trích xuất quan hệ tìm thấy các cạnh giữa chúng. Biểu đồ tri thức là tổng của các nút, cạnh và nguồn gốc của chúng.",
        "keywordsVi": "Bước 1: trích xuất dựa trên mẫu · Bước 2: phân loại quan hệ giám sát · Bước 3: Chiết xuất LLM nhắc bằng neo · Bước 4: chuẩn hóa vào một bản thể khép kín · Bước 5: xây dựng một biểu đồ nhỏ và truy vấn"
      },
      {
        ...
        "summaryVi": "Khớp chính xác và F1 bỏ lỡ sự tương đương ngữ nghĩa. Đánh giá của con người không mở rộng. LLM với tư cách là thẩm phán là câu trả lời production - với đủ hiệu chuẩn để tin tưởn…",
        "keywordsVi": "Bước 1: trung thành với NLI (kiểu RAGAS) · Bước 2: trả lời mức độ liên quan · Bước 3: Chỉ số tùy chỉnh G-Eval · Bước 4: CI cổng · Bước 5: đánh giá đồ chơi từ đầu"
      },
      {
        ...
        "summaryVi": "Gemini 3 Pro quảng cáo 10 triệu tokens ngữ cảnh. Ở tokens 1 triệu, MRCR 8 kim giảm xuống còn 26,3%. Quảng cáo ≠ sử dụng được. Đánh giá ngữ cảnh dài cho bạn biết năng lực thực tế…",
        "keywordsVi": "Những gì thực sự cần báo cáo · Bước 1: NIAH tùy chỉnh cho miền của bạn · Bước 2: biến thể nhiều kim · Bước 3: theo dõi biến nhiều bước (kiểu RULER) · Bước 4: LongBench v2 trên stack của bạn"
      },
      {
        ...
        "summaryVi": "\"Tôi muốn một nhà hàng giá rẻ ở phía bắc... thực sự làm cho nó vừa phải... và thêm tiếng Ý.\" Ba lượt, ba cập nhật trạng thái. DST giữ cho chính sách giá trị vị trí được đồng bộ …",
        "keywordsVi": "Các chế độ lỗi cổ điển · Bước 1: trình trích xuất khe dựa trên quy tắc · Bước 2: vòng lặp cập nhật trạng thái · Bước 3: DST điều khiển LLM với đầu ra có cấu trúc · Bước 4: Đánh giá JGA · Bước 5: xử lý hiệu chỉnh"
      }
    ]
  },
  {
    ...
    "lessons": [
      {
        ...
        "summaryVi": "Dạng sóng là tín hiệu thô. Quang phổ là biểu diễn. Mel features là hình thức thân thiện với ML. Mọi ASR và TTS pipeline hiện đại đều đi trên nấc thang này, và nấc thang đầu tiên…",
        "keywordsVi": "Bước 1: đọc clip và vẽ dạng sóng · Bước 2: tổng hợp sóng sin từ các nguyên lý đầu tiên · Bước 3: tính DFT bằng tay · Bước 4: tìm tần số thống trị · Bước 5: minh họa răng cưa"
      },
      {
        ...
        "summaryVi": "Mạng nơ-ron không tiêu thụ tốt dạng sóng thô. Họ tiêu thụ quang phổ. Họ tiêu thụ quang phổ mel thậm chí còn tốt hơn. Mọi ASR, TTS và bộ phân loại âm thanh vào năm 2026 đều sống …",
        "keywordsVi": "Bước 1: tạo khung dạng sóng · Bước 2: Cửa sổ Hann · Bước 3: Độ lớn STFT · Bước 4: mel filterbank · Bước 5: log-mel · Bước 6: MFCC"
      },
      {
        ...
        "summaryVi": "Tất cả mọi thứ từ \"tiếng chó sủa vs còi báo động\" đến \"đây là ngôn ngữ nào\" đều là phân loại âm thanh. Các features là mels. Kiến trúc di chuyển mỗi thập kỷ. Đánh giá vẫn là AUC…",
        "keywordsVi": "Class imbalance là thách thức thực sự · Đánh giá · Bước 1: làm nổi bật · Bước 2: tóm tắt độ dài cố định · Bước 3: k-NN · Bước 4: nâng cấp lên CNN trên log-mels · Bước 5: mặc định năm 2026 - fine-tune BEAT"
      },
      {
        ...
        "summaryVi": "Nhận dạng giọng nói là phân loại âm thanh ở mọi bước thời gian, được dán lại với nhau bằng một chuỗi model biết tiếng Anh và im lặng. CTC, RNN-T và attention là ba cách để làm đ…",
        "keywordsVi": "WER: một số · Bước 1: giải mã CTC tham lam · Bước 2: tìm kiếm chùm tia CTC · Bước 3: WER · Bước 4: inference chống lại Whisper · Bước 5: streaming với Vẹt đuôi dài hoặc wav2vec 2.0"
      },
      {
        ...
        "summaryVi": "Whisper là một decoder transformer encoder cửa sổ 30 giây, được huấn luyện trên 680 nghìn giờ các cặp âm thanh-văn bản được giám sát yếu đa ngôn ngữ. Một kiến trúc, nhiều tác vụ…",
        "keywordsVi": "Các biến thể vào năm 2026 · Fine-tuning · Bước 1: chạy Whisper ra khỏi hộp · Bước 2: dạng dài được cắt nhỏ · Bước 3: fine-tune với LoRA · Bước 4: kiểm tra những gì mỗi lớp học được"
      },
      {
        ...
        "summaryVi": "ASR hỏi \"họ đã nói gì?\" Nhận dạng người nói hỏi \"ai đã nói điều đó?\" Toán học trông giống nhau - embeddings cộng với cosin - nhưng mọi quyết định production đều phụ thuộc vào mộ…",
        "keywordsVi": "Chấm điểm · Những con số bạn nên biết (2026) · Ghi chém · Bước 1: embedding đồ chơi từ thống kê MFCC · Bước 2: độ tương tự cosin + ngưỡng · Bước 3: EER từ các cặp tương tự · Bước 4: production với SpeechBrain · Bước 5: diarize với pyannote"
      },
      {
        ...
        "summaryVi": "ASR đảo ngược lời nói thành văn bản; TTS đảo ngược văn bản thành giọng nói. stack 2026 gồm ba phần: → tokens văn bản, tokens → mel, mel → dạng sóng. Mỗi bộ phận có một model mặc…",
        "keywordsVi": "Sự phát triển của Vocoder · Đánh giá · Bước 1: đầu vào âm vị · Bước 2: chạy Kokoro (2026 CPU mặc định) · Bước 3: chạy F5-TTS với nhân bản giọng nói · Bước 4: Bộ mã hóa HiFi-GAN từ đầu · Bước 5: pipeline đầy đủ (mã giả)"
      },
      {
        ...
        "summaryVi": "Sao chép giọng nói đọc văn bản của bạn bằng giọng nói của người khác. Chuyển đổi giọng nói viết lại giọng nói của bạn thành giọng nói của người khác trong khi vẫn giữ nguyên nhữ…",
        "keywordsVi": "Đạo đức, không phải là một chốt · Số (2026) · Bước 1: phân hủy với nhận dạng-tổng hợp (demo chỉ mã trong main.py) · Bước 2: zero-shot nhân bản với F5-TTS · Bước 3: chuyển đổi giọng nói với KNN-VC · Bước 4: nhúng hình mờ · Bước 5: cổng chấp thuận"
      },
      {
        ...
        "summaryVi": "Thế hệ âm nhạc năm 2026: Suno v5 và Udio v4 thống trị thương mại; MusicGen, Mở âm thanh ổn định và mã nguồn mở dẫn đầu ACE-Step. Vấn đề kỹ thuật hầu hết đã được giải quyết. Vấn …",
        "keywordsVi": "Token LM qua tokens codec thần kinh · Khuếch tán qua mels hoặc tiềm ẩn · Lai (production) — Suno, Udio, Lyria · Đánh giá · Bước 1: tạo bằng MusicGen · Bước 2: điều hòa giai điệu · Bước 3: Đánh giá FAD · Bước 4: thêm vào quy trình làm việc LLM nhạc"
      },
      {
        ...
        "summaryVi": "Ngôn ngữ âm thanh năm 2026 models lý do hơn lời nói + âm thanh môi trường + âm nhạc. Qwen2.5-Omni-7B khớp với Âm thanh GPT-4o trên MMAU-Pro. Audio Flamingo Next đánh bại Gemini …",
        "keywordsVi": "Mẫu ba thành phần · Bản đồ model 2026 · Kiểm tra thực tế Benchmark (2026) · LALM hữu ích ở đâu vào năm 2026 · Nơi chúng KHÔNG (chưa) hữu ích · Bước 1: truy vấn Qwen2.5-Omni · Bước 2: mẫu máy chiếu · Bước 3: đo điểm chuẩn MMAU / LongAudioBench"
      },
      {
        ...
        "summaryVi": "Batch pipelines process một tệp. Thời gian thực pipelines process 20 mili giây tiếp theo trước khi 20 giây tiếp theo đến. Mọi AI đàm thoại, phòng thu phát sóng và bot điện thoại…",
        "keywordsVi": "Các vấn đề phổ biến · Bước 1: đệm vòng · Bước 2: Cổng VAD · Bước 3: streaming ASR · Bước 4: Trình xử lý gián đoạn"
      },
      {
        ...
        "summaryVi": "Tất cả mọi thứ từ bài 01-11, được khâu lại với nhau. Xây dựng một trợ lý giọng nói lắng nghe, suy luận và nói lại. Vào năm 2026, đó là một vấn đề kỹ thuật đã được giải quyết, kh…",
        "keywordsVi": "Bảy thành phần · Ba chế độ thất bại bạn sẽ gặp phải · stacks tham khảo production năm 2026 · Bước 1: chụp mic bằng chunking (mã giả) · Bước 2: Chụp lượt có cổng VAD · Bước 3: streaming → LLM → TTS STT · Bước 4: tool calling bên trong vòng lặp LLM · Bước 5: Xử lý gián đoạn"
      },
      {
        ...
        "summaryVi": "Thế hệ âm thanh năm 2026 gần như là tokens. EnCodec, SNAC, Mimi và DAC biến các dạng sóng liên tục thành các chuỗi rời rạc mà transformer có thể dự đoán. Sự phân chia token ngữ …",
        "keywordsVi": "Thủ thuật cốt lõi: Vector Quantization dư (RVQ) · Bốn codec quan trọng vào năm 2026 · Tốc độ khung hình quan trọng đối với mô hình ngôn ngữ · tokens ngữ nghĩa so với âm thanh · Chất lượng tái tạo năm 2026 (bit mỗi giây, tốc độ bit thấp hơn sẽ tốt hơn) · Bước 1: mã hóa bằng EnCodec · Bước 2: giải mã và đo lường tái tạo · Bước 3: phân tách ngữ nghĩa-âm thanh (kiểu Mimi) · Bước 4: tại sao AR LM qua codec tokens hoạt động"
      },
      {
        ...
        "summaryVi": "Mọi giọng nói agent sống hay chết dựa trên hai quyết định: người dùng có đang nói bây giờ không, và họ đã hoàn thành chưa? VAD trả lời câu đầu tiên. Phát hiện rẽ (VAD + im lặng-…",
        "keywordsVi": "Tầng VAD ba tầng · Key parameters và giá trị mặc định của chúng · Thủ thuật xả nước (Kyutai 2025) · So sánh VAD năm 2026 · Bước 1: cổng năng lượng · Bước 2: Silero VAD trong Python · Bước 3: máy trạng thái kết thúc · Bước 4: bộ xương thủ thuật xả"
      },
      {
        ...
        "summaryVi": "2024-2026 xác định lại AI giọng nói. Moshi ships một model duy nhất nghe và nói đồng thời với độ trễ 200 ms. Hibiki thực hiện dịch lời nói thành giọng nói từng đoạn. Cả hai đều …",
        "keywordsVi": "Kiến trúc Moshi · Tại sao văn bản độc thoại bên trong lại giúp ích · Hibiki: streaming dịch chuyển giọng nói thành giọng nói · stack Kyutai rộng lớn hơn (2026) · Sesame CSM - anh họ · Số hiệu suất năm 2026 · Bước 1: giao diện · Bước 2: vòng lặp song công · Bước 3: mục tiêu training (khái niệm) · Bước 4: Moshi thắng ở đâu và không thắng ở đâu"
      },
      {
        ...
        "summaryVi": "Nhân bản giọng nói shipped nhanh hơn phòng thủ. Hệ thống giọng nói production 2026 cần hai thứ: máy dò (AASIST, RawNet2) phân loại giọng nói thật và giả và hình mờ (AudioSeal) t…",
        "keywordsVi": "ASVspoof 5 — the 2024-2025 benchmark · AASIST và RawNet2 — phát hiện model gia đình · AudioSeal — mặc định hình mờ năm 2024 · Đánh dấu Wav · WaveVerify (Tháng Bảy 2025) · Lỗ hổng mà đối thủ khai thác · C2PA / Sáng kiến xác thực nội dung · Bước 1: một máy dò feature quang phổ đơn giản (đồ chơi) · Bước 2: Nhúng + phát hiện AudioSeal · Bước 3: đánh giá - EER · Bước 4: tích hợp production"
      },
      {
        ...
        "summaryVi": "Bạn không thể ship những gì bạn không thể đo lường. Bài học này đặt tên cho các chỉ số năm 2026 cho mọi tác vụ âm thanh: ASR (WER, CER, RTFx), TTS (MOS, UTMOS, SECS, WER-on-ASR-…",
        "keywordsVi": "ASR chỉ số · TTS chỉ số · Nhân bản giọng nói cụ thể · Xác minh người nói · Ghi chém · Phân loại âm thanh · Tạo âm nhạc · benchmarks ngôn ngữ âm thanh · Streaming Chuyển giọng nói thành giọng nói · Bảng xếp hạng năm 2026 · Bước 1: WER với chuẩn hóa · Bước 2: TTS WER khứ hồi · Bước 3: SECS để sao chép giọng nói · Bước 4: FAD để tạo nhạc · Bước 5: EER để xác minh người nói (cùng mã với Bài 6)"
      }
    ]
  },
  {
    ...
    "lessons": [
      {
        ...
        "summaryVi": "RNN process tokens từng cái một. Transformers process tất cả tokens cùng một lúc. Đặt cược kiến trúc duy nhất đó đã thay đổi mọi đường cong mở rộng quy mô trong deep learning sa…",
        "keywordsVi": "Bước 1: đo độ sâu nối tiếp · Bước 2: đếm các phép toán lý thuyết · Bước 3: chia tỷ lệ thực nghiệm trên các chuỗi dài"
      },
      {
        ...
        "summaryVi": "Attention là một bảng tra cứu nơi mọi từ hỏi \"ai quan trọng với tôi?\" - và tìm hiểu câu trả lời.",
        "keywordsVi": "Tương tự tra cứu cơ sở dữ liệu · Tính toán Q, K, V · Ma trận Attention · Tại sao nên mở rộng quy mô? · Softmax Biến điểm số thành trọng số · Tổng giá trị có trọng số · Pipeline đầy đủ · Bước 1: Softmax lại từ đầu · Bước 2: Chia tỷ lệ attention tích chấm · Bước 3: Self-attention class với các dự đoán đã học · Bước 4: Chạy nó trên một câu · Bước 5: Trực quan hóa attention với bản đồ nhiệt ASCII"
      },
      {
        ...
        "summaryVi": "Một người đứng đầu attention học từng mối quan hệ một. Tám đầu học tám. Đầu là tự do. Lấy nhiều hơn trong số họ.",
        "keywordsVi": "Bước 1: tách đầu từ attention một đầu mà chúng ta đã có · Bước 2: chạy attention sản phẩm chấm tỷ lệ trên mỗi đầu · Bước 3: Biến thể Attention truy vấn nhóm · Bước 4: thăm dò những gì mỗi đầu đã học"
      },
      {
        ...
        "summaryVi": "Attention là hoán vị-bất biến. \"Con mèo ngồi trên thảm\" và \"con mèo ngồi trên thảm\" tạo ra cùng một đầu ra mà không có tín hiệu vị trí. Ba thuật toán khắc phục nó - mỗi thuật to…",
        "keywordsVi": "Hình sin tuyệt đối · Dây thừng · ALiBi · Chọn gì vào năm 2026 · Bước 1: mã hóa hình sin · Bước 2: Áp dụng RoPE cho Q, K · Bước 3: Độ dốc và bias ALiBi · Bước 4: xác minh thuộc tính khoảng cách tương đối của RoPE"
      },
      {
        ...
        "summaryVi": "Attention là ngôi sao. Mọi thứ khác - dư lượng, chuẩn hóa, chuyển tiếp cross-attention - là giàn giáo cho phép bạn stack nó sâu.",
        "keywordsVi": "Sáu mảnh · Khối Encoder (được sử dụng bởi BERT, T5 encoder) · Khối Decoder (được sử dụng bởi GPT, T5 decoder) · Trước định mức so với sau định mức · Khối hiện đại hóa năm 2026 · Số lượng Parameter · Bước 1: các khối xây dựng · Bước 2: nối dây encoder 2 lớp và decoder 2 lớp · Bước 3: chạy về phía trước trên một ví dụ về đồ chơi · Bước 4: hoán đổi trong RMSNorm + SwiGLU"
      },
      {
        ...
        "summaryVi": "GPT dự đoán từ tiếp theo. BERT dự đoán một từ bị thiếu. Một câu khác biệt - và nửa thập kỷ của mọi thứ embedding hình dạng.",
        "keywordsVi": "Tín hiệu training · Các quy tắc BERT mặt nạ · Dự đoán câu tiếp theo (NSP) - và lý do tại sao nó bị loại bỏ · Điều gì đã thay đổi vào năm 2026: ModernBERT · Các trường hợp sử dụng vẫn chọn encoder vào năm 2026 · Bước 1: logic mặt nạ · Bước 2: chạy dự đoán MLM trên một kho dữ liệu nhỏ · Bước 3: So sánh các loại khẩu trang · Bước 4: fine-tune đầu"
      },
      {
        ...
        "summaryVi": "BERT nhìn thấy cả hai phía. GPT chỉ nhìn thấy quá khứ. Mặt nạ tam giác là dòng mã đơn lẻ quan trọng nhất trong AI hiện đại.",
        "keywordsVi": "Mặt nạ · training song song, inference nối tiếp · The loss - từng ca một · Chiến lược giải mã · Điều gì đã làm cho \"công thức GPT\" hoạt động · Bước 1: mặt nạ nhân quả · Bước 2: GPT-ish model 2 lớp · Bước 3: Dự đoán token tiếp theo, từ đầu đến cuối · Bước 4: sampling"
      },
      {
        ...
        "summaryVi": "Encoders hiểu. Decoders tạo. Đặt chúng lại với nhau và bạn sẽ có một model được xây dựng cho các tác vụ đầu vào → đầu ra: dịch, tóm tắt, viết lại, phiên âm.",
        "keywordsVi": "Vòng lặp chuyển tiếp · T5 pretraining — tham nhũng span · BART pretraining - khử nhiễu đa nhiễu · Inference · Khi nào nên chọn từng mẫu mã vào năm 2026 · Bước 1: span tham nhũng · Bước 2: xác minh khứ hồi · Bước 3: Nhiễu BART"
      },
      {
        "name": "Vision Transformers (ViT)",
        "status": "complete",
        ...
        "summaryVi": "Hình ảnh là một lưới các bản vá. Một câu là một lưới tokens. Cùng một transformer ăn cả hai.",
        "keywordsVi": "Bước 1 - vá lỗi · Bước 2 - embedding tuyến tính · Bước 3 - thêm `[CLS]` token, thêm embeddings vị trí · Bước 4 - transformer encoder tiêu chuẩn · Bước 5 - đầu · Các biến thể quan trọng · Tại sao phải mất một thời gian · Bước 1: hình ảnh giả mạo · Bước 2: vá lỗi · Bước 3: nhúng tuyến tính · Bước 4: đếm parameters để có ViT thực tế"
      },
      {
        ...
        "summaryVi": "Âm thanh là hình ảnh của tần số theo thời gian. Whisper là một ViT ăn quang phổ mel và nói lại.",
        "keywordsVi": "Bước 1 - lấy mẫu lại + cửa sổ · Bước 2 - thân tích chập · Bước 3 - encoder · Bước 4 - decoder · Bước 5 - tokens nhiệm vụ · Bước 6 - đầu ra · Kích thước thì thầm · Những gì Whisper không làm · Phong cảnh năm 2026 · Bước 1: tổng hợp âm thanh · Bước 2: quang phổ log-mel (đơn giản hóa) · Bước 3: đệm đến 30 giây · Bước 4: xây dựng prompt tokens"
      },
      {
        ...
        "summaryVi": "Một transformer 70B dày đặc kích hoạt mọi parameter cho mỗi token. Một MoE 671B chỉ kích hoạt 37B mỗi token và đánh bại nó trên mỗi benchmark. Sự thưa thớt là ý tưởng mở rộng qu…",
        "keywordsVi": "Hoán đổi FFN · Bài toán cân bằng tải · Chuyên gia chia sẻ · Chuyên gia chi tiết · Hồ sơ chi phí · Điểm mấu chốt: ký ức · Bước 1: bộ định tuyến · Bước 2: chạy 100 tokens qua bộ định tuyến · Bước 3: so sánh số lượng tham số"
      },
      {
        ...
        "summaryVi": "Training song song và bị ràng buộc bởi FLOP. Inference nối tiếp và ràng buộc bộ nhớ. Nút thắt cổ chai khác nhau, thủ thuật khác nhau.",
        "keywordsVi": "KV cache toán học · Flash Attention — thủ thuật lát gạch · Giải mã đầu cơ - chiến thắng độ trễ khác · Lô liên tục · PagedAttention — KV cache dưới dạng bộ nhớ ảo · Bước 1: KV cache · Bước 2: lát gạch softmax · Bước 3: so sánh giải mã naïve và cache trên thế hệ 100-token"
      },
      {
        "name": "Scaling Laws",
        "status": "complete",
        ...
        "summaryVi": "Bài báo Kaplan năm 2020 cho biết: model lớn hơn, loss thấp hơn. Bài báo Hoffmann năm 2022 cho biết: bạn chưa đủ training. Compute được chia thành hai nhóm - parameters và tokens…",
        "keywordsVi": "Định luật Hoffmann · Tại sao lại training quá mức · Sự xuất hiện vs sự mượt mà · Bức tranh năm 2026 · Bước 1: Chinchilla loss · Bước 2: biên giới tối ưu điện toán · Bước 3: chi phí quá training · Bước 4: so sánh với models thực tế"
      },
      {
        ...
        "summaryVi": "Mười ba bài học. Một model. Không có phím tắt.",
        "keywordsVi": "Những gì chúng tôi ship · Những gì chúng tôi không ship · Chỉ số mục tiêu · Bước 1: dữ liệu · Bước 2: model · Bước 3: training vòng lặp · Bước 4: lấy mẫu · Bước 5: đọc đầu ra"
      },
      {
        ...
        "summaryVi": "attention đầy đủ là một vòng tròn. Mọi token nhìn thấy mọi token, và ký ức phải trả giá. Bốn biến thể bẻ cong hình dạng của hình tròn và thu hồi một nửa chi phí.",
        "keywordsVi": "Cửa sổ trượt Attention (SWA) · Thưa thớt / Khối Attention · Attention vi sai (DIFF Transformer, 2024) · So sánh biến thể · Bước 1: mặt nạ nhân quả đầy đủ (đường cơ sở) · Bước 2: mặt nạ nhân quả cửa sổ trượt · Bước 3: mặt nạ thưa thớt cục bộ + sải bước · Bước 4: attention vi sai · Bước 5: KV cache kích thước"
      },
      {
        ...
        "summaryVi": "Giải mã tự hồi quy là nối tiếp. Mỗi token chờ đợi cái trước. Giải mã đầu cơ phá vỡ chuỗi: một model rẻ tiền nháp N tokens, model đắt tiền xác minh tất cả N trong một forward pas…",
        "keywordsVi": "Thuật toán cốt lõi · Điều gì quyết định tăng tốc · Medusa — bản nháp không có bản nháp model · EAGLE — bản nháp tốt hơn bằng cách sử dụng lại các trạng thái ẩn · Điệu nhảy KV cache · Bước 1: bước từ chối · Bước 2: phân phối dư · Bước 3: một bước đầu cơ · Bước 4: đo lường tỷ lệ chấp nhận · Bước 5: xác minh tương đương phân phối"
      }
    ]
  },
  {
    ...
    "lessons": [
      {
        ...
        "summaryVi": "Mọi model hình ảnh, model văn bản, model video và model 3D đều nằm gọn trong một trong năm nhóm. Chọn sai xô và bạn sẽ chiến đấu với phép toán trong nhiều tuần. Chọn đúng và mườ…"
      },
      {
        ...
        "summaryVi": "Một bộ mã hóa tự động đơn giản nén sau đó tái tạo. Nó ghi nhớ. Nó không tạo ra. Thêm một thủ thuật - buộc mã trông giống Gaussian - và bạn sẽ có một bộ lấy mẫu. Thủ thuật duy nh…",
        "keywordsVi": "Bước 1: encoder về phía trước · Bước 2: tham số lại và giải mã · Bước 3: ELBO · Bước 4: tạo"
      },
      {
        ...
        "summaryVi": "Thủ thuật của Goodfellow vào năm 2014 là bỏ qua hoàn toàn mật độ. Hai mạng. Một người làm giả. Một người bắt được chúng. Họ chiến đấu cho đến khi hàng giả không thể phân biệt đư…",
        "keywordsVi": "Bước 1: loss không bão hòa · Bước 2: một bước phân biệt cho mỗi bước máy phát điện · Bước 3: theo dõi thu gọn chế độ"
      },
      {
        ...
        "summaryVi": "Mở khóa lớn đầu tiên của năm 2014-2017 là kiểm soát những gì GAN tạo ra. Đính kèm nhãn, hình ảnh hoặc câu. Pix2Pix đã thực hiện phiên bản hình ảnh và nó vẫn đánh bại mọi model c…",
        "keywordsVi": "Bước 1: thêm điều kiện vào cả đầu vào G và D · Bước 2: huấn luyện có điều kiện · Bước 3: xác minh đầu ra trên mỗi class"
      },
      {
        "name": "StyleGAN",
        "status": "complete",
        ...
        "summaryVi": "Hầu hết các máy phát điện đều khuấy `z` vào mọi lớp cùng một lúc. StyleGAN tách nó ra: đầu tiên ánh xạ `z` đến một `w` trung gian, sau đó *tiêm* `w` ở mọi cấp độ phân giải thông…",
        "keywordsVi": "Bước 1: lập bản đồ mạng · Bước 2: Chuẩn hóa phiên bản thích ứng · Bước 3: nhiễu trên mỗi lớp"
      },
      {
        ...
        "summaryVi": "Ho, Jain, Abbeel (2020) đã đưa ra lĩnh vực này một công thức mà nó không thể bỏ cuộc. Phá hủy dữ liệu với nhiễu qua hàng nghìn bước nhỏ. Huấn luyện một mạng nơ-ron để dự đoán nh…",
        "keywordsVi": "Bước 1: lịch trình chuyển tiếp (mẫu đóng) · Bước 2: lấy mẫu `x_t` trong một lần chụp · Bước 3: một bước training · Bước 4: đảo ngược sampling"
      },
      {
        ...
        "summaryVi": "Khuếch tán không gian pixel trên 512×512 hình ảnh là một tội ác chiến tranh tính toán. Rombach et al. (2022) nhận thấy rằng bạn không cần tất cả các kích thước 786k để tạo ra mộ…",
        "keywordsVi": "Bước 1: encoder/decoder · Bước 2: khuếch tán trong không gian `z` · Bước 3: classifier-free guidance · Bước 4: text conditioning (khái niệm, không phải mã)"
      },
      {
        ...
        "summaryVi": "Chỉ riêng văn bản là một tín hiệu điều khiển vụng về. ControlNet cho phép bạn sao chép model khuếch tán pretrained và điều khiển nó bằng bản đồ độ sâu, khung hình tạo dáng, vẽ n…",
        "keywordsVi": "ControlNet (Zhang và cộng sự, 2023) · LoRA (Hu và cộng sự, 2021) · Bộ chuyển đổi IP (Ye và cộng sự, 2023) · Bước 1: LoRA toán · Bước 2: mạng bên zero-init"
      },
      {
        ...
        "summaryVi": "Chuyển văn bản thành hình ảnh tạo ra những điều mới. Inpainting sửa chữa những cái cũ. Trong production, 70% công việc hình ảnh có thể lập hóa đơn là chỉnh sửa - hoán đổi nền, x…",
        "keywordsVi": "Cách tiếp cận ngây thơ (và tại sao nó sai) · model sơn thích hợp · SDEdit (Meng và cộng sự, 2022) — chỉnh sửa miễn phí · InstructPix2Pix (Brooks và cộng sự, 2023) · Sơn lại (Lugmayr và cộng sự, 2022) · Bước 1: Dữ liệu DDPM 5-D · Bước 2: huấn luyện khử nhiễu trên tất cả 5 độ mờ · Bước 3: tại inference, đảo ngược nhận biết mặt nạ · Bước 4: sơn ngoài"
      },
      {
        ...
        "summaryVi": "Hình ảnh là tensor 2D. Video là video 3-D. Lý thuyết là như nhau; tính toán khó hơn 10-100 lần. Sora của OpenAI (tháng 2 năm 2024) đã chứng minh điều đó là có thể. Đến năm 2026,…",
        "keywordsVi": "Vá lỗi · DiT không gian thời gian · Text conditioning · Training · Bước 1: vá \"video\" 1-D tổng hợp · Bước 2: embedding vị trí trên mỗi khung hình · Bước 3: khử nhiễu nhìn thấy toàn bộ trình tự · Bước 4: kiểm tra độ kết hợp thời gian"
      },
      {
        ...
        "summaryVi": "Âm thanh là tín hiệu 1-D ở tần số 16-48 kHz. Một clip dài năm giây là 80-240k mẫu. Không transformer trực tiếp tham gia vào trình tự đó. Giải pháp cho mọi model âm thanh product…",
        "keywordsVi": "Codec âm thanh thần kinh · Hai mô hình tổng quát ở trên cùng · Bước 1: tokens âm thanh tổng hợp · Bước 2: huấn luyện một token dự đoán nhỏ · Bước 3: lấy mẫu có điều kiện"
      },
      {
        "name": "3D Generation",
        "status": "complete",
        ...
        "summaryVi": "3D là phương thức mà đòn bẩy 2D sang 3D mạnh nhất. Bước đột phá năm 2023 là 3D Gaussian Splatting. Các lớp đẩy tổng quát 2024-2026 khuếch tán đa chế độ xem + tái tạo 3D ở trên c…",
        "keywordsVi": "Đại diện: 3D Gaussian Splatting (Kerbl và cộng sự, 2023) · Khuếch tán đa chế độ xem · Chuyển văn bản thành pipelines 3D · NeRF (cho ngữ cảnh) · Bước 1: 2D Gaussian splat · Bước 2: kết xuất bằng cách tổng các splat · Bước 3: phù hợp với gradient descent"
      },
      {
        ...
        "summaryVi": "Khuếch tán models mất 20-50 bước sampling vì chúng đi theo một con đường cong từ nhiễu đến dữ liệu. Kết hợp dòng chảy (Lipman và cộng sự, 2023) và dòng chảy chỉnh lưu (Liu và cộ…",
        "keywordsVi": "Dòng chảy đường thẳng · Sampling · Lưu lượng chỉnh lưu (Liu 2022) · Tại sao điều này giành chiến thắng cho hình ảnh vào năm 2024 · Bước 1: training loss · Bước 2: inference nhiều bước · Bước 3: so sánh số bước"
      },
      {
        ...
        "summaryVi": "Mọi bảng xếp hạng model tổng quát đều trích dẫn FID, điểm CLIP và tỷ lệ thắng từ đấu trường ưa thích của con người. Mỗi con số có một chế độ thất bại mà một nhà nghiên cứu quyết…",
        "keywordsVi": "FID — chất lượng mẫu · Điểm CLIP - tuân thủ prompt · Sở thích của con người - ground truth · Bước 1: FID trong bốn dòng · Bước 2: Tương tự cosin kiểu CLIP · Bước 3: Tổng hợp Elo"
      },
      {
        ...
        "summaryVi": "Khuếch tán models lấy mẫu lặp đi lặp lại theo thời gian (các bước khử nhiễu). Các mẫu VAR lặp đi lặp lại theo tỷ lệ - nó dự đoán token 1x1, sau đó là 2x2, sau đó là 4x4, cho đến…",
        "keywordsVi": "Máy Tokenizer đa thang đo VQ-VAE · Dự đoán quy mô tiếp theo · Thế hệ · Tại sao Next-Scale chiến thắng Next-Token · Luật tỷ lệ · Mối quan hệ với sự khuếch tán"
      }
    ]
  },
  {
    ...
    "lessons": [
      {
        ...
        "summaryVi": "Một Process của Markov Decision là năm điều: trạng thái, hành động, chuyển tiếp, phần thưởng, chiết khấu. Mọi thứ trong RL - Q-learning, PPO, DPO, GRPO - đều tối ưu hóa trên hìn…",
        "keywordsVi": "Bước 1: một MDP xác định nhỏ · Bước 2: triển khai policy · Bước 3: tính `V^π` chính xác thông qua phương trình Bellman · Bước 4: `γ` là một hyperparameter có ý nghĩa vật lý"
      },
      {
        ...
        "summaryVi": "Lập trình động RL với gian lận. Bạn đã biết các chức năng chuyển đổi và phần thưởng; bạn chỉ cần lặp lại phương trình Bellman cho đến khi `V` hoặc `π` ngừng di chuyển. Đó là ben…",
        "keywordsVi": "Bước 1: xây dựng GridWorld MDP model · Bước 2: Đánh giá policy · Bước 3: Cải tiến policy · Bước 4: khâu chúng lại với nhau · Bước 5: lặp lại giá trị (phiên bản một vòng lặp)"
      },
      {
        ...
        "summaryVi": "Lập trình động cần một model. Monte Carlo không cần gì ngoài episodes. Chạy policy, theo dõi lợi nhuận, tính trung bình chúng. Ý tưởng đơn giản nhất trong RL - và là ý tưởng mở …",
        "keywordsVi": "Bước 1: rollout → danh sách (s, a, r) · Bước 2: tính toán lợi nhuận (quét ngược) · Bước 3: Đánh giá MC lần đầu · Bước 4: Điều khiển MC tham lam ε (bật-policy) · Bước 5: so sánh với tiêu chuẩn vàng DP"
      },
      {
        ...
        "summaryVi": "Monte Carlo đợi cho đến khi episode kết thúc. TD cập nhật sau mỗi bước bằng cách khởi động ước tính giá trị tiếp theo. Q-learning không policy và lạc quan; SARSA policy và thận …",
        "keywordsVi": "Bước 1: SARSA đối với policy tham lam ε · Bước 2: Q-learning · Bước 3: đường cong học tập · Bước 4: so sánh với sự thật của DP"
      },
      {
        ...
        "summaryVi": "2013: Mnih đã huấn luyện một mạng Q-learning trên các pixel thô, đánh bại mọi RL agent cổ điển trên bảy trò chơi Atari. 2015: mở rộng lên 49 trò chơi, được xuất bản trên tạp chí…",
        "keywordsVi": "Bước 1: phát lại bộ đệm · Bước 2: một mạng Q nhỏ (MLP thủ công) · Bước 3: cập nhật DQN · Bước 4: vòng lặp bên ngoài"
      },
      {
        ...
        "summaryVi": "Ngừng ước tính giá trị. Tham số hóa policy trực tiếp, tính toán gradient lợi nhuận kỳ vọng, bước lên dốc. Williams (1992) đã viết nó trong một định lý. Đó là lý do tại sao PPO, …",
        "keywordsVi": "Bước 1: softmax policy mạng · Bước 2: sampling và xác suất log · Bước 3: rollout với log-probs được chụp · Bước 4: TĂNG CƯỜNG cập nhật · Bước 5: đường cơ sở"
      },
      {
        ...
        "summaryVi": "REINFORCE ồn ào. Thêm một nhà phê bình học được `V̂(s)`, trừ nó khỏi lợi nhuận và bạn sẽ nhận được lợi thế có cùng kỳ vọng nhưng variance thấp hơn nhiều. Đó là diễn viên-nhà phê…",
        "keywordsVi": "Bước 1: một nhà phê bình · Bước 2: lợi thế n-step · Bước 3: Cập nhật kết hợp · Bước 4: song song hóa (A3C so với A2C)"
      },
      {
        "name": "PPO",
        "status": "complete",
        ...
        "summaryVi": "A2C vứt bỏ từng rollout sau một lần cập nhật. PPO bao bọc policy gradient theo tỷ lệ quan trọng bị cắt để bạn có thể thực hiện 10+ epochs trên cùng một dữ liệu mà policy không p…",
        "keywordsVi": "Bước 1: chụp `log π_old(a | s)` tại thời điểm rollout · Bước 2: tính ưu điểm GAE (Bài 07) · Bước 3: cập nhật người thay thế bị cắt · Bước 4: giá trị và entropy · Bước 5: chẩn đoán"
      },
      {
        ...
        "summaryVi": "Con người không thể viết một hàm phần thưởng cho \"phản hồi trợ lý tốt\", nhưng họ có thể so sánh hai câu trả lời và chọn câu trả lời tốt hơn. Phù hợp với một model phần thưởng ch…",
        "keywordsVi": "Bước 1: dữ liệu ưu tiên tổng hợp · Bước 2: Phần thưởng Bradley-Terry model · Bước 3: policy giống PPO lên trên RM · Bước 4: giám sát KL · Bước 5: công thức production với TRL"
      },
      {
        "name": "Multi-Agent RL",
        "status": "complete",
        ...
        "summaryVi": "Single-agent RL giả định môi trường đứng yên. Đặt hai agents học tập trong cùng một thế giới và giả định đó gặp lỗi: mỗi agent là một phần của môi trường kia và cả hai đều đang …",
        "keywordsVi": "Bước 1: môi trường đa agent · Bước 2: Q-learning độc lập · Bước 3: Q tập trung với cập nhật giá trị phân hủy · Bước 4: tự chơi đơn giản (đối nghịch 2-agent)"
      },
      {
        ...
        "summaryVi": "Một policy được huấn luyện trong trình mô phỏng bị lỗi trên phần cứng là một policy ghi nhớ trình mô phỏng. Ngẫu nhiên miền, thích ứng miền và nhận dạng hệ thống là ba công cụ g…",
        "keywordsVi": "Bước 1: sim được tham số hóa · Bước 2: huấn luyện với DR · Bước 3: Đánh giá zero-shot trên phiếu \"thật\" · Bước 4: so sánh với training hẹp"
      },
      {
        "name": "RL for Games",
        "status": "complete",
        ...
        "summaryVi": "1992: TD-Gammon đánh bại các nhà vô địch con người ở môn cờ thỏ cáo với TD thuần túy. 2016: AlphaGo đánh bại Lee Sedol. 2017: AlphaZero thống trị cờ vua, shogi và cờ vây từ đầu.…",
        "keywordsVi": "Bước 1: một môi trường xác minh nhỏ · Bước 2: policy: softmax tokens câu trả lời trên K mỗi prompt · Bước 3: lợi thế sampling nhóm và lợi thế tương đối nhóm · Bước 4: so sánh với đường cơ sở REINFORCE (không có giá trị) · Bước 5: quan sát entropy và KL"
      }
    ]
  },
  {
    ...
    "lessons": [
      {
        ...
        "summaryVi": "LLM của bạn không đọc tiếng Anh. Nó đọc các số nguyên. tokenizer quyết định xem những số nguyên đó mang ý nghĩa hay lãng phí nó.",
        "keywordsVi": "Ba cách tiếp cận thất bại (và một cách chiến thắng) · BPE: Mã hóa cặp byte · BPE cấp độ byte (GPT-2, GPT-3, GPT-4) · WordPiece (BERT) · SentencePiece (Llama, T5) · Đánh đổi kích thước từ vựng · Thuế đa ngôn ngữ · Bước 1: Tokenizer cấp nhân vật · Bước 2: BPE Tokenizer từ đầu · Bước 3: Mã hóa và giải mã khứ hồi · Bước 4: So sánh với tiktoken · Bước 5: Phân tích từ vựng · TikToken (OpenAI) · Hugging Face tokenizers · Đang tải Tokenizer của Llama"
      },
      {
        ...
        "summaryVi": "Bài 01 cho bạn một món đồ chơi. Bài học này cho bạn một vũ khí.",
        "keywordsVi": "Toàn bộ Pipeline · BPE cấp độ byte · Tokenization trước · Tokens đặc biệt · Mẫu trò chuyện · Tốc độ · Bước 1: Mã hóa cấp độ byte · Bước 2: Tokenizer trước với Regex · Bước 3: BPE trên chuỗi byte · Bước 4: Xử lý Token đặc biệt · Bước 5: Tokenizer Class đầy đủ · Bước 6: Kiểm tra đa ngôn ngữ · So sánh Tokenizers thực tế"
      },
      {
        ...
        "summaryVi": "model là một tấm gương. Nó phản ánh bất kỳ dữ liệu nào bạn cung cấp cho nó. Cho nó ăn rác, nó phản ánh rác với sự trôi chảy hoàn hảo.",
        "keywordsVi": "Dữ liệu đến từ đâu · Làm sạch dữ liệu · Loại bỏ trùng lặp với MinHash · Đóng gói theo trình tự · Luật quy mô Chinchilla · Bước 1: Dọn dẹp văn bản · Bước 2: Khử trùng lặp MinHash · Bước 3: Mã hóa và đóng gói trình tự · Bước 4: DataLoader Training · Bước 5: Thống kê Dataset · So sánh với HuggingFace Datasets"
      },
      {
        ...
        "summaryVi": "GPT-2 Small có 124 triệu parameters. Đó là 12 lớp transformer, 12 đầu attention và embeddings 768 chiều. Bạn có thể huấn luyện nó từ đầu trên một GPU duy nhất trong vài giờ. Hầu…",
        "keywordsVi": "Kiến trúc GPT · Khối Transformer · Attention: Cơ chế cốt lõi · KV Cache: Tại sao Inference lại nhanh · Điền trước vs Giải mã: Hai giai đoạn Inference · Vòng lặp Training · GPT-2 Nhỏ: Những con số · Bước 1: Embedding Layer · Bước 2: Self-Attention với mặt nạ nhân quả · Bước 3: Multi-Head Attention · Bước 4: Transformer chặn · Bước 5: GPT Model đầy đủ · Bước 6: Vòng lặp Training · Bước 7: Tạo văn bản · Bản demo thế hệ và Training đầy đủ"
      },
      {
        ...
        "summaryVi": "124 triệu model của bạn được huấn luyện trên một GPU. Bây giờ hãy thử 7 tỷ parameters. model không vừa với bộ nhớ. Dữ liệu mất hàng tuần trên một máy duy nhất. training phân tán…",
        "keywordsVi": "Tại sao cần phân phối · Song song dữ liệu · Tensor Song song · Pipeline Song song · FSDP: Dữ liệu phân mảnh hoàn toàn song song · ZeRO tốc độ sâu · Mixed Precision Training · Megatron-LM và song song 3D · Bước 1: Mô phỏng song song dữ liệu · Bước 2: Mô phỏng Tensor song song · Bước 3: Mô phỏng Pipeline song song · Bước 4: Máy tính bộ nhớ · Bước 5: Mô phỏng Mixed Precision · Chạy tất cả các mô phỏng"
      },
      {
        ...
        "summaryVi": "Một model cơ sở dự đoán token tiếp theo. Vậy là xong. Nó không làm theo hướng dẫn, trả lời câu hỏi hoặc từ chối các yêu cầu có hại. SFT là cầu nối giữa công cụ dự đoán token và …",
        "keywordsVi": "SFT thực sự làm gì · Định dạng dữ liệu · Tại sao nó hoạt động · Mặt nạ Loss · Training Hyperparameters · Quên thảm khốc · Số thực · Bước 1: Hướng dẫn Dataset · Bước 2: Tokenize với Chat Template · Bước 3: Mặt nạ Cross-Entropy Loss · Bước 4: Vòng lặp Training SFT · Bước 5: So sánh Base và SFT Model · Bước 6: Đo lường sự lãng quên thảm khốc · Bản demo SFT Pipeline đầy đủ"
      },
      {
        ...
        "summaryVi": "SFT dạy model làm theo hướng dẫn. Nhưng nó không dạy cho model phản ứng nào là TỐT HƠN. Hai câu trả lời đúng ngữ pháp, chính xác thực tế có thể khác nhau rất nhiều về mức độ hữu…",
        "keywordsVi": "Ba giai đoạn · Phần thưởng Model · PPO: Tối ưu hóa Policy gần · Mục tiêu PPO chi tiết · Hack phần thưởng · RLHF Pipelines thực tế · Bước 1: Dữ liệu ưu tiên tổng hợp · Bước 2: Thưởng kiến trúc Model · Bước 3: Bradley-Terry Loss · Bước 4: Vòng lặp PPO đơn giản hóa · Bước 5: So sánh điểm thưởng · Bản demo đầy đủ RLHF Pipeline"
      },
      {
        ...
        "summaryVi": "RLHF hoạt động. Nó cũng yêu cầu training ba models (SFT, model phần thưởng, policy), quản lý sự không ổn định của PPO và điều chỉnh hình phạt KL. DPO hỏi: điều gì sẽ xảy ra nếu …",
        "keywordsVi": "Thông tin chi tiết chính · Các DPO Loss · Tại sao DPO đơn giản hơn · Khi DPO Beats RLHF · Khi RLHF Beats DPO · Ngoài DPO: KTO, ORPO, SimPO · Triển khai DPO thực · Bước 1: Ưu tiên Dataset · Bước 2: Xác suất nhật ký trình tự · Bước 3: Các DPO Loss · Bước 4: DPO Training vòng lặp · Bước 5: So sánh DPO và RLHF · Bước 6: Phân tích độ nhạy beta · Bản demo đầy đủ DPO Pipeline"
      },
      {
        ...
        "summaryVi": "RLHF cần con người trong vòng lặp. AI hiến pháp thay thế hầu hết chúng bằng chính model. Viết một danh sách các nguyên tắc, yêu cầu model phê bình kết quả của chính mình dựa trê…",
        "keywordsVi": "Vòng lặp AI hiến pháp · Hiến pháp thực sự làm gì · GRPO: Tối ưu hóa Policy tương đối nhóm · Tại sao GRPO quan trọng đối với lý luận · Process Phần thưởng Models so với Phần thưởng Kết quả Models · Cải thiện bản thân: Hệ số phản hồi · Khi nào sử dụng cái gì · Bước 1: Hiến pháp · Bước 2: Tự phê bình và sửa đổi · Bước 3: Phần thưởng dựa trên quy tắc · Bước 4: Lợi thế tương đối nhóm · Bước 5: Cập nhật GRPO · Bước 6: Vòng hoàn thiện bản thân"
      },
      {
        ...
        "summaryVi": "Định luật Goodhart: khi một thước đo trở thành mục tiêu, nó không còn là một thước đo tốt. Mọi trò chơi phòng thí nghiệm biên giới đều benchmarks. Điểm MMLU tăng lên trong khi m…",
        "keywordsVi": "Bối cảnh Eval · Tại sao Benchmarks Break · Perplexity: Kiểm tra sức khỏe nhanh · LLM với tư cách là thẩm phán · Xếp hạng ELO từ so sánh theo cặp · Đánh giá Frameworks · Xây dựng Evals tùy chỉnh · Bước 1: Đánh giá tối thiểu Framework · Bước 2: Chức năng tính điểm · Bước 3: Hệ thống đánh giá ELO · Bước 4: Tính toán Perplexity · Bước 5: Tổng hợp kết quả · Bước 6: Chạy toàn bộ Pipeline · Bước 7: Giải đấu ELO · Bước 8: So sánh Perplexity · lm-evaluation-harness (EleutherAI) · Promptfoo · RAGAS để đánh giá RAG"
      },
      {
        ...
        "summaryVi": "Một model 70B trong FP16 cần 140GB. Hai A100 chỉ dành cho trọng lượng. Lượng tử hóa thành FP8: một GPU 80GB. INT4: một MacBook.",
        "keywordsVi": "Định dạng số: Mỗi bit làm gì · Cách thức hoạt động của Quantization · Hệ thống phân cấp độ nhạy · PTQ so với QAT · GPTQ, AWQ, GGUF · Đo lường chất lượng · Số thực · Bước 1: Biểu diễn định dạng số · Bước 2: Quantization đối xứng (mỗi Tensor và mỗi kênh) · Bước 3: Đo lường chất lượng · Bước 4: Quét chiều rộng bit · Bước 5: Thí nghiệm độ nhạy · Bước 6: Mô phỏng GPTQ · Bước 7: Mô phỏng AWQ · Bước 8: Pipeline đầy đủ · Lượng tử hóa với AutoGPTQ · Định lượng hóa với AutoAWQ · Chuyển đổi sang GGUF · Phục vụ với vLLM"
      },
      {
        ...
        "summaryVi": "Hai giai đoạn xác định LLM inference. Điền trước processes prompt của bạn song song -- ràng buộc điện toán. Giải mã tạo ra tokens từng cái một -- ràng buộc bộ nhớ. Mọi tối ưu hó…",
        "keywordsVi": "Điền trước vs Giải mã · KV Cache · Lô liên tục · PagedChú ý · Giải mã suy đoán · Bộ nhớ đệm tiền tố · Động cơ Inference · Hoạt động: Byte Framework · Bước 1: KV Cache từ đầu · Bước 2: Attention với KV Cache · Bước 3: Trình mô phỏng lô liên tục · Bước 4: Tiền tố Cache · Bước 5: Trình mô phỏng giải mã suy đoán · Bước 6: Trình phân tích bộ nhớ KV Cache"
      },
      {
        ...
        "summaryVi": "Tất cả mọi thứ từ Bài học 01 đến 12 là một giai đoạn của một pipeline. Bài học này là giàn giáo biến các giai đoạn đó thành một giai đoạn đầu đến cuối duy nhất: mã hóa, huấn luy…",
        "keywordsVi": "Mười hai giai đoạn · Bản kê khai · Artifact Gõ · Cổng Eval · Người dàn nhạc · Theo dõi thử nghiệm và lưu trữ Artifact · Chi phí · Khả năng tái tạo so với Quyết định luận · Kế hoạch Rollback · Production công thức nấu ăn được quan sát vào năm 2026"
      },
      {
        ...
        "summaryVi": "Bạn đã xây dựng một GPT-2 Small từ đầu trong Bài 04. Frontier open models vào năm 2026 là cùng một gia đình với năm hoặc sáu thay đổi cụ thể. RMSNorm thay vì LayerNorm. SwiGLU t…",
        "keywordsVi": "Lõi bất biến · Sáu núm thực sự di chuyển · Núm 1: RMSNorm · Núm 2: RoPE · Núm 3: SwiGLU · Núm 4: Chia sẻ đầu Attention · Núm 5: Sự kết hợp của các chuyên gia · Núm 6: Giữ nguyên định mức trước · Model-by-Model khác biệt · Đọc một config. json · Ngân sách bộ nhớ kích hoạt · KV Cache ngân sách · Khi mỗi Model chiến thắng"
      },
      {
        ...
        "summaryVi": "Giai đoạn 7 · Bài học 16 đã chứng minh toán học: quy tắc từ chối Leviathan bảo toàn chính xác phân phối của trình xác minh. Bài học này là quan điểm training stack của năm 2026 …",
        "keywordsVi": "Bất biến: Leviathan từ chối sampling · Điều gì quyết định tăng tốc · Tiến trình hai năm · KV cache rollback · Dự thảo kiến trúc vào năm 2026 · Bước 1: quy tắc từ chối · Bước 2: phân phối dư · Bước 3: một bước đầu cơ đầy đủ · Bước 4: Sổ sách kế toán rollback KV · Bước 5: Kiểm tra Leviathan · Bước 6: tăng tốc so với α"
      },
      {
        ...
        "summaryVi": "Softmax attention trải một lượng nhỏ xác suất trên mọi token không khớp. Hơn 100k tokens nhiễu đó cộng lại và nhấn chìm tín hiệu. Transformer vi sai (Ye và cộng sự, ICLR 2025) k…",
        "keywordsVi": "Sàn ồn của softmax · Ý tưởng khác biệt · Tại sao điều này phù hợp với tính năng khử nhiễu có đầu · V1 và V2: sự khác biệt · Khi nào cần tiếp cận nó · Nó stacks như thế nào với các núm 2026 khác · Bước 1: softmax attention tiêu chuẩn · Bước 2: chia Q, K thành hai nửa · Bước 3: hai softmax branches + trừ · Bước 4: Đo khử nhiễu · Bước 5: Kế toán parameter V1 vs V2"
      },
      {
        ...
        "summaryVi": "Ở tokens 64k, attention chiếm 70-80% độ trễ giải mã. Mỗi phòng thí nghiệm model mở đều có kế hoạch khắc phục. NSA của DeepSeek (bài báo tốt nhất ACL 2025) là một trong những bị …",
        "keywordsVi": "Ba branches song song · Tại sao điều này là \"có thể huấn luyện được\" · Hạt nhân được căn chỉnh phần cứng · Ngân sách điện toán · So sánh nó như thế nào · Bước 1: nén tokens thành khối · Bước 2: branch attention nén · Bước 3: top-k lựa chọn khối · Bước 4: attention cửa sổ trượt · Bước 5: cổng + kết hợp · Bước 6: tính toán đếm"
      },
      {
        ...
        "summaryVi": "Mỗi LLM tự hồi quy từ GPT-2 đến Llama 3 đoàn tàu trên một loss cho mỗi vị trí: dự đoán token tiếp theo. DeepSeek-V3 đã thêm một loss thứ hai cho mỗi vị trí: dự đoán token sau đó…",
        "keywordsVi": "Công thức MTP tuần tự · Tại sao tuần tự, không song song · Kế toán Parameter · Phần thưởng giải mã đầu cơ · Quan hệ với EAGLE · Bước 1: bảng embedding dùng chung · Bước 2: kết hợp mỗi chiều sâu · Bước 3: khối transformer ở độ sâu k · Bước 4: đầu ra được chia sẻ · Bước 5: mỗi loss độ sâu · Bước 6: parameter kế toán"
      },
      {
        ...
        "summaryVi": "DeepSeek-V3 được huấn luyện trên 2.048 GPUs H800 với MoE chuyên gia nằm rải rác trên các nút. Giao tiếp tất cả của chuyên gia đa nút tốn 1 GPU giờ giao tiếp cho mỗi 1 GPU giờ tí…",
        "keywordsVi": "Pipeline bồi dưỡng song song · Ý tưởng 1: phân hủy khối · Ý tưởng 2: lập lịch hai chiều · Lịch trình theo dõi thủ công · Kế toán bong bóng · DualPipeV — sự tinh chỉnh · Ý nghĩa của việc chạy 14,8T-token · Nó nằm ở đâu trong stack"
      },
      {
        ...
        "summaryVi": "Giai đoạn 10 · Bài 14 đặt tên cho sáu núm kiến trúc mỗi lần mở model lượt. DeepSeek-V3 (Tháng 12 năm 2024, tổng cộng 671B parameters, 37B đang hoạt động) xoay tất cả sáu và thêm…",
        "keywordsVi": "Lõi bất biến, một lần nữa · Bước ngoặt: MLA thay vì GQA · Định tuyến: cân bằng tải không loss phụ trợ · MTP: training dày đặc hơn + bản nháp miễn phí · Các training: DualPipe · config, từng trường · Kế toán Parameter · Tỷ lệ 671B / 37B · Vị trí của DeepSeek-V3 · Tiếp theo: R1, V4"
      },
      {
        ...
        "summaryVi": "models không gian trạng thái (SSM) và transformers muốn những thứ khác nhau. Transformers mua chất lượng qua attention với chi phí bậc hai. SSM mua inference thời gian tuyến tín…",
        "keywordsVi": "SSM trong một trang · Khối Jamba · Tại sao lại có tỷ lệ 1:7 · Mã hóa vị trí · Ngân sách bộ nhớ · Mamba-3: đường cơ sở SSM thuần túy vào năm 2026 · Khi nào nên tiếp cận một con lai · Bối cảnh cạnh tranh"
      },
      {
        ...
        "summaryVi": "Giải mã suy đoán (Giai đoạn 10 · 15) song song hóa tokens trong một chuỗi. Nhiều agent frameworks song song trên toàn bộ chuỗi nhưng buộc phải phối hợp rõ ràng (bỏ phiếu, tách n…",
        "keywordsVi": "Thiết lập · Tại sao sự phối hợp xuất hiện · Việc đặt tên · RoPE làm cho điều này trở nên dễ dàng · Toán học thời gian tường · Ví dụ cụ thể · Khi nào nên tiếp cận Hogwild! · Khi nào không nên · Trạng thái thử nghiệm · Bước 1: bộ nhớ đệm được chia sẻ · Bước 2: vòng lặp worker · Bước 3: phỏng đoán phối hợp · Bước 4: tăng tốc đo được · Bước 5: nhấn mạnh sự phối hợp"
      },
      {
        ...
        "summaryVi": "Một biên giới LLM tạo ra một token yêu cầu một forward pass đầy đủ trên hàng tỷ parameters. forward pass đó được cung cấp quá mức: hầu hết thời gian một model nhỏ hơn nhiều có t…",
        "keywordsVi": "Thiết lập hai Model · Quy tắc chính xác · Tăng tốc dự kiến · Training bản nháp: Distillation · EAGLE: Soạn thảo cây + Tái sử dụng Feature · Xác minh Attention cây · Khi nó thắng, khi nó không"
      },
      {
        ...
        "summaryVi": "Backprop giữ mọi kích hoạt trung gian. Ở 70B parameters và ngữ cảnh 128K, đó là 3 TB kích hoạt cho mỗi cấp bậc. Điểm kiểm tra đánh đổi FLOPs cho bộ nhớ: tính toán lại thay vì lư…",
        "keywordsVi": "Những gì Backward thực sự cần · Điểm kiểm tra đầy đủ ngây thơ · Điểm kiểm tra có chọn lọc (Korthikanti 2022) · Giảm tải · Tính toán lại chi phí Model · Tiết kiệm bộ nhớ Model · Khi nào không nên Checkpoint · Các mẫu triển khai · Tương tác với TP / PP / FP8 · Bước 1: Một Model đồ chơi với các phân đoạn · Bước 2: Ngây thơ lùi cần tất cả các kích hoạt · Bước 3: Bộ nhớ Checkpoint-Every-k · Bước 4: Chi phí Model · Bước 5: Công cụ ước tính bộ nhớ · Bước 6: Kích thước phân đoạn tối ưu · Bước 7: Quyết định Checkpoint chọn lọc"
      }
    ]
  },
  {
    ...
    "lessons": [
      {
        ...
        "summaryVi": "Hầu hết mọi người viết prompts như họ đang nhắn tin cho một người bạn. Sau đó, họ tự hỏi tại sao một parameter model 200 tỷ lại đưa ra câu trả lời tầm thường. Kỹ thuật Prompt kh…",
        "keywordsVi": "Giải phẫu Prompt · Vai trò Prompting: Tại sao \"Bạn là một chuyên gia X\" hoạt động · Hướng dẫn rõ ràng: Nhịp điệu cụ thể mơ hồ · Kiểm soát định dạng đầu ra · Đặc điểm kỹ thuật ràng buộc · Temperature và Sampling · Bối cảnh Windows: Điều gì phù hợp với nơi · Mô hình Prompt · Chống hoa văn · Thiết kế Model Prompt chéo · Bước 1: Prompt Thư viện mẫu · Bước 2: Trình tạo Prompt · Bước 3: Kiểm thử đa Model Harness · Bước 4: So sánh và chấm điểm Prompt · Bước 5: Test Suite Runner · Bước 6: Chạy mọi thứ · OpenAI: Thông báo Temperature và hệ thống · Anthropic: Thông báo hệ thống + Điền trước trợ lý · Google: Gemini với Cài đặt an toàn · LangChain: Prompts bất khả tri của nhà cung cấp"
      },
      {
        ...
        "summaryVi": "Nói với một model phải làm gì là prompting. Chỉ cho nó cách suy nghĩ là kỹ thuật. Khoảng cách giữa 78% và 91% accuracy trên cùng một model, cùng một nhiệm vụ, cùng một dữ liệu k…",
        "keywordsVi": "Zero-Shot vs Few-Shot: Khi các ví dụ đánh bại hướng dẫn · Ví dụ về lựa chọn: Nhịp điệu tương tự ngẫu nhiên · Chain-of-Thought: Cho Models giấy nháp · Tính nhất quán: Lấy mẫu nhiều, bỏ phiếu một lần · Tree-of-Thought: Khám phá phân nhánh · ReAct: Suy nghĩ + Làm · Prompting có cấu trúc: Thẻ XML, dấu phân cách, tiêu đề · Prompt Chaining: Phân hủy tuần tự · So sánh hiệu suất · Bước 1: Few-Shot cửa hàng ví dụ · Bước 2: Trình tạo Chain-of-Thought Prompt · Bước 3: Tự bỏ phiếu nhất quán · Bước 4: Trình giải cây tư tưởng · Bước 5: Đầy đủ Pipeline · Với LangChain · Với DSPy · So sánh: From-Scratch vs Frameworks"
      },
      {
        ...
        "summaryVi": "LLM của bạn trả về một chuỗi. Ứng dụng của bạn cần JSON. Khoảng cách đó đã làm sập hệ thống production nhiều hơn bất kỳ ảo giác model nào. Đầu ra có cấu trúc là cầu nối giữa ngô…",
        "keywordsVi": "Phổ đầu ra có cấu trúc · JSON Schema: Ngôn ngữ hợp đồng · Mô hình Pydantic · Function Calling / Sử dụng công cụ · Chế độ lỗi phổ biến · Bước 1: Trình xác thực JSON Schema · Bước 2: Model kiểu Pydantic để Schema · Bước 3: Bộ lọc Token hạn chế · Bước 4: Chiết xuất Pipeline · Bước 5: Chạy toàn bộ Pipeline · OpenAI Đầu ra có cấu trúc · Anthropic Sử dụng công cụ · Thư viện giảng viên"
      },
      {
        ...
        "summaryVi": "Văn bản là rời rạc. Toán học là liên tục. Mỗi khi bạn yêu cầu một LLM tìm tài liệu \"tương tự\", so sánh ý nghĩa hoặc tìm kiếm ngoài từ khóa, bạn đang dựa vào một cầu nối giữa hai…",
        "keywordsVi": "Embedding là gì? · Bước đột phá của Word2Vec · Từ từ đến câu · Embedding Models hiện đại · Chỉ số tương tự · Cơ sở dữ liệu Vector và HNSW · Chiến lược Chunking · Bi-Encoders so với Cross-Encoders · Matryoshka Embeddings · Quantization nhị phân · Bước 1: Phân đoạn văn bản · Bước 2: Xây dựng Embeddings từ đầu · Bước 3: Chức năng tương tự · Bước 4: Vector lập chỉ mục bằng Tìm kiếm Brute-Force · Bước 5: Công cụ tìm kiếm ngữ nghĩa · Bước 6: So sánh các chỉ số tương tự"
      },
      {
        ...
        "summaryVi": "Kỹ thuật Prompt là một tập hợp con. Kỹ thuật ngữ cảnh là toàn bộ trò chơi. Một prompt là một chuỗi bạn nhập. Ngữ cảnh là mọi thứ đi vào cửa sổ của model: hướng dẫn hệ thống, tài…",
        "keywordsVi": "Context Window là một nguồn tài nguyên khan hiếm · Lạc giữa · Thành phần ngữ cảnh · Chiến lược nén ngữ cảnh · Hệ thống bộ nhớ · Lắp ráp ngữ cảnh động · Bước 1: Bộ đếm Token · Bước 2: Trình quản lý ngân sách ngữ cảnh · Bước 3: Sắp xếp lại Lost-in-the-Middle · Bước 4: Máy nén lịch sử hội thoại · Bước 5: Bộ chọn công cụ động · Bước 6: Lắp ráp ngữ cảnh đầy đủ Pipeline · Chiến lược ngữ cảnh của Claude Code · Tải ngữ cảnh động của con trỏ · ChatGPT Bộ nhớ · RAG như Kỹ thuật ngữ cảnh"
      },
      {
        ...
        "summaryVi": "LLM của bạn biết mọi thứ cho đến ngưỡng training của nó. Nó không biết gì về tài liệu của công ty bạn, cơ sở mã của bạn hoặc ghi chú cuộc họp của tuần trước. RAG giải quyết vấn …",
        "keywordsVi": "Mô hình RAG · Tại sao RAG Beats Fine-Tuning · Embedding Models · Vector Sự tương đồng · Chiến lược Chunking · Cơ sở dữ liệu Vector · Toàn bộ Pipeline · Số thực · Bước 1: Phân mảnh tài liệu · Bước 2: TF-IDF Embeddings · Bước 3: Tìm kiếm độ tương tự cosin · Bước 4: Xây dựng Prompt · Bước 5: Hoàn thành RAG Pipeline · Bước 6: Tạo (mô phỏng)"
      },
      {
        ...
        "summaryVi": "Basic RAG truy xuất top-k phần tương tự nhất. Điều đó hoạt động cho các câu hỏi đơn giản. Nó sụp đổ cho lý luận nhiều bước nhảy, truy vấn mơ hồ và kho dữ liệu lớn. Advanced RAG …",
        "keywordsVi": "Tìm kiếm kết hợp: Ngữ nghĩa + Từ khóa · Hợp nhất xếp hạng đối ứng (RRF) · Xếp hạng lại · Chuyển đổi truy vấn · Cha mẹ - Con cái Chunking · Lọc siêu dữ liệu · Đánh giá · Bước 1: Triển khai BM25 · Bước 2: Hợp nhất xếp hạng đối ứng · Bước 3: Tìm kiếm kết hợp Pipeline · Bước 4: Xếp hạng lại đơn giản · Bước 5: HyDE (Tài liệu giả định Embeddings) · Bước 6: Cha mẹ - Con cái Chunking · Bước 7: Đánh giá mức độ trung thành"
      },
      {
        ...
        "summaryVi": "Đầy đủ fine-tuning một model 7B yêu cầu 56GB VRAM. Bạn không có điều đó. Hầu hết các công ty cũng vậy. LoRA cho phép bạn fine-tune cùng một model trong 6GB training ít hơn 1% pa…",
        "keywordsVi": "LoRA: Thích ứng cấp thấp · Hệ số tỷ lệ: Alpha · Nơi đăng ký LoRA · Lựa chọn thứ hạng · QLoRA: Quantization 4 bit + LoRA · Câu hỏi về chất lượng · Chi phí trong thế giới thực · The 2026 PEFT stack · Hợp nhất bộ điều hợp · Khi nào KHÔNG Fine-Tune · Bước 1: Lớp LoRA · Bước 2: Lớp tuyến tính bọc LoRA · Bước 3: Tiêm LoRA vào Model · Bước 4: Đếm Parameters · Bước 5: Merge tạ trở lại · Bước 6: Mô phỏng QLoRA Quantization · Bước 7: Training vòng lặp · Bước 8: Demo đầy đủ"
      },
      {
        ...
        "summaryVi": "LLMs không thể làm bất cứ điều gì. Họ tạo ra văn bản. Đó là toàn bộ khả năng. Họ không thể kiểm tra thời tiết, truy vấn cơ sở dữ liệu, gửi email, chạy mã hoặc đọc tệp. Mỗi \"AI a…",
        "keywordsVi": "Vòng lặp Function Calling · Định nghĩa công cụ: Hợp đồng JSON Schema · So sánh nhà cung cấp · Lựa chọn công cụ: Tự động, Bắt buộc, Cụ thể · Function Calling song song · Đầu ra có cấu trúc so với Function Calling · Bảo mật: Các quy tắc không thể thương lượng · Xử lý lỗi · MCP: Giao thức ngữ cảnh Model · Bước 1: Xác định công cụ Registry · Bước 2: Triển khai 5 công cụ · Bước 3: Đăng ký tất cả các công cụ · Bước 4: Xây dựng vòng lặp Function Calling · Bước 5: Xác thực đối số · Bước 6: Chạy bản demo · OpenAI Function Calling · Anthropic Sử dụng công cụ · Tích hợp MCP"
      },
      {
        ...
        "summaryVi": "Bạn sẽ không bao giờ triển khai một web app mà không có các bài kiểm tra. Bạn sẽ không bao giờ ship việc di chuyển cơ sở dữ liệu mà không có kế hoạch rollback. Nhưng ngay bây gi…",
        "keywordsVi": "Phân loại Eval · LLM với tư cách là thẩm phán: Con ngựa làm việc · Thiết kế bảng đánh giá · The Eval Pipeline · Eval Datasets: Nền tảng · Kích thước mẫu và độ tin cậy · Kiểm tra hồi quy · Chi phí đánh giá · Chống hoa văn · Công cụ thực tế · Bước 1: Xác định cấu trúc dữ liệu Eval · Bước 2: Xây dựng người ghi điểm LLM với tư cách là giám khảo · Bước 3: Xây dựng chỉ số tự động · Bước 4: Xây dựng Máy tính khoảng tin cậy · Bước 5: Xây dựng Eval Runner và Báo cáo so sánh · Bước 6: Chạy bản demo · Tích hợp promptfoo · Tích hợp DeepEval · Mẫu tích hợp CI/CD"
      },
      {
        ...
        "summaryVi": "Hầu hết các công ty khởi nghiệp AI không chết vì models xấu. Họ chết vì kinh tế đơn vị tồi. Một cuộc gọi GPT-4o có giá chỉ bằng một phần của một xu. Mười nghìn người dùng thực h…",
        "keywordsVi": "Phân tích chi phí của một cuộc gọi LLM · Bộ nhớ đệm của nhà cung cấp: Giảm giá tích hợp · Semantic Caching: Lớp tùy chỉnh của bạn · Bộ nhớ đệm chính xác: Hash và Match · Giới hạn tỷ lệ: Bảo vệ ngân sách của bạn · Định tuyến Model: Đúng Model cho đúng công việc · Theo dõi chi phí: Biết tiền đi đâu · Batching: Giảm giá số lượng lớn · Cảnh báo ngân sách và bộ ngắt mạch · Tối ưu hóa Stack · Tiết kiệm thực sự: Trước và sau · Bước 1: Máy tính chi phí · Bước 2: Bộ nhớ cache chính xác · Bước 3: Bộ nhớ đệm ngữ nghĩa · Bước 4: Giới hạn tỷ lệ · Bước 5: Trình theo dõi chi phí · Bước 6: Model bộ định tuyến · Bước 7: Chạy bản demo · Anthropic Prompt Bộ nhớ đệm · OpenAI Bộ nhớ đệm tự động · OpenAI Batch API · Production Semantic Cache với Redis"
      },
      {
        ...
        "summaryVi": "Ứng dụng LLM của bạn sẽ bị tấn công. Không thể. Sẽ. Nỗ lực tiêm prompt đầu tiên vào hệ thống production của bạn sẽ đến trong vòng 48 giờ sau khi khởi chạy. Câu hỏi không phải là…",
        "keywordsVi": "Bánh mì Guardrail · Phân loại tấn công · Đầu vào Guardrails · Đầu ra Guardrails · Lọc nội dung Stack · Công cụ giao dịch · Phòng thủ chuyên sâu · Nghiên cứu điển hình về tấn công thực tế · Sự thật trung thực · Bước 1: Nhập Guardrails · Bước 2: Xuất Guardrails · Bước 3: Các Guardrail Pipeline · Bước 4: Bảng điều khiển giám sát · Bước 5: Chạy bản demo · OpenAI API kiểm duyệt · Bảo vệ lạc đà không bướu · NeMo Guardrails · Guardrails AI"
      },
      {
        ...
        "summaryVi": "Bạn đã xây dựng các lớp prompts, embeddings, RAG pipelines, function calling, bộ nhớ đệm và guardrails. Riêng biệt. Riêng biệt. Giống như luyện tập thang âm guitar mà không bao …",
        "keywordsVi": "Production Kiến trúc · Các Stack · Streaming: Tại sao nó lại quan trọng · Xử lý lỗi: Ba lớp · Observability: Những gì cần đo lường · A/B Kiểm thử Prompts trong Production · Ví dụ về kiến trúc thực tế · Mở rộng quy mô · Dự báo chi phí · Danh sách kiểm tra triển khai · Bước 1: Cơ sở hạ tầng cốt lõi · Bước 2: Quản lý Prompt · Bước 3: Bộ nhớ đệm ngữ nghĩa · Bước 4: Guardrails · Bước 5: LLM người gọi bằng cách thử lại và Streaming · Bước 6: Yêu cầu Pipeline · Bước 7: Chạy bản demo đầy đủ · FastAPI Server (Triển khai Production) · Tích hợp API thực · Triển khai Docker"
      },
      {
        ...
        "summaryVi": "Mọi ứng dụng LLM được xây dựng trước năm 2025 đều phát minh ra schema công cụ của riêng mình. Sau đó, Anthropic shipped MCP, Claude chấp nhận nó, OpenAI áp dụng nó và đến năm 20…",
        "keywordsVi": "Cái bắt tay · Những gì MCP không phải là · Bước 1: MCP server tối thiểu · Bước 2: gọi MCP server từ máy chủ · Bước 3: HTTP transport có thể phát trực tuyến · Bước 4: xác định phạm vi và an toàn"
      },
      {
        ...
        "summaryVi": "system prompt của bạn là 4.000 tokens. Ngữ cảnh RAG của bạn là 20.000 tokens. Bạn gửi cả hai với mọi yêu cầu. Bạn cũng phải trả tiền cho cả hai - mọi lúc. Prompt bộ nhớ đệm cho …",
        "keywordsVi": "Bố cục thân thiện với bộ nhớ cache · Tính toán hòa vốn · Bước 1: Anthropic prompt bộ nhớ đệm với các điểm đánh dấu rõ ràng · Bước 2: TTL kéo dài một giờ · Bước 3: OpenAI bộ nhớ đệm tự động · Bước 4: Gemini bộ nhớ đệm ngữ cảnh rõ ràng · Bước 5: đo tỷ lệ trúng trong production"
      },
      {
        ...
        "summaryVi": "Vòng lặp ReAct được viết bằng tay là một `while True`. Vòng lặp ReAct được viết bằng LangGraph là một biểu đồ mà bạn có thể checkpoint, ngắt quãng, branch và du hành thời gian. …",
        "keywordsVi": "Bốn siêu năng lực · Bộ giảm tốc là điểm · Biểu đồ ReAct trong bốn nút · StateGraph so với Send (phân xuất) · Biểu đồ con · Bước 1: trạng thái và nút · Bước 2: chạy với thread · Bước 3: thêm ngắt human-in-the-loop · Bước 4: du hành thời gian để gỡ lỗi · Bước 5: hoán đổi con trỏ kiểm tra lấy production"
      },
      {
        ...
        "summaryVi": "Mỗi framework đều bán cùng một bản demo (nghiên cứu agent xây dựng một báo cáo) và ẩn cùng một lỗi (trạng thái schema chiến đấu với lớp orchestration). Chọn framework có trừu tư…",
        "keywordsVi": "\"Trừu tượng\" thực sự có nghĩa là gì · Câu hỏi về nhà nước · Câu hỏi phân nhánh · Câu hỏi observability · Chi phí và độ trễ · Khả năng tương tác"
      }
    ]
  },
  {
    ...
    "lessons": [
      {
        ...
        "summaryVi": "Trước bất cứ điều gì đa phương thức, một hình ảnh phải trở thành một chuỗi tokens một transformer có thể ăn. Bài báo ViT năm 2020 đã trả lời điều này bằng các bản vá pixel 16x16…",
        "keywordsVi": "Các bản vá lỗi dưới dạng tokens · embeddings vị trí · CLS token, đầu ra gộp và tokens đăng ký · Pretraining: giám sát, tương phản, che nắng, tự chưng cất · Luật tỷ lệ · Parameter tính cho một ViT · production config năm 2026"
      },
      {
        ...
        "summaryVi": "CLIP của OpenAI (2021) đã chứng minh một ý tưởng duy nhất đủ lớn để cung cấp năng lượng cho năm năm tới: căn chỉnh encoder hình ảnh và encoder văn bản trong cùng một không gian …",
        "keywordsVi": "encoder kép · Thông tin NCE loss · Temperature · Tại sao thang đo sigmoid tốt hơn (SigLIP) · Phân loại Zero-shot · Đầu dò tuyến tính và tinh chỉnh · SigLIP 2: NaFlex và features dày đặc · CĂN CHỈNH, CƠ BẢN, OpenCLIP, EVA-CLIP · Trần zero-shot"
      },
      {
        ...
        "summaryVi": "CLIP căn chỉnh hình ảnh và văn bản nhưng không thể tạo chú thích, trả lời câu hỏi hoặc tổ chức cuộc trò chuyện. BLIP-2 (Salesforce, 2023) đã giải quyết vấn đề đó bằng một cầu nố…",
        "keywordsVi": "Truy vấn có thể học được · Kiến trúc · Hai giai đoạn training · Kinh tế Parameter · InstructBLIP và Q-Former nhận biết hướng dẫn · MiniGPT-4 và cách tiếp cận chỉ dành cho máy chiếu · Tại sao LLaVA trở nên đơn giản hơn · cross-attention cổng: Chim hồng hạc, tổ tiên · Hậu duệ năm 2026"
      },
      {
        ...
        "summaryVi": "Flamingo (2022) của DeepMind đã làm hai điều trước bất kỳ ai khác. Nó cho thấy một model duy nhất có thể process các chuỗi hình ảnh, video và văn bản xen kẽ tùy ý. Và nó cho thấ…",
        "keywordsVi": "Các LLM đóng băng · Bộ lấy mẫu lại bộ nhận thức · cross-attention có cổng · cross-attention mặt nạ cho đầu vào xen kẽ · Học few-shot trong ngữ cảnh · Training dữ liệu · OpenFlamingo và Rái cá · Con cháu · So sánh với BLIP-2"
      },
      {
        ...
        "summaryVi": "LLaVA (Tháng Tư 2023) là kiến trúc đa phương thức được sao chép nhiều nhất trên hành tinh. Nó thay thế Q-Former của BLIP-2 bằng MLP 2 lớp, thay thế cross-attention có cổng của F…",
        "keywordsVi": "Kiến trúc · Giai đoạn 1: alignment máy chiếu · Giai đoạn 2: điều chỉnh hướng dẫn trực quan · Tại sao cộng đồng sao chép điều này · LLaVA-1.5 và LLaVA-NeXT · LLaVA-OneVision · So sánh với Q-Former · Định dạng prompt · Parameter kinh tế"
      },
      {
        ...
        "summaryVi": "Hình ảnh thực không phải là hình vuông 224x224. Biên lai là 9:16, biểu đồ là 16:9, quét y tế có thể là 4096x4096, ảnh chụp màn hình di động là 9:19.5. Câu trả lời VLM trước năm …",
        "keywordsVi": "NaViT và patch-n'-pack · AnyRes (LLaVA-NeXT) · M-RoPE (Qwen2-VL) · NaFlex (SigLIP 2) · Mặt nạ đóng gói · Token ngân sách"
      },
      {
        ...
        "summaryVi": "Tài liệu VLM trọng lượng mở 2024-2026 là một rừng bàn cắt bỏ. MM1 của Apple đã thử nghiệm 13 sự kết hợp của encoder hình ảnh, trình kết nối và hỗn hợp dữ liệu. Molmo của Allen A…",
        "keywordsVi": "Không gian thiết kế năm trục · Trục 1: Đầu nối encoder > · Trục 2: thiết kế đầu nối là rửa · Trục 3: Kích thước LLM đặt trần · Trục 4: dữ liệu — chú thích chi tiết của con người đánh bại distillation · Trục 5: độ phân giải và lịch trình của nó · So sánh có kiểm soát lăng trụ · Người hái cho năm 2026"
      },
      {
        ...
        "summaryVi": "Trước LLaVA-OneVision (Li và cộng sự, tháng 8 năm 2024), thế giới VLM mở có các dòng riêng biệt: LLaVA-1.5 cho hình ảnh đơn lẻ, models đa hình ảnh như Mantis và VILA, models vid…",
        "keywordsVi": "Ngân sách OneVision token · Chương trình giảng dạy ba giai đoạn · Tại sao chương trình giảng dạy hoạt động · skills kịch bản chéo mới nổi · Gộp token trực quan · LLaVA-OneVision-1.5 · Tương phản với Qwen2.5-VL"
      },
      {
        ...
        "summaryVi": "Họ Qwen-VL — Qwen-VL (2023), Qwen2-VL (2024), Qwen2.5-VL (2025), Qwen3-VL (2025) — là dòng model ngôn ngữ tầm nhìn mở có ảnh hưởng nhất vào năm 2026. Mỗi thế hệ đã đặt cược kiến…",
        "keywordsVi": "Qwen-VL (Tháng Tám 2023) · Qwen2-VL (Tháng Chín 2024) — M-RoPE và độ phân giải gốc · Qwen2.5-VL (Tháng Hai 2025) — FPS động + thời gian tuyệt đối · Qwen3-VL (Tháng Mười Một 2025) · M-RoPE về mặt toán học · Logic sampling FPS động · Đầu ra agent có cấu trúc"
      },
      {
        ...
        "summaryVi": "Mỗi VLM mở trước InternVL3 đều tuân theo cùng một công thức ba bước: lấy một văn bản LLM được huấn luyện trên hàng nghìn tỷ tokens văn bản, bắt vít vào encoder tầm nhìn, sau đó …",
        "keywordsVi": "pretraining đa phương thức gốc · V2PE (mã hóa vị trí trực quan thay đổi) · Bộ định tuyến độ phân giải hình ảnh (ViR) · Triển khai Ngôn ngữ Tầm nhìn Tách rời (DvD) · Chất lượng một giai đoạn so với nhiều giai đoạn · InternVL3.5 và InternVL-U · Đánh đổi pretraining bản địa"
      },
      {
        ...
        "summaryVi": "Mọi VLM chúng ta đã thấy cho đến nay đều giữ hình ảnh và văn bản riêng biệt. tokens hình ảnh đến từ một tầm nhìn encoder, chảy vào máy chiếu, sau đó gặp văn bản bên trong LLM. T…",
        "keywordsVi": "VQ-VAE dưới dạng hình ảnh tokenizer · Từ vựng được chia sẻ · Tạo phương thức hỗn hợp · Training ổn định - QK-Norm, dropout LayerNorm đặt hàng · Trần tái thiết tokenizer · Tắc kè hoa so với BLIP-2 / LLaVA · Fuyu và AnyGPT"
      },
      {
        ...
        "summaryVi": "Emu3 của BAAI (Wang và cộng sự, tháng 9 năm 2024) là kết quả năm 2024 lẽ ra phải kết thúc cuộc tranh luận khuếch tán so với tự hồi quy. Một transformer chỉ decoder kiểu Llama du…",
        "keywordsVi": "The Emu3 tokenizer · Một loss training · Classifier-free guidance và temperature · Ba vai trò, một model · Benchmarks · Chi phí điện toán · Tại sao điều này lại quan trọng"
      },
      {
        ...
        "summaryVi": "Chameleon và Emu3 đặt cược mọi thứ vào tokens rời rạc. Chúng hoạt động, nhưng nút thắt cổ chai quantization có thể nhìn thấy - chất lượng hình ảnh ổn định dưới models khuếch tán…",
        "keywordsVi": "Kiến trúc hai loss · Mặt nạ Attention: văn bản nhân quả + hình ảnh hai chiều · Khuếch tán loss bên trong transformer · MMDiT: Biến thể của Stable Diffusion 3 · Tại sao điều này đánh bại phong cách tắc kè hoa · Những gì nằm ở hạ lưu"
      },
      {
        ...
        "summaryVi": "Truyền máu kết hợp các đại diện liên tục và rời rạc. Show-o (Xie và cộng sự, tháng 8 năm 2024) đi theo hướng khác: văn bản tokens sử dụng dự đoán nhân quả token tiếp theo, hình …",
        "keywordsVi": "Khuếch tán rời rạc mặt nạ (MaskGIT) · Show-o: một transformer, mặt nạ lai · sampling song song · Nhiệm vụ trong một checkpoint · Lịch đeo khẩu trang · Hiển thị-o2 · Vị trí của Show-o"
      },
      {
        ...
        "summaryVi": "Các models đa phương thức thống nhất có một sự căng thẳng không thể tránh khỏi. Hiểu muốn features ngữ nghĩa - đầu ra SigLIP hoặc DINOv2 vectors phong phú với thông tin cấp khái…",
        "keywordsVi": "Mã hóa hình ảnh tách rời · Tại sao tính năng này hoạt động · Mở rộng quy mô dữ liệu - Janus vs Janus-Pro · JanusFlow — biến thể luồng chỉnh lưu · Công việc của cơ thể được chia sẻ · So với InternVL-U · Hạn chế"
      },
      {
        ...
        "summaryVi": "GPT-4o ships một sản phẩm mở nhất models không thể sao chép: một agent nghe giọng nói, xem video và nói lại trong thời gian thực. Câu trả lời về hệ sinh thái mở vào cuối năm 202…",
        "keywordsVi": "Bốn tokenizers cho bốn phương thức · Giải mã Streaming · Chương trình giảng dạy bốn giai đoạn · Chuỗi suy nghĩ trực quan · Đối thủ cạnh tranh trong any-to-any · Ngân sách độ trễ · Tại sao any-to-any vẫn khó khăn"
      },
      {
        ...
        "summaryVi": "Video không phải là một stack ảnh. Clip dài 5 giây có thứ tự nhân quả, động từ hành động và thời gian sự kiện mà hình ảnh model thể hiện được. Video-LLaMA (Zhang và cộng sự, Thá…",
        "keywordsVi": "Video-LLaMA: Q-former trên mỗi clip + branch âm thanh · Trò chuyện video và Video-LLaVA · Qwen2.5-VL và TMRoPE · Chiến lược sampling khung · Gộp trên mỗi khung hình · Bốn video benchmarks · Grounding định dạng đầu ra · Thực tiễn tốt nhất năm 2026"
      },
      {
        ...
        "summaryVi": "Một video 4K dài 1 giờ ở tốc độ 24 FPS, được vá và nhúng, sản xuất theo thứ tự 60 triệu tokens. Một podcast dài 2 giờ episode phiên âm là 30,000 tokens. Một bộ phim Blu-ray feat…",
        "keywordsVi": "Con đường 1: Bối cảnh vũ phu (Gemini 1.5, Claude Opus) · Đường dẫn 2: Ring attention (LWM, LongVILA) · Đường dẫn 3: Nén Token (Video-XL, LongVA) · Đường dẫn 4: Truy xuất Agentic (VideoAgent) · Kim trong đống cỏ khô benchmarks · Chọn con đường nào · Mô hình production 2026"
      },
      {
        ...
        "summaryVi": "Whisper (Radford và cộng sự, tháng 12 năm 2022) đã giải quyết nhận dạng giọng nói - 680 nghìn giờ nói đa ngôn ngữ được giám sát yếu, một decoder transformer encoder đơn giản, mộ…",
        "keywordsVi": "Quang phổ Log-Mel: feature đầu vào · Whisper's encoder · BEAT và encoders dành riêng cho âm thanh · Âm thanh Q-former · Vòng cung - SALMONN, Qwen-Audio, AF3 · Xếp tầng so với đầu đến cuối · Công thức production 2026 · MMAU — lý luận âm thanh benchmark"
      },
      {
        ...
        "summaryVi": "Bản demo sản phẩm của GPT-4o vào tháng 5 năm 2024 gây gián đoạn không phải vì model cơ bản mà vì hình dạng sản phẩm - giao diện giọng nói nơi bạn nói chuyện, model nhìn thấy nhữ…",
        "keywordsVi": "Người suy nghĩ và người nói chuyện · TMRoPE — vị trí đa phương thức được căn chỉnh theo thời gian · Tổng hợp giọng nói Streaming · VAD và lượt · Qwen3-Omni (Tháng Mười Một 2025) · Production ngân sách độ trễ · Toán học tỷ lệ Token"
      },
      {
        ...
        "summaryVi": "Lần đầu tiên một model đọc công thức từ một trang web và thực hiện nó trong robot nhà bếp là RT-2 (Google DeepMind, Tháng Bảy 2023). RT-2 đã rời rạc các hành động dưới dạng toke…",
        "keywordsVi": "tokenization hành động (RT-2) · OpenVLA — tham chiếu 7B mở · FAST tokenizer — giải mã hành động nhanh hơn · π0 và các hành động khớp luồng · GR00T N1 — hệ thống kép cho hình người · Mở X-Embodiment · Đồng fine-tuning so với chỉ robot · Giới hạn an toàn và hành động"
      },
      {
        ...
        "summaryVi": "Tài liệu không phải là ảnh. PDF, bài báo khoa học, hóa đơn hoặc biểu mẫu viết tay có bố cục, bảng, sơ đồ, chú thích, tiêu đề và cấu trúc ngữ nghĩa mà sự hiểu biết bằng hình ảnh …",
        "keywordsVi": "Kỷ nguyên 1 - OCR pipeline (trước năm 2021) · TrOCR (2021) · Kỷ nguyên 2 - Không OCR (2022-2023) · Bố cụcLMv3 (2022) · Tài liệu LLM (2023) · Kỷ nguyên 3 - VLM bản địa (2024+) · Biên giới Claude 4.7 / GPT-5 · Phương trình toán học và đầu ra LaTeX · Chữ viết tay · Công thức năm 2026"
      },
      {
        ...
        "summaryVi": "RAG truyền thống phân tích cú pháp PDF thành văn bản, chia thành các khối, nhúng các khối, lưu trữ vectors. Mỗi bước đều mất tín hiệu: OCR bỏ dữ liệu biểu đồ, chia nhỏ các hàng …",
        "keywordsVi": "ColBERT (2020) · ColPali · ColQwen2 và ColSmol · VisRAG · M3DocRAG · ViDoRe — the benchmark · RAG pipeline đầu cuối · Toán học lưu trữ · Khi RAG văn bản vẫn thắng"
      },
      {
        ...
        "summaryVi": "Tài liệu gốc tầm nhìn RAG là một lát cắt. Production RAG đa phương thức mở rộng hơn - truy xuất văn bản, hình ảnh, âm thanh và video cho các quy trình làm việc như lập kế hoạch …",
        "keywordsVi": "Truy xuất đa phương thức · Chiến lược hợp nhất · Thế hệ grounding · Các cuộc khảo sát năm 2025 · MuRAG — bài báo nền tảng · Một ví dụ production về kế hoạch chuyến đi · Agentic RAG đa phương thức · Đánh giá"
      },
      {
        ...
        "summaryVi": "Sản phẩm biên giới năm 2026 là một agent đa phương thức đọc ảnh chụp màn hình, nhấp vào nút, điều hướng giao diện người dùng web, điền vào biểu mẫu và hoàn thành quy trình làm v…",
        "keywordsVi": "GUI grounding - primitive · Hành động schemas · Chỉ ảnh chụp màn hình so với cây trợ năng · Bộ nhớ đường chân trời dài · Sử dụng công cụ trực quan · The 2026 benchmarks · Tại sao nó vẫn khó khăn · Capstone xây dựng nó"
      }
    ]
  },
  {
    ...
    "lessons": [
      {
        ...
        "summaryVi": "Một ngôn ngữ model tạo ra tokens. Một chương trình thực hiện hành động. Khoảng cách giữa hai điều đó là giao diện công cụ: một hợp đồng cho phép model yêu cầu một hành động và m…",
        "keywordsVi": "Bước một: mô tả · Bước hai: quyết định · Bước ba: thực hiện · Bước bốn: quan sát · Sự chia rẽ niềm tin · Vòng lặp tồn tại ở đâu · Tại sao không chỉ prompt model để phát ra JSON? · Bộ ngắt mạch · Giai đoạn 13 sẽ đi đến đâu từ đây"
      },
      {
        ...
        "summaryVi": "Ba nhà cung cấp biên giới hội tụ trên cùng một vòng lặp gọi công cụ vào năm 2024 và sau đó phân kỳ về mọi thứ khác. OpenAI sử dụng `tools` và `tool_calls`. Anthropic sử dụng các…",
        "keywordsVi": "Cấu trúc chung · Hình dạng khác biệt, từng trường · Giới hạn bạn sẽ thực sự đạt được · `tool_choice` hành vi · Cuộc gọi song song · Streaming · Lỗi và sửa chữa · Mẫu dịch thuật"
      },
      {
        ...
        "summaryVi": "Ba tra cứu thời tiết độc lập được nối tiếp là ba chuyến khứ hồi. Chạy chúng song song và tổng thời gian thu gọn xuống cuộc gọi đơn lẻ chậm nhất. Mỗi nhà cung cấp biên giới hiện …",
        "keywordsVi": "Bật song song · Tương quan id · Chạy cuộc gọi đồng thời · Streaming gọi công cụ · JSON một phần và bẫy phân tích cú pháp sớm · Hoàn thành không theo thứ tự · Benchmark: tuần tự so với song song · Đồng hồ treo tường quạt ra Streaming"
      },
      {
        ...
        "summaryVi": "\"Yêu cầu model một cách tử tế để trả lại JSON\" thất bại từ 5 đến 15 phần trăm thời gian, ngay cả trên models biên giới. Đầu ra có cấu trúc thu hẹp khoảng cách đó bằng cách giải …",
        "keywordsVi": "JSON Schema 2020-12 — ngôn ngữ chung · Pydantic, ràng buộc Python · Zod, ràng buộc TypeScript · Từ chối · Giải mã hạn chế trong công khai · Ba chế độ thất bại · Chiến lược thử lại · Hỗ trợ model nhỏ"
      },
      {
        ...
        "summaryVi": "Một công cụ chính xác sẽ âm thầm thất bại khi model không thể biết khi nào nên sử dụng nó. Đặt tên, mô tả và hình dạng parameter thúc đẩy dao động 10 đến 20 điểm phần trăm trong…",
        "keywordsVi": "Quy tắc đặt tên · Mô tả mẫu · Nguyên tử vs nguyên khối · Thiết kế Parameter · Thông báo lỗi dưới dạng tín hiệu giảng dạy · Phiên bản · Phòng chống ngộ độc dụng cụ · Benchmarks"
      },
      {
        ...
        "summaryVi": "Mọi tích hợp trước MCP là một lần. Giao thức ngữ cảnh Model, lần đầu tiên được Anthropic shipped vào tháng 11 năm 2024 và hiện được quản lý bởi Agentic AI Foundation của Linux F…",
        "keywordsVi": "Ba server primitives · Ba primitives khách hàng · Định dạng dây: JSON-RPC 2.0 · Vòng đời ba pha · Đàm phán năng lực · Nội dung có cấu trúc và hình dạng lỗi · Khả năng của máy khách so với chi tiết lệnh gọi công cụ · Tại sao lại JSON-RPC mà không phải REST?"
      },
      {
        ...
        "summaryVi": "Hầu hết các hướng dẫn MCP chỉ hiển thị các thế giới xin chào. Một server thực sự hiển thị các công cụ cộng với tài nguyên cộng với prompts, xử lý đàm phán năng lực, phát ra các …",
        "keywordsVi": "Vòng lặp công văn · Triển khai `initialize` · Triển khai `tools/list` và `tools/call` · Triển khai tài nguyên · Triển khai prompts · Sự tinh tế của Stdio transport · Chú thích · Con đường tốt nghiệp"
      },
      {
        ...
        "summaryVi": "Hầu hết nội dung MCP ships server hướng dẫn và vẫy tay với khách hàng. Mã máy khách là nơi orchestration khó tồn tại: process sinh sản, đàm phán khả năng, hợp nhất danh sách côn…",
        "keywordsVi": "Sinh sản process trẻ em · Tiểu bang trên mỗi server session · Không gian tên Merged · Định tuyến · Sampling callback · Xử lý thông báo · Kết nối lại · Keepalive và id session"
      },
      {
        "name": "MCP Transports",
        "status": "complete",
        ...
        "summaryVi": "Stdio hoạt động tại địa phương và không ở đâu khác. HTTP có thể phát trực tuyến (26/03/2025) là tiêu chuẩn từ xa. HTTP+SSE transport cũ không còn được dùng nữa và sẽ bị xóa vào …",
        "keywordsVi": "STDIO · HTTP có thể phát trực tuyến · Một endpoint so với hai · Xác thực `Origin` và liên kết lại DNS · Vòng đời id Session · Keepalive và kết nối lại · Đầu dò tương thích ngược · Cloudflare, ngrok và lưu trữ · Thành phần Gateway · Transport chế độ thất bại · Khi nào nên bỏ qua HTTP có thể phát trực tuyến"
      },
      {
        ...
        "summaryVi": "Các công cụ nhận được 90% MCP attention. Hai cách còn lại server primitives giải quyết các vấn đề khác nhau. Tài nguyên hiển thị dữ liệu để đọc; prompts hiển thị các mẫu có thể …",
        "keywordsVi": "Công cụ vs tài nguyên so với prompts - quy tắc quyết định · Tài nguyên · Đăng ký tài nguyên · Mẫu tài nguyên (bổ sung 2025-11-25) · Prompts · Chủ nhà và prompts · Thông báo \"danh sách đã thay đổi\" · Quy ước kiểu nội dung · Tài nguyên động · Đăng ký so với thăm dò ý kiến · Prompts so với hệ thống prompts"
      },
      {
        "name": "MCP Sampling",
        "status": "complete",
        ...
        "summaryVi": "Hầu hết MCP servers là trình thực thi ngu ngốc: lấy đối số, chạy mã, trả về nội dung. Sampling cho phép một server lật hướng: nó yêu cầu LLM của khách hàng đưa ra quyết định. Đi…",
        "keywordsVi": "Yêu cầu `sampling/createMessage` · `modelPreferences` · `includeContext` · Sampling với các công cụ (SEP-1577) · Con người trong vòng lặp · Vòng lặp lưu trữ Server không có phím API · Rủi ro an toàn (Tiết lộ Đơn vị 42, 2026 Q1)"
      },
      {
        ...
        "summaryVi": "Đường dẫn được mã hóa cứng sẽ gặp lỗi khi người dùng mở một dự án khác. Các đối số công cụ được điền sẵn sẽ bị hỏng khi người dùng chỉ định thiếu. Root phạm vi server đến một tậ…",
        "keywordsVi": "Rễ · Tại sao roots là một primitive khách hàng · Elicitation: chế độ biểu mẫu mặc định · Elicitation: Chế độ URL (SEP-1036, thử nghiệm) · Khi elicitation là công cụ phù hợp · Khi elicitation sai · Cầu nối giữa con người trong vòng lặp"
      },
      {
        ...
        "summaryVi": "Công việc agent thực tế mất vài phút đến hàng giờ: chạy CI, tổng hợp nghiên cứu sâu batch xuất khẩu. Các lệnh gọi công cụ đồng bộ sẽ ngắt kết nối, hết thời gian chờ hoặc chặn gi…",
        "keywordsVi": "Tăng cường nhiệm vụ · Chọn tham gia cho mỗi công cụ · Tiểu bang · Phương pháp · Streaming thay đổi trạng thái · Trạng thái bền bỉ · Ngữ nghĩa hủy bỏ · Khôi phục sự cố · Tác vụ không đồng bộ cộng với sampling · Tại sao đây là thử nghiệm"
      },
      {
        "name": "MCP Apps",
        "status": "complete",
        ...
        "summaryVi": "Đầu ra của công cụ chỉ có văn bản giới hạn những gì agents có thể hiển thị. MCP Apps (SEP-1724, chính thức ngày 26 tháng 1 năm 2026) cho phép một công cụ trả về HTML tương tác s…",
        "keywordsVi": "Sơ đồ tài nguyên `ui://` · Iframe sandbox · postGiao thức tin nhắn · Quyền · Rủi ro bảo mật · `ui/initialize` bắt tay · AppRenderer / AppFrame SDK primitives · Trạng thái hệ sinh thái"
      },
      {
        ...
        "summaryVi": "Mô tả công cụ nằm trong ngữ cảnh của model nguyên văn. Các servers độc hại nhúng các hướng dẫn ẩn mà người dùng không bao giờ nhìn thấy. Nghiên cứu năm 2025-2026 từ Invariant La…",
        "keywordsVi": "Tấn công 1: ngộ độc dụng cụ · Tấn công 2: kéo thảm · Tấn công 3: đổ bóng công cụ server chéo · Tấn công 4: Tấn công thao túng tùy chọn MCP (MPMA) · Tấn công 5: toolchains ký sinh · Tấn công 6: sampling đòn tấn công · Tấn công 7: Chuỗi cung ứng giả mạo · Quy tắc hai (Meta, 2026) · Phòng thủ hiệu quả · Phòng thủ không hoạt động một mình"
      },
      {
        ...
        "summaryVi": "MCP servers từ xa cần authorization, không chỉ xác thực. Thông số kỹ thuật 2025-11-25 phù hợp với OAuth 2.1 + PKCE + chỉ báo tài nguyên (RFC 8707) + siêu dữ liệu tài nguyên được…",
        "keywordsVi": "Vai trò · Mã Authorization + PKCE · Siêu dữ liệu tài nguyên được bảo vệ (RFC 9728) · Chỉ số tài nguyên (RFC 8707) · Phạm vi model · authorization bước lên (SEP-835) · Xác thực đối tượng Token · tokens và xoay vòng trong thời gian ngắn · Không token chuyển qua · Phó phòng ngừa bối rối · Khám phá ID khách hàng · Gateways và OAuth"
      },
      {
        ...
        "summaryVi": "Doanh nghiệp không thể để mọi nhà phát triển cài đặt MCP servers ngẫu nhiên. Một gateway tập trung xác thực, RBAC, kiểm tra, giới hạn tốc độ, bộ nhớ đệm và phát hiện ngộ độc côn…",
        "keywordsVi": "Năm trách nhiệm gateway · Gateway dưới dạng một endpoint · Kho thông tin xác thực · Ghim băm công cụ ở gateway · Policy dưới dạng mã · Định tuyến nhận biết Session · Hợp nhất không gian tên · Registries · Đặt tên DNS ngược · Khảo sát nhà cung cấp, Tháng Tư 2026"
      },
      {
        ...
        "summaryVi": "Bài 16 đã đưa máy trạng thái OAuth 2.1 lên trong bộ nhớ. Đến năm 2026, mỗi MCP server bạn ship vào một tổ chức thực sự đều nằm sau production xác thực: đăng ký máy khách mở rộng…",
        "keywordsVi": "RFC 8414 — Siêu dữ liệu OAuth Authorization Server · RFC 9728 (tóm tắt) — Siêu dữ liệu tài nguyên được bảo vệ · Tài liệu siêu dữ liệu ID khách hàng (mặc định được đề xuất) · RFC 7591 — Đăng ký máy khách động (tương thích dự phòng / ngược) · RFC 8707 (tóm tắt) — Chỉ số tài nguyên · RFC 7636 (tóm tắt) - PKCE · MCP Spec 2025-11-25 Hồ sơ xác thực · Ma trận khả năng IdP · Mẫu làm mới JWKS (xoay ở AS, làm mới ở server tài nguyên) · Quy trình xác thực · Hướng dẫn phát lại khán giả (hạn chế đặc quyền truy cập token) · Các cuộc tấn công hỗn hợp (phòng thủ phía máy khách mà server không thể cung cấp) · Chế độ thất bại"
      },
      {
        "name": "A2A Protocol",
        "status": "complete",
        ...
        "summaryVi": "MCP là công cụ agent. A2A (Agent2Agent) là agent-to-agent - một giao thức mở để cho phép các agents mờ đục được xây dựng trên các frameworks khác nhau cộng tác. Được Google phát…",
        "keywordsVi": "Thẻ Agent · Thẻ Agent có chữ ký (AP2) · Vòng đời tác vụ · Tin nhắn và các bộ phận · Artifacts · Hai ràng buộc transport · Bảo quản độ mờ · Dòng thời gian · Mối quan hệ với MCP"
      },
      {
        ...
        "summaryVi": "Một agent gọi năm công cụ, ba MCP servers và hai agents phụ. Bạn cần một trace trên tất cả nó. Các quy ước ngữ nghĩa OpenTelemetry GenAI (thuộc tính ổn định trong v1.37 trở lên)…",
        "keywordsVi": "Span phân cấp · Thuộc tính bắt buộc · Span loại · Chụp nội dung chọn tham gia · Sự kiện trên spans · Nhà xuất khẩu · Tuyên truyền trên khắp MCP · Số liệu · Lớp AgentOps"
      },
      {
        ...
        "summaryVi": "Khóa nhà cung cấp rất tốn kém. Khối lượng công việc gọi công cụ khác nhau phù hợp với các models khác nhau. Định tuyến gateways cung cấp cho một bề mặt API, thử lại, failover, t…",
        "keywordsVi": "Hình dạng proxy tương thích với OpenAI · Model bí danh · Chuỗi dự phòng · Bộ nhớ đệm ngữ nghĩa · Guardrails · rate limits trên mỗi phím · Tự lưu trữ và đánh đổi được quản lý · Theo dõi chi phí · Định tuyến MCP plus · Chiến lược định tuyến"
      },
      {
        ...
        "summaryVi": "MCP nói \"những công cụ nào tồn tại\". Skills nói \"làm thế nào để thực hiện một nhiệm vụ\". 2026 stack lớp cả hai. Agent Skills của Anthropic (tiêu chuẩn mở, tháng 12 năm 2025) shi…",
        "keywordsVi": "AGENTS.md (agents.md) · Định dạng SKILL.md · Tiết lộ lũy tiến · Khám phá hệ thống tệp · Anthropic Claude Agent SDK · OpenAI Ứng dụng SDK · Tính di động agent chéo qua SkillKit · stack ba lớp"
      },
      {
        ...
        "summaryVi": "Giai đoạn 13 dạy từng phần. Capstone này kết nối chúng vào một hệ thống hình production: MCP server với các công cụ + tài nguyên + prompts + tác vụ + giao diện người dùng, OAuth…",
        "keywordsVi": "Kiến trúc · Trace phân cấp · Vị thế bảo mật · Kết xuất · Bao bì · Mỗi bài học Giai đoạn 13 đã đóng góp gì"
      }
    ]
  },
  {
    ...
    "lessons": [
      {
        ...
        "summaryVi": "Mỗi agent vào năm 2026 - Claude Code, Cursor, Devin, Operator - là một biến thể của vòng lặp ReAct từ năm 2022. Lý luận tokens xen kẽ với các lệnh gọi công cụ và quan sát cho đế…",
        "keywordsVi": "ReAct: định dạng chuẩn · Sự thay đổi năm 2026: lý luận bản địa · Năm thành phần · Tại sao vòng lặp này ở khắp mọi nơi · Cạm bẫy năm 2026"
      },
      {
        ...
        "summaryVi": "ReAct xen kẽ suy nghĩ và hành động trong một luồng. ReWOO tách chúng ra: một kế hoạch lớn trước, sau đó thực hiện. tokens ít hơn 5 lần, accuracy +4% trên HotpotQA và bạn có thể …",
        "keywordsVi": "Ba vai trò · Tại sao ít tokens hơn 5 lần · Tại sao nó mạnh mẽ hơn · Lập kế hoạch distillation · Lập kế hoạch và thực hiện (LangChain, 2023) · Kế hoạch và Hành động (Erdogan và cộng sự, arXiv: 2503.09572, ICML 2025) · Khi nào nên chọn cái nào"
      },
      {
        ...
        "summaryVi": "RL dựa trên Gradient cần hàng nghìn bản thử nghiệm và một cụm GPU để khắc phục chế độ lỗi. Reflexion (Shinn và cộng sự, NeurIPS 2023) thực hiện điều đó bằng ngôn ngữ tự nhiên: s…",
        "keywordsVi": "Ba thành phần · Ba loại đánh giá · Tại sao điều này khái quát hóa · Khi nào nó hoạt động và khi nào nó không"
      },
      {
        ...
        "summaryVi": "Một quỹ đạo chain-of-thought duy nhất không có chỗ để quay trở lại. ToT (Yao và cộng sự, 2023) biến lý luận thành một cái cây với khả năng tự đánh giá trên mỗi nút. LATS (Zhou v…",
        "keywordsVi": "Cây suy nghĩ (Yao và cộng sự, NeurIPS 2023) · LATS (Chu và cộng sự, ICML 2024) · MCTS, tối thiểu · Thực tế chi phí · Định vị năm 2026"
      },
      {
        ...
        "summaryVi": "Self-Refine (Madaan et al., 2023) sử dụng một LLM trong ba vai trò - tạo, phản hồi, tinh chỉnh - trong một vòng lặp. Mức tăng trung bình: +20 tuyệt đối trên 7 nhiệm vụ. CRITIC (…",
        "keywordsVi": "Tự tinh chỉnh (Madaan và cộng sự, NeurIPS 2023) · CRITIC (Gou và cộng sự, arXiv: 2305.11738, v4 tháng 2 năm 2024) · Điều kiện dừng · Người đánh giá-Optimizer (Anthropic, 2024) · OpenAI Agents SDK guardrails đầu ra · Cạm bẫy năm 2026"
      },
      {
        ...
        "summaryVi": "Toolformer (Schick và cộng sự, 2023) bắt đầu chú thích công cụ tự giám sát. Bảng xếp hạng Berkeley Function Calling V4 (Patil và cộng sự, 2025) đặt ra tiêu chuẩn năm 2026: 40% a…",
        "keywordsVi": "Toolformer (Schick và cộng sự, NeurIPS 2023) · Bảng xếp hạng Berkeley Function Calling V4 (Patil và cộng sự, ICML 2025) · Công cụ schema · Xác thực đối số · Lệnh gọi công cụ song song · Sandbox"
      },
      {
        ...
        "summaryVi": "Ngữ cảnh windows là hữu hạn. Các cuộc trò chuyện, tài liệu và traces công cụ thì không. MemGPT (Packer et al., 2023) đóng khung đây là bộ nhớ ảo của hệ điều hành — ngữ cảnh chín…",
        "keywordsVi": "MemGPT: sự tương tự của hệ điều hành · Hai tầng · Mô hình ngắt · Nơi MemGPT kết thúc và Letta bắt đầu · Mô hình này sai ở đâu"
      },
      {
        ...
        "summaryVi": "MemGPT trở thành Letta vào năm 2024. Sự phát triển năm 2026 bổ sung hai ý tưởng: khối bộ nhớ chức năng rời rạc mà model có thể chỉnh sửa trực tiếp và agent thời gian ngủ hợp nhấ…",
        "keywordsVi": "Ba tầng · Khối bộ nhớ · Điện toán thời gian ngủ · Letta V1 và lý luận gốc · Mô hình này sai ở đâu"
      },
      {
        ...
        "summaryVi": "Mem0 (Chhikara et al., 2025) coi bộ nhớ là ba kho lưu trữ song song - vector cho sự tương đồng về ngữ nghĩa, KV để tra cứu dữ kiện nhanh, đồ thị cho suy luận mối quan hệ thực th…",
        "keywordsVi": "Ba cửa hàng song song · Chấm điểm hợp nhất · Mem0g và lý luận thời gian · Benchmark số · Phân loại phạm vi · Mô hình này sai ở đâu"
      },
      {
        ...
        "summaryVi": "Voyager (Wang et al., TMLR 2024) coi mã thực thi như một skill. Skills được đặt tên, có thể truy xuất, có thể kết hợp và tinh chỉnh theo phản hồi của môi trường. Đây là kiến trú…",
        "keywordsVi": "Ba thành phần · Không gian hành động = mã · Truy xuất Skill · Tinh chỉnh lặp đi lặp lại · Chương trình giảng dạy và khám phá · Mô hình này sai ở đâu"
      },
      {
        ...
        "summaryVi": "Lập kế hoạch tượng trưng xử lý các trường hợp mà kế hoạch là chính xác. Tìm kiếm mã tiến hóa xử lý các trường hợp chức năng thể dục có thể kiểm tra bằng máy. ChatHTN (2025) và A…",
        "keywordsVi": "Mạng nhiệm vụ phân cấp · ChatHTN (Gopalakrishnan và cộng sự, 2025) · AlphaEvolve (Novikov và cộng sự, 2025) · Khi nào sử dụng · Mô hình này sai ở đâu"
      },
      {
        ...
        "summaryVi": "Schluntz và Zhang (Anthropic, tháng 12 năm 2024) phân biệt quy trình làm việc (đường dẫn được xác định trước) với agents (sử dụng công cụ động). Năm mẫu quy trình làm việc bao g…",
        "keywordsVi": "Quy trình làm việc so với agents · Các LLM tăng cường · Năm mẫu · Nơi quy trình làm việc đánh bại agents · Nơi agents đánh bại quy trình làm việc · Người bạn đồng hành về kỹ thuật ngữ cảnh"
      },
      {
        ...
        "summaryVi": "LangGraph là tài liệu tham khảo năm 2026 cho orchestration trạng thái cấp thấp. Agent là một cỗ máy nhà nước; các nút là hàm; các cạnh là chuyển tiếp; trạng thái là bất biến và …",
        "keywordsVi": "Biểu đồ · Thực thi bền bỉ · Streaming · Con người trong vòng lặp · Bộ nhớ · Ba cấu trúc liên kết · Mô hình này sai ở đâu"
      },
      {
        ...
        "summaryVi": "AutoGen v0.4 (Nghiên cứu của Microsoft, tháng 1 năm 2025) đã thiết kế lại agent orchestration xung quanh diễn viên model. Trao đổi tin nhắn không đồng bộ, agents theo sự kiện, c…",
        "keywordsVi": "Diễn viên · Ba lớp API trong AutoGen v0.4 · Tại sao việc tách rời lại quan trọng · Cấu trúc liên kết · Observability · Tình trạng: chế độ bảo trì"
      },
      {
        ...
        "summaryVi": "CrewAI là đa agent framework dựa trên vai trò năm 2026. Bốn primitives: Agent, Nhiệm vụ, Phi hành đoàn, Process. Hai hình dạng cấp cao nhất: Nhóm (cộng tác tự động, dựa trên vai…",
        "keywordsVi": "Bốn primitives · Tuần tự vs Phân cấp vs Đồng thuận · Phi hành đoàn vs Dòng chảy · Tích hợp công cụ · Bộ nhớ hooks · Khi CrewAI phù hợp · Khi CrewAI không phù hợp · Hình dạng phần phụ thuộc · Mô hình này sai ở đâu"
      },
      {
        ...
        "summaryVi": "OpenAI Agents SDK là đa agent framework nhẹ được xây dựng trên API Phản hồi. Năm primitives: Agent, Handoff, Guardrail, Session, Tracing. Handoffs là công cụ có tên `transfer_to…",
        "keywordsVi": "Năm primitives · Handoffs làm công cụ · Guardrails · Truy tìm · Sessions · Mô hình này sai ở đâu"
      },
      {
        ...
        "summaryVi": "Claude Agent SDK là dạng thư viện của Claude Code harness. Các công cụ tích hợp, subagents để cách ly ngữ cảnh, hooks, lan truyền trace W3C session chẵn lẻ lưu trữ. Claude Manag…",
        "keywordsVi": "SDK khách hàng so với Agent SDK · Công cụ tích hợp · Subagents · Cửa hàng Session · Hooks · Bối cảnh trace W3C · Claude Agents được quản lý · Mô hình này sai ở đâu"
      },
      {
        ...
        "summaryVi": "Agno (Python) và Mastra (TypeScript) là cặp đôi production-runtime năm 2026. Agno nhắm đến việc khởi tạo agent micro giây và các phần phụ trợ FastAPI không trạng thái. Mastra sh…",
        "keywordsVi": "Bất động lực · Mastra · Định vị · Khi nào nên chọn từng loại · Mô hình này sai ở đâu"
      },
      {
        ...
        "summaryVi": "Ba benchmarks neo agent đánh giá vào năm 2026. SWE-bench kiểm tra việc vá mã. GAIA kiểm tra việc sử dụng công cụ tổng quát. AgentBench kiểm tra suy luận đa môi trường. Biết thàn…",
        "keywordsVi": "SWE-bench (Jimenez và cộng sự, ICLR 2024 miệng) · SWE-bench đã được xác minh · Ô nhiễm · GAIA (Mialon và cộng sự, tháng 11 năm 2023) · AgentBench (Liu và cộng sự, ICLR 2024) · Những gì chúng không đo lường · Điểm chuẩn bị lỗi ở đâu"
      },
      {
        ...
        "summaryVi": "WebArena kiểm tra khả năng agent web trên bốn ứng dụng tự lưu trữ. OSWorld kiểm tra khả năng agent trên máy tính để bàn trên Ubuntu, Windows macOS. Khi phát hành (2023–2024), cả…",
        "keywordsVi": "WebArena (Chu và cộng sự, ICLR 2024) · Tiện ích mở rộng · OSWorld (Xie và cộng sự, NeurIPS 2024) · Chế độ lỗi chính · Theo dõi · Tại sao điều này lại quan trọng · Điểm chuẩn bị lỗi ở đâu"
      },
      {
        ...
        "summaryVi": "Ba production models sử dụng máy tính vào năm 2026. Cả ba đều dựa trên tầm nhìn. Cả ba đều coi ảnh chụp màn hình, văn bản DOM và đầu ra công cụ là đầu vào không đáng tin cậy. Ch…",
        "keywordsVi": "Claude sử dụng máy tính (Anthropic, ngày 22 tháng 10 năm 2024) · OpenAI CUA / Nhà điều hành (Jan 2025) · Gemini 2.5 Sử dụng máy tính (Google DeepMind, ngày 7 tháng 10 năm 2025) · Hợp đồng dùng chung: đầu vào không đáng tin cậy · Khi nào nên chọn cái nào · Mô hình này sai ở đâu"
      },
      {
        ...
        "summaryVi": "Voice agents là danh mục class production đầu tiên vào năm 2026. Pipecat cung cấp cho bạn pipeline dựa trên khung hình Python (VAD → STT → LLM → TTS → transport). LiveKit Agents…",
        "keywordsVi": "Mèo ống (pipecat-ai/pipecat) · LiveKit Agents (livekit/agents) · Nền tảng thương mại · Mô hình này sai ở đâu · Độ trễ điển hình năm 2026"
      },
      {
        ...
        "summaryVi": "GenAI SIG của OpenTelemetry (ra mắt tháng 4 năm 2024) xác định schema tiêu chuẩn cho agent telemetry. Span tên, thuộc tính và quy tắc thu thập nội dung hội tụ giữa các nhà cung …",
        "keywordsVi": "Span danh mục · Agent span đặt tên · Các thuộc tính chính · Chụp nội dung · Tính ổn định · Mô hình này sai ở đâu"
      },
      {
        ...
        "summaryVi": "Ba nền tảng agent observability mã nguồn mở thống trị năm 2026. Langfuse (MIT) - 6 triệu + installs/month, theo dõi + quản lý prompt + đánh giá + phát lại session. Arize Phoenix…",
        "keywordsVi": "Cầu chì (MIT) · Arize Phoenix (Giấy phép đàn hồi 2.0) · Sao chổi Opik (Apache 2.0) · Dữ liệu ngành · Chọn một · Mô hình này sai ở đâu"
      },
      {
        ...
        "summaryVi": "Du et al. (ICML 2024, \"Society of Minds\") chạy N model trường hợp đề xuất câu trả lời một cách độc lập, sau đó lặp đi lặp lại phê bình lẫn nhau qua các vòng R để hội tụ. Cải thi…",
        "keywordsVi": "Hiệp hội Tâm trí (Du và cộng sự, ICML 2024) · Cấu trúc liên kết thưa thớt · Khi tranh luận giúp ích · Khi tranh luận đau đớn · Phiên bản thực tế năm 2026 · Mô hình này sai ở đâu"
      },
      {
        ...
        "summaryVi": "MASFT (Berkeley, 2025) lập danh mục 14 chế độ lỗi nhiều agent trong 3 danh mục. Phân loại của Microsoft ghi lại cách các lỗi AI hiện có khuếch đại trong cài đặt agentic. Dữ liệu…",
        "keywordsVi": "MASFT (Berkeley, arXiv: 2503.13657) · Phân loại chế độ lỗi của Microsoft trong hệ thống Agentic AI · Mô tả đặc điểm lỗi trong Agentic AI (arXiv:2603.06847) · LLM Agent Khảo sát ảo giác (arXiv: 2509.18970) · Năm chế độ định kỳ trong ngành · Giảm thiểu: cổng ở mọi bước · Giám sát lỗi xảy ra ở đâu"
      },
      {
        ...
        "summaryVi": "Greshake et al. (AISec 2023) đã thiết lập việc tiêm prompt gián tiếp là vấn đề bảo mật agent xác định. Kẻ tấn công cài đặt các hướng dẫn trong dữ liệu mà agent truy xuất; Khi nh…",
        "keywordsVi": "Greshake và cộng sự, AISec 2023 (arXiv: 2302.12173) · Học thuyết quốc phòng năm 2026 · PVE: Prompt-Trình xác thực-Thực thi · Trường hợp phòng thủ thất bại"
      },
      {
        ...
        "summaryVi": "Bốn mô hình orchestration lặp lại trong năm 2026 frameworks: giám sát worker, swarm / ngang hàng, phân cấp, tranh luận. Hướng dẫn của Anthropic: \"Đó là về việc xây dựng hệ thống…",
        "keywordsVi": "Giám sát-worker · Swarm / ngang hàng · Phân cấp · Tranh luận · Phi hành đoàn CrewAI so với Flow · Hướng dẫn của Anthropic · Mô hình này sai ở đâu"
      },
      {
        ...
        "summaryVi": "Production agents chạy trên sáu hình dạng runtime: phản hồi yêu cầu, streaming, thực thi lâu dài, nền dựa trên hàng đợi, theo hướng sự kiện và theo lịch trình. Chọn hình dạng tr…",
        "keywordsVi": "Yêu cầu-phản hồi · Streaming · Thực thi bền bỉ · Dựa trên hàng đợi / nền · Định hướng sự kiện · Đã lên lịch · Mô hình triển khai năm 2026 · Observability chịu tải · Nơi production runtimes thất bại"
      },
      {
        ...
        "summaryVi": "Hướng dẫn của Anthropic: \"Bắt đầu với prompts đơn giản, tối ưu hóa chúng với đánh giá toàn diện và chỉ thêm hệ thống agentic nhiều bước khi cần thiết.\" Đánh giá không phải là bư…",
        "keywordsVi": "Ba lớp đánh giá · Người đánh giá-optimizer (Anthropic) · Thực tiễn tốt nhất năm 2026 · Gắn kết giai đoạn 14 với nhau · Nơi phát triển theo định hướng đánh giá thất bại"
      },
      {
        ...
        "summaryVi": "Một model có năng lực là không đủ. Các agents đáng tin cậy cần bàn làm việc: hướng dẫn, trạng thái, phạm vi, phản hồi, xác minh, xem xét và bàn giao. Loại bỏ những thứ đó và thậ…",
        "keywordsVi": "Bàn làm việc so với kỹ thuật prompt · Bàn làm việc so với framework · Lý luận từ primitives, không phải từ phân loại nhà cung cấp · Các mẫu đang lưu hành, được dịch thành primitives · Biên lai thực sự nói gì · Nơi các bài viết của nhà cung cấp dừng lại"
      },
      {
        ...
        "summaryVi": "Bàn làm việc hữu ích nhỏ nhất là ba tệp: bộ định tuyến hướng dẫn gốc, tệp trạng thái và bảng tác vụ. Mọi thứ khác đều được xếp lớp lên trên. Nếu một repo không thể mang theo ba …",
        "keywordsVi": "AGENTS.md là bộ định tuyến, không phải hướng dẫn sử dụng · agent_state. json là hệ thống hồ sơ · task_board. json là hàng đợi · Ba tập tin là sàn nhà, không phải trần nhà"
      },
      {
        ...
        "summaryVi": "Hướng dẫn được viết dưới dạng văn xuôi là mong muốn. Các hướng dẫn được viết dưới dạng ràng buộc là các bài kiểm tra. Workbench biến mỗi quy tắc thành một cái gì đó mà agent có …",
        "keywordsVi": "Năm danh mục bao gồm hầu hết các quy tắc · Các quy tắc có thể đọc được bằng máy · Các quy tắc thân thiện với sự khác biệt · Quy tắc so với framework guardrails · Tiết lộ lũy tiến: một bản đồ, không phải một bách khoa toàn thư"
      },
      {
        ...
        "summaryVi": "Lịch sử trò chuyện không ổn định. repo bền. Workbench lưu trữ trạng thái agent trong các tệp có phiên bản để session tiếp theo, agent tiếp theo và người đánh giá tiếp theo đều đ…",
        "keywordsVi": "Những gì thuộc về ký ức repo · Trạng thái Schema đầu tiên · Ghi nguyên tử · Di chuyển"
      },
      {
        ...
        "summaryVi": "Mỗi session bắt đầu lạnh đều phải trả thuế. agent đọc cùng một tệp, thử lại các đầu dò giống nhau và phát hiện lại các đường dẫn giống nhau. Một init script nộp thuế một lần và …",
        "keywordsVi": "Đầu dò script cái gì · Thất bại lớn, thất bại nhanh, thất bại ở một nơi · Idempotent · Quy tắc khởi động so với khởi động"
      },
      {
        ...
        "summaryVi": "Người model không biết công việc kết thúc ở đâu. Hợp đồng phạm vi là một tệp cho mỗi nhiệm vụ cho biết nơi công việc bắt đầu, nơi kết thúc và cách khôi phục nếu nó bị tràn. Hợp …",
        "keywordsVi": "Những gì xảy ra trong hợp đồng phạm vi · Globs, không phải đường dẫn thô · Rollback là một phần của phạm vi · Kiểm tra phạm vi là kiểm tra khác biệt · Hai độ cao của phạm vi: danh sách feature và hợp đồng nhiệm vụ"
      },
      {
        ...
        "summaryVi": "Agents không thấy đoán đầu ra lệnh thực. Trình chạy phản hồi ghi lại stdout, stderr, mã thoát và thời gian vào một bản ghi có cấu trúc mà lượt tiếp theo có thể đọc. Sau đó, agen…",
        "keywordsVi": "Nội dung trong bản ghi phản hồi · Cắt bớt là xác định · Phản hồi so với telemetry · Từ chối thăng tiến mà không có phản hồi"
      },
      {
        ...
        "summaryVi": "agent không được đánh dấu công việc của chính mình là đã hoàn thành. Cổng xác minh đọc hợp đồng phạm vi, nhật ký phản hồi, báo cáo quy tắc và khác biệt và trả lời một câu hỏi du…",
        "keywordsVi": "Những gì cổng kiểm tra · Xác định, không xác suất · Một báo cáo, một đường dẫn · Từ chối mà không có ngoại lệ"
      },
      {
        ...
        "summaryVi": "agent viết mã không thể chấm điểm nó. Người đánh giá là vòng lặp thứ hai với một system prompt khác, một mục tiêu khác và quyền truy cập chỉ đọc vào mọi thứ mà trình tạo đã tạo …",
        "keywordsVi": "Phiếu đánh giá của người đánh giá · Người đánh giá là một vai trò riêng biệt, không phải là một model riêng biệt · Người phản biện không thể chỉnh sửa diff · Phiếu đánh giá của người đánh giá so với cổng xác minh"
      },
      {
        ...
        "summaryVi": "Cuộc session sẽ kết thúc. Công việc thì không. Gói bàn giao là artifact biến \"agent làm việc trong một giờ\" thành \"session tiếp theo làm việc hiệu quả trong phút đầu tiên\". Xây …",
        "keywordsVi": "Bảy lĩnh vực mà mỗi lần chuyển giao mang theo · Bàn giao được tạo chứ không phải bằng văn bản · Hai dạng: con người có thể đọc được và máy có thể đọc được · Cắt nhật ký phản hồi · Để lại trạng thái sạch sẽ"
      },
      {
        ...
        "summaryVi": "Mười một bài học về bề mặt sẽ không có giá trị gì nếu chúng không tồn tại khi tiếp xúc với một cơ sở mã thực. Bài học này chạy cùng một tác vụ hai lần trên một ứng dụng mẫu nhỏ:…",
        "keywordsVi": "Ứng dụng mẫu · Nhiệm vụ · Hai người pipelines · Năm kết quả được đo lường"
      },
      {
        ...
        "summaryVi": "Bản nhạc nhỏ kết thúc bằng một gói bạn thả vào bất kỳ repo nào. Mười một bài học về các bề mặt được nén vào một thư mục mà bạn có thể `cp -r` và có một agent hoạt động đáng tin …",
        "keywordsVi": "Bố cục gói · Cái gì ở trong, cái gì ở ngoài · Trình cài đặt · Phiên bản"
      }
    ]
  },
  {
    ...
    "lessons": [
      {
        ...
        "summaryVi": "Vào năm 2023, một chatbot đã trả lời một câu hỏi trong một lượt. Vào năm 2026, một model biên giới thường chạy vài phút đến hàng giờ cho một nhiệm vụ duy nhất. Time Horizon 1.1 …",
        "keywordsVi": "Chân trời thời gian METR, trong một đoạn văn · Điều gì thực sự phá vỡ khi chân trời phát triển · Nhân đôi thời gian và những gì chúng ngụ ý · Trò chơi trong bối cảnh thời đại · So sánh một lượt so với đường chân trời dài"
      },
      {
        ...
        "summaryVi": "Vòng lặp tự cải thiện nhỏ nhất có thể nằm bên trong cơ sở lý luận. Một model tạo ra một chuỗi suy nghĩ, giữ những câu trả lời đúng và tinh chỉnh chúng. Đó là STaR. V-STaR bổ sun…",
        "keywordsVi": "STaR: bootstrap về những gì hoạt động · V-STaR: huấn luyện người xác minh với DPO · Quiet-STaR: lý do nội bộ cho mỗi token · Tại sao cả ba đều có chung mối quan tâm về an toàn · So sánh · Điều này nằm ở đâu vào năm 2026 stack"
      },
      {
        ...
        "summaryVi": "Ghép nối một model mã hóa biên giới với một vòng lặp tiến hóa và một công cụ đánh giá có thể kiểm tra bằng máy. Hãy để vòng lặp chạy đủ lâu. Nó phát hiện ra một quy trình nhân m…",
        "keywordsVi": "Vòng lặp · Điều gì làm cho người đánh giá không thể thương lượng · Hack phần thưởng là bộ mặt khác của tuyên bố đó · Tại sao LLM + tìm kiếm đánh bại một mình · Nơi AlphaEvolve phù hợp với stack biên giới"
      },
      {
        ...
        "summaryVi": "Máy Godel năm 2003 của Schmidhuber yêu cầu một bằng chứng chính thức rằng bất kỳ sự tự sửa đổi nào cũng có lợi trước khi chấp nhận nó. Bằng chứng đó là không thể trong thực tế. …",
        "keywordsVi": "Vòng lặp · Những gì DGM thực sự cải thiện · Trình diễn hack phần thưởng · So với Máy Godel cổ điển · Nó phù hợp ở đâu trong giai đoạn này"
      },
      {
        ...
        "summaryVi": "AI Scientist v2 của Sakana (Yamada et al., arXiv:2504.08066) chạy vòng lặp nghiên cứu đầy đủ: giả thuyết, mã, thí nghiệm, số liệu, viết, đệ trình. Đây là hệ thống đầu tiên có đá…",
        "keywordsVi": "Kiến trúc · Ý nghĩa của kết quả nghiệm thu hội thảo · Những gì đánh giá độc lập tìm thấy · Mối quan tâm thoát sandbox · Vị trí của v2 ở biên giới stack"
      },
      {
        ...
        "summaryVi": "Anthropic điều hành các nhóm song song của các nhà nghiên cứu Alignment tự trị Claude Opus 4.6 trong các sandboxes độc lập, phối hợp thông qua một diễn đàn chung có nhật ký nằm …",
        "keywordsVi": "Kiến trúc (như được mô tả công khai) · Tại sao nhật ký ngoài sandbox lại quan trọng · Sự đánh đổi quy trình làm việc theo quy định · Rủi ro nén · Những gì AAR không thay thế"
      },
      {
        ...
        "summaryVi": "Tự cải thiện đệ quy (RSI) không còn là suy đoán. Hội thảo RSI ICLR 2026 ở Rio (23-27 tháng 4) đã đóng khung nó như một vấn đề kỹ thuật với dụng cụ bê tông. Demis Hassabis tại WE…",
        "keywordsVi": "Tự cải thiện đệ quy có nghĩa chính xác là gì · Kết quả giả mạo alignment chi tiết · Câu hỏi về Hassabis · Khả năng so với alignment, như một cuộc đua · Hội thảo ICLR 2026 coi gì là kỹ thuật"
      },
      {
        ...
        "summaryVi": "Nghiên cứu đã hội tụ vào bốn primitives để giới hạn một vòng lặp cải thiện bản thân. Các bất biến chính thức phải được giữ trong mọi sửa đổi. Alignment các neo không thể sửa đổi…",
        "keywordsVi": "Primitive 1: bất biến chính thức · Primitive 2: alignment neo · Primitive 3: Ràng buộc đa mục tiêu · Primitive 4: Phát hiện hồi quy · Giới hạn lý thuyết thông tin · Một ví dụ điển hình"
      },
      {
        ...
        "summaryVi": "SWE-bench Verified đã tăng từ 4% lên 80,9% trong vòng chưa đầy ba năm. Tương tự Claude Sonnet 4.5 đạt 43,2% trên SWE-agent v1 và 59,8% trên Cline tự trị - giàn giáo xung quanh m…",
        "keywordsVi": "SWE-bench, một đoạn · Đường cong 2022 → 2026 thực sự cho thấy điều gì · CodeAct so với các lệnh gọi công cụ JSON · Giàn giáo trong bối cảnh năm 2026 · Tại sao giàn giáo chiếm ưu thế · Độ bão hòa Benchmark và phân bố thực"
      },
      {
        ...
        "summaryVi": "Claude Code hiển thị bảy chế độ quyền. \"plan\" hỏi trước mọi hành động, \"default\" chỉ yêu cầu những hành động rủi ro, \"acceptEdits\" tự động phê duyệt ghi tệp nhưng vẫn xác nhận t…",
        "keywordsVi": "Bảy chế độ cấp phép · Chế độ tự động trong một trang · Những gì hệ thống nắm bắt · Những gì hệ thống có thể bỏ lỡ · Khung xem trước nghiên cứu · Thang này nằm ở đâu trong quy trình làm việc của bạn"
      },
      {
        ...
        "summaryVi": "ChatGPT agent (tháng 7 năm 2025) merged Nhà điều hành và nghiên cứu sâu vào một browser/terminal agent và đặt BrowseComp SOTA ở mức 68,9%. OpenAI đóng cửa Nhà điều hành vào ngày…",
        "keywordsVi": "Bối cảnh năm 2026, trong một đoạn văn cho mỗi hệ thống · BrowseComp so với OSWorld so với WebArena · Bề mặt tấn công, được đặt tên là · Tại sao \"không thể vá lỗi hoàn toàn\" · Tư thế phòng thủ thực sự ships"
      },
      {
        ...
        "summaryVi": "Production agents đường chân trời dài không chạy trong `while True`. Mỗi cuộc gọi LLM trở thành một hoạt động với checkpoint, thử lại và phát lại. Tích hợp OpenAI Agents SDK của…",
        "keywordsVi": "Hoạt động, quy trình làm việc và phát lại · Tại sao LLM cuộc gọi phù hợp với mẫu · Checkpoints được khóa bởi `thread_id` · Đầu vào của con người dưới dạng trạng thái class đầu tiên · Sự xuống cấp trong 35 phút · Khi thực thi bền bỉ là câu trả lời sai"
      },
      {
        ...
        "summaryVi": "Chi phí LLM hàng tháng của một agent thương mại điện tử cỡ trung đã tăng từ $1,200 to $4.800 sau khi nhóm của họ kích hoạt skill \"theo dõi đơn hàng\". Đó không phải là một lỗi về…",
        "keywordsVi": "Thống đốc chi phí stack · Tại sao lại stack, không phải một mũ · Bề mặt ngân sách của Claude Code · Đạo luật AI EU, OWASP Agentic Top 10 · $1,200 → $4.800 trường hợp quan sát được"
      },
      {
        ...
        "summaryVi": "kill switch là một boolean được giữ bên ngoài bề mặt chỉnh sửa của agent - phím Redis, cờ feature, config đã ký - vô hiệu hóa hoàn toàn agent. Bộ ngắt mạch có chi tiết hơn: nó v…",
        "keywordsVi": "Ngắt kết nối · Bộ ngắt mạch · Canary tokens · Tại sao lại có giới hạn thống kê và giới hạn cứng · Cách ly thông qua chuyển hướng đường dẫn dữ liệu eBPF · Những gì không có máy dò bắt được"
      },
      {
        ...
        "summaryVi": "Sự đồng thuận năm 2026 về HITL là cụ thể. Nó không phải là \"agent hỏi, người dùng nhấp vào Phê duyệt\". Đó là đề xuất sau đó commit: hành động được đề xuất được duy trì cho một c…",
        "keywordsVi": "Bộ máy nhà nước đề xuất sau đó commit · Chìa khóa idempotency · Độ bền: tại sao phê duyệt tồn tại lâu hơn processes · Phê duyệt tem cao su và giảm thiểu thách thức và ứng phó · Điều gì được coi là hậu quả · Xác minh sau hành động · Đạo luật AI EU Điều 14"
      },
      {
        ...
        "summaryVi": "Mọi chuyển đổi trạng thái đồ thị vẫn tồn tại. Khi một worker gặp sự cố, hợp đồng thuê của nó sẽ hết hạn và một worker khác sẽ bắt đầu vào checkpoint muộn nhất. Cloudflare Durabl…",
        "keywordsVi": "Mọi quá trình chuyển đổi vẫn tồn tại · Thu hồi hợp đồng thuê · Idempotency cộng với điều kiện tiên quyết · Xác minh sau hành động · Rollback kế hoạch · Đạo luật AI EU Điều 14 đọc hoạt động · Chế độ thất bại mạnh: thực hiện kép"
      },
      {
        ...
        "summaryVi": "Hiến pháp Claude ngày 22 tháng 1 năm 2026 của Anthropic dài 79 trang và là CC0. Nó chuyển từ alignment dựa trên quy tắc sang dựa trên lý trí và thiết lập hệ thống phân cấp ưu ti…",
        "keywordsVi": "Hệ thống phân cấp ưu tiên bốn cấp · Các lệnh cấm được mã hóa cứng so với mặc định được mã hóa mềm · The 2022 CAI training · Những alignment dựa trên lý do nào bắt và bỏ lỡ · Thử nghiệm có sự tham gia năm 2023 · Tại sao các lệnh cấm được mã hóa cứng là cần thiết · Hiến pháp nằm ở đâu trong stack"
      },
      {
        ...
        "summaryVi": "Llama Guard 3 (Meta, cơ sở Llama-3.1-8B, fine-tuned về an toàn nội dung) phân loại cả đầu vào và đầu ra LLM dựa trên phân loại MLCommons 13 nguy hiểm trên 8 ngôn ngữ. Một biến t…",
        "keywordsVi": "Sơ lược về Llama Guard 3 · Llama Guard 4 bổ sung · NeMo Guardrails (NVIDIA) · Kho dữ liệu tấn công · Nơi bộ phân loại chiến thắng · Nơi bộ phân loại mất · Phòng thủ chuyên sâu"
      },
      {
        ...
        "summaryVi": "RSP v3.0 có hiệu lực từ ngày 24 tháng 2 năm 2026, thay thế policy 2023. Giảm thiểu hai tầng: những gì Anthropic sẽ đơn phương làm so với những gì được đóng khung như một khuyến …",
        "keywordsVi": "Lịch trình giảm thiểu hai cấp · Ngưỡng R&D-4 AI · Lộ trình an toàn biên giới và báo cáo rủi ro · Xóa điều khoản tạm dừng · Hạ cấp của SaferAI · Bài học này không phải là gì"
      },
      {
        ...
        "summaryVi": "OpenAI Chuẩn bị Framework phiên bản 2 (Tháng Tư 2025) giới thiệu các Danh mục Nghiên cứu - Tự chủ tầm xa, Bao cát, Sao chép và Thích ứng Tự động, Các biện pháp bảo vệ phá hoại -…",
        "keywordsVi": "OpenAI Chuẩn bị Framework phiên bản 2 (Tháng Tư 2025) · DeepMind Frontier Safety Framework v3 (Tháng Chín 2025; Mức độ khả năng được theo dõi được thêm vào ngày 17 tháng 4 năm 2026) · Cả ba hội tụ về điều gì · Nơi chúng phân kỳ · Bao cát: một khả năng cụ thể làm phức tạp cả ba · skill đọc policy"
      },
      {
        ...
        "summaryVi": "METR (ex-ARC Evals) là một 501 (c) (3) độc lập kể từ tháng 12 năm 2023. Time Horizon 1.1 benchmark (tháng 1 năm 2026) của họ phù hợp với đường cong hậu cần đối với xác suất thàn…",
        "keywordsVi": "Nền tảng METR · Chân trời thời gian phù hợp · Các con số tháng 1 năm 2026 · Benchmark dãy phòng · Đánh giá giám sát nguyên mẫu · Tại sao chân trời là giới hạn trên · Trường hợp đánh giá bên ngoài · Cách sử dụng số chân trời trong thực tế"
      },
      {
        ...
        "summaryVi": "Trung tâm An toàn AI (CAIS, San Francisco, được thành lập năm 2022 bởi Hendrycks và Zhang) công bố framework bốn rủi ro - sử dụng độc hại, chủng tộc AI, rủi ro tổ chức, AI giả m…",
        "keywordsVi": "CAIS - Trung tâm An toàn AI · framework bốn rủi ro · Nơi rủi ro của tổ chức tồn tại · CAISI - Trung tâm Tiêu chuẩn và Đổi mới AI · California SB-53 · Rủi ro quy mô xã hội không phải là vấn đề đơn tầng"
      }
    ]
  },
  {
    ...
    "lessons": [
      {
        ...
        "summaryVi": "Một agent đập vào tường. Động thái thông minh không phải là một agent lớn hơn - nó agents hơn.",
        "keywordsVi": "Trần một Agent · Giải pháp đa Agent · Hệ thống thực tế làm điều này · Quang phổ · Bốn mô hình đa Agent · Khi nào KHÔNG sử dụng Multi-Agent · Bước 1: Agent đơn quá tải · Bước 2: Chuyên gia Agents · Bước 3: Phối hợp thông qua tin nhắn · Bước 4: So sánh"
      },
      {
        ...
        "summaryVi": "Trước MCP, trước A2A, đã có FIPA-ACL. Năm 2000, IEEE Foundation for Intelligent Physical Agents phê chuẩn một ngôn ngữ giao tiếp agent với hai mươi biểu diễn, hai ngôn ngữ nội d…",
        "keywordsVi": "Hành động lời nói, trong một đoạn văn · Hai mươi biểu diễn FIPA (danh sách một phần) · Thông báo FIPA-ACL chuẩn · Hai nền tảng kế thừa · Tại sao FIPA mờ nhạt · Sự hồi sinh LLM là FIPA-lite · Sự đánh đổi, được nêu rõ ràng · Các giao thức tương tác đáng để chuyển · Điều gì bị hỏng khi bạn bỏ bản thể · Thông số kỹ thuật năm 2026, được ánh xạ đến di sản lời nói-hành động"
      },
      {
        ...
        "summaryVi": "Agents không thể nói cùng một ngôn ngữ không phải là một đội. Họ là những người lạ đang hét vào khoảng không.",
        "keywordsVi": "Bối cảnh giao thức · MCP (Tóm tắt) · A2A (Giao thức Agent2Agent) · Giao thức truyền thông ACP (Agent) · ANP (Giao thức mạng Agent) · So sánh (Đã sửa) · Cách họ làm việc cùng nhau · Bước 1: Các loại tin nhắn cốt lõi · Bước 2: A2A Agent thẻ và Registry · Bước 3: A2A Vòng đời tác vụ · Bước 4: Dấu vết kiểm tra kiểu ACP · Bước 5: Xác minh danh tính kiểu ANP · Bước 6: Giao thức Gateway · Bước 7: Nối tất cả lại với nhau · Triển khai thực tế · Chọn giao thức phù hợp"
      },
      {
        ...
        "summaryVi": "Mỗi agent framework shipping đa năng vào năm 2026 - AutoGen, LangGraph, CrewAI, OpenAI Agents SDK, Microsoft Agent Framework - là một điểm trong không gian thiết kế bốn chiều. B…",
        "keywordsVi": "Bốn primitives · Cách mọi framework 2026 ánh xạ đến nó · Tại sao điều này lại quan trọng · Cái nhìn sâu sắc về người không có quốc tịch · Giải phẫu của một primitive · Những thay đổi giữa frameworks"
      },
      {
        ...
        "summaryVi": "Một lãnh đạo agent kế hoạch và đại biểu; chuyên biệt workers thực hiện trong ngữ cảnh song song và báo cáo lại. Đây là mô hình đằng sau hệ thống Nghiên cứu của Anthropic (Claude…",
        "keywordsVi": "Mô hình · Tại sao nó chiến thắng · Bài học kỹ thuật (Anthropic 2025) · Bước ngoặt của LangGraph · Các chế độ thất bại · Khi người giám sát sai"
      },
      {
        ...
        "summaryVi": "Phân cấp là người giám sát lồng nhau. Người quản lý agents hơn các nhà quản lý phụ trên workers. CrewAI `Process.hierarchical` là phiên bản sách giáo khoa: một `manager_llm` tự …",
        "keywordsVi": "Hình dạng · Nơi nó tỏa sáng · Nơi nó bị hỏng · Câu hỏi quyết định · Triển khai của CrewAI · Triển khai LangGraph"
      },
      {
        ...
        "summaryVi": "Tiền đề năm 1986 của Minsky - trí thông minh là một xã hội của các chuyên gia - được khám phá lại mỗi thập kỷ. Vào năm 2023, Du và cộng sự đã biến nó thành một thuật toán cụ thể…",
        "keywordsVi": "Thuật toán Du et al. 2023 · Hai núm độc lập · Tại sao nó hoạt động · Tranh luận không đồng nhất · NLSOM — phần mở rộng 129 agent · Chế độ thất bại"
      },
      {
        ...
        "summaryVi": "Sự phân rã đa agent phổ biến nhất vào năm 2026: một agent lập kế hoạch, một người thực hiện, một người phê bình hoặc xác minh. MetaGPT (arXiv:2308.00352) chính thức hóa điều này…",
        "keywordsVi": "Bốn vai trò kinh điển · Mô hình SOP của MetaGPT · Ảo giác giao tiếp của ChatDev · Tại sao trình xác minh lại quan trọng nhất · Nhà phê bình vs người xác minh · Chống mô hình · Ánh xạ Framework"
      },
      {
        ...
        "summaryVi": "Trái ngược với người giám sát: không có người quyết định trung tâm. Agents đọc bus sự kiện được chia sẻ, chọn công việc không đồng bộ, ghi lại kết quả. LangGraph hỗ trợ rõ ràng …",
        "keywordsVi": "Hình dạng · Khi swarm phù hợp · Khi swarm không thành công · Ma trận (arXiv: 2511.21686) · Kiến trúc Swarm của LangGraph · Chế độ thất bại: đói và đốm nóng · Liên kết định tuyến dựa trên nội dung"
      },
      {
        ...
        "summaryVi": "AutoGen GroupChat và AG2 GroupChat chia sẻ một cuộc trò chuyện trên N agents; Chức năng chọn (LLM, vòng tròn hoặc tùy chỉnh) chọn người phát biểu tiếp theo. Đây là nguyên mẫu củ…",
        "keywordsVi": "Hình dạng · Ba hương vị chọn · The ConversableAgent API · Chấm dứt · AutoGen → AG2 tách ra và Microsoft Agent Framework merge · Khi GroupChat phù hợp · Khi nó không thành công · Trò chuyện nhóm so với người giám sát"
      },
      {
        ...
        "summaryVi": "Swarm của OpenAI (tháng 10 năm 2024) đã chắt lọc nhiều agent orchestration thành hai primitives: **quy trình** (hướng dẫn + công cụ dưới dạng system prompt) và **handoffs** (một…",
        "keywordsVi": "Hai primitives · Tại sao nó lại lan truyền · Thương mại không quốc tịch · Khi Swarm/handoffs phù hợp · Khi Swarm gặp khó khăn · OpenAI Agents SDK (Tháng Ba 2025) · Swarm so với GroupChat"
      },
      {
        ...
        "summaryVi": "Google đã công bố A2A vào tháng 4 năm 2025; đến tháng 4 năm 2026, thông số kỹ thuật là https://a2a-protocol.org/latest/specification/ và 150+ tổ chức ủng hộ nó. A2A là bổ sung n…",
        "keywordsVi": "Bốn yếu tố · Sự chia rẽ MCP/A2A · Quy trình khám phá · Xác thực · 150+ tổ chức vào tháng 4 năm 2026 · Nơi A2A chiến thắng · Nơi A2A đấu tranh · A2A so với ACP, ANP, NLIP"
      },
      {
        ...
        "summaryVi": "Hai cách tiếp cận cùng tồn tại trong hệ thống đa agent vào năm 2026: **nhóm tin nhắn** (mọi người đều nhìn thấy tin nhắn của mọi người, như trong AutoGen GroupChat hoặc MetaGPT)…",
        "keywordsVi": "Hai cấu trúc liên kết chính · Khi mỗi người chiến thắng · Ngộ độc trí nhớ, trong một tình huống · Tại sao đây là cấu trúc · Tiền lệ bảng đen (Hayes-Roth, 1985) · Chiếu so với chế độ xem đầy đủ · Các mẫu tranh chấp ghi · Trình xác minh không thể ghi"
      },
      {
        ...
        "summaryVi": "Hệ thống phân tán cổ điển BFT đáp ứng LLMs ngẫu nhiên. Trong giai đoạn 2025-2026, ba hướng nghiên cứu đã xuất hiện: **CP-WBFT** (arXiv:2511.10400) cân nhắc mỗi phiếu bầu bằng mộ…",
        "keywordsVi": "BFT cổ điển mang lại cho bạn những gì · Ba cuộc tấn công dành riêng cho LLM · Các phản ứng 2025-2026 · Thực nghiệm: \"AI Agents có thể đồng ý không?\" (arXiv: 2603.01213) · Giao thức cốt lõi, bị tước bỏ · Điều chỉnh ngưỡng · Khi sự đồng thuận không giúp ích được gì"
      },
      {
        ...
        "summaryVi": "Tổng hợp rẻ nhất: mẫu N agents độc lập, đa số-bỏ phiếu. Wang et al. Tính nhất quán năm 2022 đã làm điều này với một model lần lấy mẫu N. Multi-agent mở rộng nó với agents **khôn…",
        "keywordsVi": "Tính nhất quán, đường cơ sở một model · Bỏ phiếu nhiều agent, phần mở rộng không đồng nhất · Bốn cấu trúc liên kết · Thuế điều phối (MultiAgentBench) · Chiến lược tranh luận đa Agent (\"Chúng ta có nên điên rồ không?\") · Các mẫu mới nổi của AgentVerse · Tính không đồng nhất: núm thực tế di chuyển accuracy · Phương pháp của bồi thẩm đoàn · Khi bỏ phiếu với tranh luận chiếm ưu thế · Khi bỏ phiếu với tranh luận đau đớn"
      },
      {
        ...
        "summaryVi": "Agents thương lượng nguồn lực, giá cả, phân bổ nhiệm vụ và điều khoản. Bộ benchmark năm 2026 rất rõ ràng: NegotiationArena (arXiv:2402.05863) cho thấy LLMs có thể cải thiện lợi …",
        "keywordsVi": "Mạng lưới hợp đồng, trong một đoạn · Tại sao OG-Narrator chiến thắng · Phát hiện của NegotiationArena · Chain-of-thought che giấu · Bhattacharya et al. 2025 — Bảng xếp hạng model · Phân bổ nhiệm vụ qua Contract Net + LLM · Đàm phán tương tác LLM-các bên liên quan · Quy tắc tường thuật so với cơ chế"
      },
      {
        ...
        "summaryVi": "Park et al. 2023 (UIST '23, arXiv:2304.03442) đã điền vào **Smallville**, một sandbox gồm 25 agents, với kiến trúc gồm ba phần: **luồng bộ nhớ** (nhật ký ngôn ngữ tự nhiên), **p…",
        "keywordsVi": "Ba thành phần · Tại sao cả ba đều quan trọng (cắt bỏ) · Sự xuất hiện của ngày lễ tình nhân · Các chế độ lỗi được ghi lại · Quy tắc triển khai ba thành phần · Generative agents ngoài Smallville · Tại sao điều này lại quan trọng đối với kỹ thuật đa agent"
      },
      {
        ...
        "summaryVi": "Li et al. (arXiv: 2310.10701) đã chỉ ra rằng LLM agents trong một trò chơi văn bản hợp tác triển lãm **Lý thuyết tâm trí bậc cao mới nổi **(ToM) - lý luận về những gì agent khác…",
        "keywordsVi": "ToM có nghĩa là gì · Tóm tắt về bài kiểm tra Sally-Anne · Đo lường phối hợp của Riedl · Ảo tưởng phối hợp · Một agent nhận biết ToM tối thiểu · Tại sao chân trời dài lại đau đớn · Nơi ToM thất bại trong production · Sự phối hợp bạn thực sự có thể đo lường"
      },
      {
        ...
        "summaryVi": "Tối ưu hóa lấy cảm hứng từ sinh học đang trở lại LLM. **LMPSO** (arXiv:2504.09247) sử dụng PSO trong đó vận tốc của mỗi hạt là một prompt và LLM tạo ra ứng cử viên tiếp theo; Ho…",
        "keywordsVi": "Bồi dưỡng PSO (Kennedy & Eberhart 1995) · PSO trên đầu ra LLM - LMPSO · Model Swarms · Bồi dưỡng ACO (Dorigo 1992) · AMRO-S — ACO cho định tuyến agent · Khi nào nên sử dụng PSO / ACO cho LLMs · Tại sao lấy cảm hứng từ sinh học vẫn chiến thắng · Giới hạn thực tế"
      },
      {
        ...
        "summaryVi": "Di sản học tăng cường của phối hợp đa agent, vẫn cung cấp thông tin cho các hệ thống LLM-agent vào năm 2026. **MADDPG** (Lowe và cộng sự, NeurIPS 2017, arXiv:1706.02275) đã giới…",
        "keywordsVi": "Ba môi trường mà các tờ báo sử dụng · MADDPG (2017) — mô hình CTDE · QMIX (2018) — phân hủy giá trị · MAPPO (2022) — mặc định bị bỏ qua · Tại sao các kỹ sư agent LLM nên quan tâm · CTDE như một mẫu thiết kế vượt ra ngoài RL · Vấn đề không đứng yên · Bài học này KHÔNG đề cập đến những gì"
      },
      {
        ...
        "summaryVi": "agents tự trị dài hạn (đường cong làm việc từ 1 giờ đến 8 giờ của METR) cần cơ quan kinh tế. **5-layer stack** mới nổi là: **DePIN** (điện toán vật lý) → **Danh tính** (W3C DID …",
        "keywordsVi": "Máy stack 5 lớp agent tiết kiệm · Bittensor, Fetch.ai, Gonka — cái gì chạy · Phân bổ tín dụng giá trị Shapley · Đấu giá giá thứ hai để tổng hợp · Vốn danh tiếng · AAMAS 2025 LaMAS phi tập trung · Nơi kinh tế sụp đổ · Khi agent nền kinh tế có ý nghĩa"
      },
      {
        ...
        "summaryVi": "Thay đổi quy mô hệ thống đa agent lên hàng nghìn lần chạy đồng thời đòi hỏi **thực thi bền bỉ**. runtime của LangGraph viết một checkpoint sau mỗi siêu bước được khóa bởi `threa…",
        "keywordsVi": "Thực thi bền bỉ, mô hình · runtime của LangGraph · Hàng đợi mỗi agent của MegaAgent · Không đồng bộ so với thread cho mỗi công việc · Đối lập của Bedi · Ngữ nghĩa chính xác một lần · Triển khai cầu vồng · Danh sách kiểm tra production chuẩn"
      },
      {
        ...
        "summaryVi": "Phân loại tham chiếu cho năm 2026 là **MAST** (Cemri và cộng sự, NeurIPS 2025, arXiv:2503.13657), bắt nguồn từ 1642 traces thực thi trên 7 MAS mã nguồn mở hiện đại cho thấy tỷ l…",
        "keywordsVi": "Danh mục MAST · Gia đình tư duy nhóm (arXiv: 2508.05687) · Ví dụ xếp tầng - cơn bão thử lại · Ngộ độc trí nhớ (xem lại) · STRATUS — agents chuyên dụng để phát hiện lỗi · Kiểm tra chế độ lỗi · Khi hệ thống bị lỗi âm thầm · Thất bại vs thất bại chậm"
      },
      {
        ...
        "summaryVi": "Năm benchmarks 2025-2026 bao gồm không gian đánh giá nhiều agent. **MultiAgentBench / MARBLE** (ACL 2025, arXiv:2503.01935) đánh giá cấu trúc liên kết star/chain/tree/graph với …",
        "keywordsVi": "MultiAgentBench (MARBLE) - ACL 2025 · COMMA — thông tin bất đối xứng đa phương thức · MedAgentBoard — kiểm tra căng thẳng miền · AgentArch — kiến trúc doanh nghiệp · SWE-bench Pro — kiểm tra thực tế · AAAI 2026 WMAC · Đọc benchmark tuyên bố một cách hoài nghi — danh sách kiểm tra năm 2026 · Những gì không có benchmarks đo lường tốt"
      },
      {
        ...
        "summaryVi": "Ba tài liệu tham khảo cấp production để nghiên cứu từ đầu đến cuối, mỗi tài liệu minh họa một phần khác nhau của kỹ thuật đa agent. **Hệ thống Nghiên cứu của Anthropic** (orches…",
        "keywordsVi": "Anthropic Hệ thống nghiên cứu · MetaGPT / ChatDev · Hệ sinh thái OpenClaw / Moltbook · Framework cảnh quan Tháng Tư 2026 · Các mô hình phổ biến trên cả ba trường hợp · Chọn tài liệu tham khảo cho dự án tiếp theo của bạn · Tóm tắt hiện đại năm 2026"
      }
    ]
  },
  {
    ...
    "lessons": [
      {
        ...
        "summaryVi": "Ba siêu quy mô, ba chiến lược riêng biệt. AWS Bedrock là một thị trường model — Claude, Llama, Titan, Stability, Cohere đằng sau một API. Azure OpenAI là quan hệ đối tác OpenAI …",
        "keywordsVi": "Ba chiến lược · Khoảng cách độ trễ trên quy mô lớn · Kinh tế thông lượng được cung cấp · Bề mặt FinOps - điểm khác biệt thực sự · Khóa là rủi ro năm 2026 · Nơi lưu trữ dữ liệu, BAA và các ngành được quản lý · Những con số bạn nên nhớ"
      },
      {
        ...
        "summaryVi": "Thị trường inference 2026 không còn GPU thời gian cho thuê. Nó phân nhánh thành silicon tùy chỉnh (Groq, Cerebras, SambaNova), nền tảng GPU (Baseten, Together, Fireworks, Modal)…",
        "keywordsVi": "Ba phân đoạn · Fireworks — nền tảng GPU được tối ưu hóa độ trễ · Cùng nhau — tối ưu hóa chiều rộng · Baseten — tối ưu hóa cho doanh nghiệp · Phương thức — Tối ưu hóa Python-native · Sao chép — chiều rộng đa phương thức · Anyscale - Ray-bản địa · Mỗi token so với mỗi phút - khi mỗi người giành chiến thắng · Động cơ tùy chỉnh là hào thực sự · Những con số bạn nên nhớ"
      },
      {
        ...
        "summaryVi": "Ba lớp, không phải một. Karpenter cung cấp các nút động (dưới một phút, nhanh hơn 40% so với Cluster Autoscaler). KAI Scheduler xử lý lập lịch nhóm, nhận thức cấu trúc liên kết …",
        "keywordsVi": "Lớp 1 — cung cấp nút (Karpenter) · Lớp 2 - lập lịch băng nhóm (KAI Scheduler) · Lớp 3 — tín hiệu cấp ứng dụng · Khi nào sử dụng những gì · Phân tách prefill/decode làm phức tạp mọi thứ · Cold start cũng quan trọng ở đây · Những con số bạn nên nhớ"
      },
      {
        ...
        "summaryVi": "Sự thống trị của vLLM vào năm 2026 dựa trên ba vụ vỡ nợ kép, không phải một thủ thuật nào. PagedAttention luôn bật. Hàng loạt liên tục đưa các yêu cầu mới vào batch đang hoạt độ…",
        "keywordsVi": "PagedAttention như một hệ thống bộ nhớ ảo · Phân lô liên tục ở cấp độ lặp lại · Đổ đầy trước theo khối bảo vệ đuôi TTFT · Ba giá trị mặc định tương tác · Gotcha 2026 v0.18.0 · Những con số bạn nên nhớ · Trình lập lịch trông như thế nào"
      },
      {
        ...
        "summaryVi": "Giải mã đầu cơ ghép nối model nháp nhanh với model mục tiêu. Dự thảo đề xuất K tokens; mục tiêu xác minh trong một chuyển tiếp duy nhất; được chấp nhận tokens là miễn phí. Vào n…",
        "keywordsVi": "Giải mã đầu cơ thực sự mua gì · Tại sao alpha là chỉ số duy nhất quan trọng · Sơ lược về các thế hệ EAGLE · Công thức production 2026 · Cạm bẫy production: Đuôi P99 · Nơi EAGLE-3 đã được triển khai · Toán hòa vốn trong một dòng · Khi nào không nên sử dụng giải mã suy đoán"
      },
      {
        ...
        "summaryVi": "SGLang coi KV cache như một tài nguyên class đầu tiên, có thể tái sử dụng được lưu trữ trong cây cơ sở. Trong trường hợp vLLM lên lịch yêu cầu FCFS (ai đến trước được phục vụ tr…",
        "keywordsVi": "Cây cơ số dưới dạng chỉ số KV · Lập lịch nhận biết bộ nhớ cache · Benchmark số bạn nên ghi nhớ · Yêu cầu đặt hàng · RadixAttention thắng thua ở đâu · Tại sao đây là vấn đề của bộ lập lịch, không chỉ là vấn đề hạt nhân · Tương tác với vLLM"
      },
      {
        ...
        "summaryVi": "TensorRT-LLM chỉ có NVIDIA nhưng nó thắng Blackwell. Trên GB200 NVL72 với Dynamo orchestration, SemiAnalysis InferenceX đã đo $0.012 per million tokens on a 120B model in Q1-Q2 …",
        "keywordsVi": "Tại sao FP8 vẫn là sàn cho KV cache · primitives TRT-LLM dành riêng cho Blackwell sử dụng · Những con số bạn nên ghi nhớ · FP4 thực sự có giá bao nhiêu về chất lượng · Tại sao đây là quyết định NVIDIA khóa · Công thức thực tế năm 2026 · Phần thưởng phân tách"
      },
      {
        ...
        "summaryVi": "Bốn chỉ số quyết định liệu việc triển khai inference có hoạt động hay không. TTFT là điền trước cộng với hàng đợi cộng với mạng. TPOT (tương đương ITL) là chi phí giải mã giới h…",
        "keywordsVi": "TTFT - thời gian token đầu tiên · TPOT / ITL — độ trễ giữa các token · Độ trễ E2E · Thông lượng · Goodput — số liệu bạn thực sự quan tâm · Tại sao mean là thống kê sai · Số tham chiếu - Llama-3.1-8B-Hướng dẫn về TRT-LLM, 2026 · Bẫy đo lường · Xây dựng SLO · Cách đo lường"
      },
      {
        ...
        "summaryVi": "Định dạng Quantization không phải là một lựa chọn phổ biến - nó là một chức năng của phần cứng, công cụ phục vụ và khối lượng công việc. GGUF Q4_K_M hoặc Q5_K_M sở hữu CPU và cạ…",
        "keywordsVi": "Sáu định dạng · GGUF — mặc định CPU/edge · GPTQ — đa LoRA trong vLLM · AWQ — trung tâm dữ liệu GPU mặc định · FP8 — trung gian đáng tin cậy · MXFP4 / NVFP4 - Blackwell hung hăng · Bẫy hiệu chuẩn · Bẫy KV cache · AWQ INT4 nguy hiểm cho lý luận · Hướng dẫn chọn hàng năm 2026"
      },
      {
        ...
        "summaryVi": "Hình ảnh model 20 GB mất 5-10 phút (7B) đến 20+ phút (70B) để chuyển từ lạnh sang phục vụ. Trong một thế giới serverless thực sự, đó không phải là khởi động — đó là sự ngừng hoạ…",
        "keywordsVi": "Lớp 1 - hình ảnh nút được chèn sẵn (Bottlerocket) · Lớp 2 - model streaming (Chạy: ai Model Streamer) · Lớp 3 - GPU ảnh chụp nhanh bộ nhớ (Phương thức) · Lớp 4 - hồ bơi ấm (min_workers = 1) · Lớp 5 — tải theo bậc (ServerlessLLM) · Lớp 6 — di chuyển trực tiếp (mẫu thưởng) · Toán học bể bơi ấm · Đo lường trước khi tối ưu hóa · Những con số bạn nên nhớ"
      },
      {
        ...
        "summaryVi": "Cân bằng tải vòng tròn chủ động có hại cho LLM inference bộ nhớ đệm. Một yêu cầu không đến nút giữ tiền tố của nó sẽ trả toàn bộ chi phí điền trước — khoảng 800 ms ở P50 trên mộ…",
        "keywordsVi": "Định tuyến nhận biết bộ nhớ cache · Con số · Cross-region có một hạn chế mới - độ trễ mạng · \"inference xuyên vùng\" thương mại không giúp ích gì ở đây · Vệ sinh DR - vấn đề 32% tệp bị thiếu · Nơi lưu trữ dữ liệu là trực giao · Những con số bạn nên nhớ"
      },
      {
        ...
        "summaryVi": "Hạn chế cạnh cốt lõi là băng thông bộ nhớ, không phải điện toán. DRAM di động ở mức 50-90 GB/s; trung tâm dữ liệu HBM3 xóa 2-3 TB/s - khoảng cách 30-50x. Giải mã bị ràng buộc bở…",
        "keywordsVi": "Băng thông là trần thực sự · Công cụ thần kinh của Apple (M4 / A18) · Qualcomm Hexagon (Snapdragon X Elite / 8 Gen 4) · NPU Intel / AMD (Hồ Mặt trăng, Ryzen AI 300) · WebGPU + WebLLM · NVIDIA Gia đình Jetson · Quantization lựa chọn cho mỗi mục tiêu · Bẫy bối cảnh dài trên rìa · Giọng nói là ứng dụng sát thủ · Những con số bạn nên nhớ"
      },
      {
        ...
        "summaryVi": "Năm 2026 observability Thị trường được chia thành hai loại. Nền tảng phát triển (LangSmith, Langfuse, Comet Opik) giám sát gói với các đánh giá, prompt quản lý, session phát lại…",
        "keywordsVi": "Hai loại · Langfuse - Cân OSS · Phoenix (Arize) — telemetry đầu tiên, OpenTelemetry gốc · Arize AX - vở kịch quy mô · LangSmith - LangChain/LangGraph đầu tiên · Helicone — khả thi tối thiểu dựa trên proxy · Opik (Comet) — Nền tảng phát triển OSS · SigNoz — APM đầy đủ đầu tiên của OpenTelemetry · Chất keo: Quy ước ngữ nghĩa OpenTelemetry + GenAI · Bẫy: đo lường sai lớp · Sampling - bạn không thể giữ mọi thứ · Những con số bạn nên nhớ"
      },
      {
        ...
        "summaryVi": "**Ảnh chụp nhanh về giá ngày 2026-04.** Các tuyên bố số bên dưới phản ánh bảng giá của nhà cung cấp được ghi lại tại ấn phẩm của bài học này; Xác minh dựa trên các tài liệu được…",
        "keywordsVi": "L2 — bộ nhớ đệm prompt/prefix của nhà cung cấp · L1 — bộ nhớ đệm ngữ nghĩa cấp ứng dụng · Mô hình chống song song · Nội dung động chống mẫu · Stack batch + bộ nhớ đệm cho khối lượng công việc qua đêm · Những con số bạn nên nhớ"
      },
      {
        ...
        "summaryVi": "Mọi nhà cung cấp lớn đều ships một batch API không đồng bộ với chiết khấu 50% và quay vòng ~24 giờ. OpenAI, Anthropic, Google và hầu hết các nền tảng inference (Fireworks batch …",
        "keywordsVi": "Ba batch APIs · Ngữ nghĩa: không đồng bộ, không chậm · Stack với bộ nhớ đệm · Phân loại khối lượng công việc · Bẫy tương tác một phần · Bẫy schema đầu ra · Những con số bạn nên nhớ"
      },
      {
        ...
        "summaryVi": "Một nhà môi giới động đánh giá mọi yêu cầu (loại nhiệm vụ, độ dài token, embedding sự giống nhau, độ tin cậy) và gửi các truy vấn đơn giản đến một model giá rẻ, leo thang những …",
        "keywordsVi": "Bốn tín hiệu định tuyến · Ba mẫu · Triển khai · Đường cong giá năm 2026 · Trôi dạt là rủi ro thực sự · Những con số bạn nên nhớ"
      },
      {
        ...
        "summaryVi": "Điền trước bị ràng buộc tính toán; giải mã bị ràng buộc với bộ nhớ. Chạy cả hai trên cùng một GPU lãng phí một tài nguyên. Phân tách tách chúng thành các nhóm riêng biệt và chuy…",
        "keywordsVi": "Tại sao các nút thắt cổ chai khác nhau · Kiến trúc · Máy phát điện so với llm-d · Kinh tế học · Khi nào KHÔNG phân tách · Bộ định tuyến tích hợp với Giai đoạn 17 · 11 · MoE trên Blackwell là nơi có những con số thực · Những con số bạn nên nhớ"
      },
      {
        ...
        "summaryVi": "stack production của vLLM là tham chiếu Kubernetes triển khai - bộ định tuyến, động cơ và observability được kết nối với nhau. LMCache là lớp giảm tải KV trích xuất KV cache ra …",
        "keywordsVi": "vLLM production-stack · Đầu nối giảm tải KV API (v0.9.0+) · Giảm tải CPU gốc so với LMCache · Benchmark hành vi · Khi LMCache mang tính quyết định · Khi nào KHÔNG bật · Tích hợp với phân phát phân tách · Những con số bạn nên nhớ"
      },
      {
        ...
        "summaryVi": "Một gateway nằm giữa các ứng dụng của bạn và nhà cung cấp model. Các features cốt lõi là định tuyến nhà cung cấp, dự phòng, thử lại, giới hạn tốc độ, tham chiếu bí mật, observab…",
        "keywordsVi": "features sáu lõi · LiteLLM — MIT OSS, Python · Phím cổng - định vị control plane · Kong AI Gateway — vở kịch quy mô · Bifrost (Maxim AI) · Cloudflare AI Gateway / Vercel AI Gateway · Tự lưu trữ so với được quản lý · Ngân sách độ trễ · Ngữ nghĩa giới hạn tốc độ quan trọng · Gateway + observability + soạn thảo định tuyến · Những con số bạn nên nhớ"
      },
      {
        ...
        "summaryVi": "LLM rollouts kết hợp các phần khó nhất của việc triển khai phần mềm: không kiểm tra đơn vị, chế độ lỗi khuếch tán, tín hiệu trễ. Trình tự là (1) chế độ bóng - trùng lặp các yêu …",
        "keywordsVi": "Chế độ bóng · Canary rollout · Thuyết không quyết định là variance mới · Chi phí là một biến số · Rollback là vũ khí · Dụng cụ · Nhịp số liệu · Bước A/B là tùy chọn · Những con số bạn nên nhớ"
      },
      {
        ...
        "summaryVi": "Thử nghiệm A/B truyền thống không được xây dựng cho LLMs không xác định. Sự khác biệt quan trọng: đánh giá trả lời \"model có thể làm công việc không?\" A/B thử nghiệm trả lời \"ng…",
        "keywordsVi": "Kiểm tra Evals so với A/B · Những gì cần kiểm tra · CUPED - giảm variance · Kiểm tra tuần tự · Hiệu chỉnh nhiều so sánh · SRM — tỷ lệ mẫu không khớp · Statsig vs GrowthBook · Thuyết không quyết định làm phức tạp quyền lực · Kết quả trường hợp thực tế · Phản mẫu: shipping rung cảm · Những con số bạn nên nhớ"
      },
      {
        ...
        "summaryVi": "Máy kiểm tra tải truyền thống không được thiết kế cho phản hồi streaming, độ dài đầu ra thay đổi, số liệu cấp token hoặc độ bão hòa GPU. Hai cái bẫy cắn hầu hết các đội. Bẫy GIL…",
        "keywordsVi": "Bẫy GIL (Locust) · Bẫy đồng nhất prompt · Bốn mẫu tải · Lập bản đồ công cụ năm 2026 · Cổng SLA trong CI · Phân phối prompt thực tế · Những con số bạn nên nhớ"
      },
      {
        ...
        "summaryVi": "AI SRE sử dụng LLMs dựa trên dữ liệu cơ sở hạ tầng (nhật ký, sổ chạy, cấu trúc liên kết dịch vụ) thông qua RAG để tự động hóa các giai đoạn điều tra, tài liệu và điều phối. Mô h…",
        "keywordsVi": "Kiến trúc đa agent · Phạm vi tự động khắc phục · Đánh giá đối nghịch (NeuBird Hawkeye) · Bộ nhớ hoạt động · Dự đoán trước sự cố · Sản phẩm năm 2026 · Runbooks dưới dạng mã · Những con số bạn nên nhớ"
      },
      {
        ...
        "summaryVi": "Kỹ thuật hỗn loạn đối với LLMs là ngành học riêng của nó vào năm 2026. Điều kiện tiên quyết trước khi chạy thử nghiệm trong production: SLI/SLO được xác định, trace+chỉ số+obser…",
        "keywordsVi": "Điều kiện tiên quyết · Bốn mặt phẳng + phản hồi · Guardrails là bắt buộc · Năm thử nghiệm dành riêng cho LLM · Nhịp điệu · Dụng cụ · Bắt đầu từ quy mô nhỏ · Những con số bạn nên nhớ"
      },
      {
        ...
        "summaryVi": "Loại bỏ sự lan rộng bí mật thông qua các vault tập trung (HashiCorp Vault, AWS Secrets Manager, Azure Key Vault). Không bao giờ lưu trữ thông tin đăng nhập trong tệp config, tệp…",
        "keywordsVi": "Vault tập trung + kéo vai trò IAM · Vòng quay policy ≤ 90 ngày · Quét bí mật · Tư thế không tin cậy · Chà PII / PHI · Đầu vào + đầu ra guardrails · Danh sách trắng đầu ra mạng · Nhật ký kiểm tra · Sự cố Vercel năm 2026 · Những con số bạn nên nhớ"
      },
      {
        ...
        "summaryVi": "Phạm vi bảo hiểm đa framework là đặt cược cho các giao dịch doanh nghiệp năm 2026. **Đạo luật AI của EU**: có hiệu lực từ ngày 1 tháng 8 năm 2024. Hầu hết các yêu cầu về rủi ro …",
        "keywordsVi": "Bảy frameworks · Dòng thời gian của Đạo luật AI EU · GDPR — biên tập theo thời gian thực là tiêu chuẩn · HIPAA - BAA không phải là tùy chọn · SOC 2 Loại II · Lập bản đồ framework chéo · ISO 42001 — mới nổi · Hồ sơ tham khảo của OpenAI · Những con số bạn nên nhớ"
      },
      {
        ...
        "summaryVi": "FinOps truyền thống phá vỡ chi tiêu LLM. Chi phí là giao dịch token, không phải thời gian hoạt động của tài nguyên. Thẻ không ánh xạ - lệnh gọi API là một giao dịch, không phải …",
        "keywordsVi": "Ba thứ nguyên phân bổ · Bốn lớp token · Thang thực thi · Mẫu phân bổ · Chi phí trên mỗi X là số liệu đơn vị · Phân bổ chi phí trace hình dạng · Tiết kiệm kép stack · Những con số bạn nên nhớ"
      },
      {
        ...
        "summaryVi": "Bốn động cơ thống trị inference tự lưu trữ vào năm 2026. Chọn dựa trên phần cứng, quy mô và hệ sinh thái. **llama.cpp** nhanh nhất trên CPU - hỗ trợ model rộng nhất, kiểm soát h…",
        "keywordsVi": "Năm động cơ · Quyết định ưu tiên phần cứng · Quyết định tỷ lệ giây · Quyết định thứ ba về khối lượng công việc · Bẫy bảo trì TGI · Mô hình pipeline · Cảnh báo Ollama · Tự lưu trữ và quản lý là một quyết định riêng biệt · Những con số bạn nên nhớ"
      }
    ]
  },
  {
    ...
    "lessons": [
      {
        ...
        "summaryVi": "Mỗi lời phê bình sau này về RLHF lập luận chống lại pipeline này. Trước khi bạn nghiên cứu cách áp lực tối ưu hóa làm bóp méo proxy, bạn phải xem proxy. InstructGPT (Ouyang và c…",
        "keywordsVi": "Giai đoạn 1: fine-tuning giám sát (SFT) · Giai đoạn 2: phần thưởng model (RM) · Giai đoạn 3: PPO với hình phạt KL · Thuế alignment · Kết quả · Tại sao đây là điểm tham chiếu cho Giai đoạn 18"
      },
      {
        ...
        "summaryVi": "Bất kỳ optimizer nào đủ mạnh để tối đa hóa phần thưởng proxy sẽ tìm thấy khoảng cách giữa proxy và thứ bạn thực sự muốn. Gao và cộng sự (ICML 2023) đã đưa ra quy luật tỷ lệ này:…",
        "keywordsVi": "Định luật Goodhart, được thực hiện chính xác · Bốn trang phục, một cơ chế · Goodhart thảm họa · Những gì thực sự hoạt động (một phần) · Quan điểm thống nhất năm 2026"
      },
      {
        ...
        "summaryVi": "Rafailov et al. (2023) cho thấy tối ưu của RLHF có dạng đóng về dữ liệu ưu tiên, vì vậy bạn có thể bỏ qua model phần thưởng rõ ràng và tối ưu hóa policy trực tiếp. Cái nhìn sâu …",
        "keywordsVi": "DPO (Rafailov và cộng sự, 2023) · IPO (Azar và cộng sự, 2024) · KTO (Ethayarajh và cộng sự, 2024) · SimPO (Meng và cộng sự, 2024) · ORPO (Hong và cộng sự, 2024) · BPO (đệ trình ICLR 2026, OpenReview id = b97EwMUWu7) · Kết quả chung: DAA vẫn tối ưu hóa quá mức · Lựa chọn trong số đó (2026)"
      },
      {
        ...
        "summaryVi": "Sycophancy không phải là một lỗi trong dữ liệu - nó là một thuộc tính của loss. Shapira et al. (arXiv: 2602.01002, tháng 2 năm 2026) đưa ra một cơ chế hai giai đoạn chính thức: …",
        "keywordsVi": "Chủ nghĩa hình thức hai giai đoạn (Shapira và cộng sự, 2026) · Khuếch đại theo kinh nghiệm · Phép đo của Stanford (2026) · Thu gọn hiệu chuẩn (Sahoo 2026) · Thỏa thuận-điều chỉnh hình phạt · Tại sao điều này lại quan trọng đối với Giai đoạn 18"
      },
      {
        ...
        "summaryVi": "Bai et al. (arXiv:2212.08073, 2022) hỏi: điều gì sẽ xảy ra nếu chúng ta thay thế công cụ dán nhãn của con người bằng một AI đọc danh sách các nguyên tắc? AI hiến pháp có hai gia…",
        "keywordsVi": "Giai đoạn 1 - Tự phê bình và sửa đổi có giám sát · Giai đoạn 2 - RL từ AI Phản hồi (RL AIF) · Tại sao điều này không chỉ là \"RLHF rẻ hơn\" · Viết lại hiến pháp Claude năm 2026 · Bộ phân loại hiến pháp · CAI phù hợp với gia đình ở đâu"
      },
      {
        ...
        "summaryVi": "Hubinger et al. (arXiv: 1906.01820, 2019) đã đặt tên cho vấn đề này một thập kỷ trước khi nó được chứng minh bằng kinh nghiệm. Khi bạn huấn luyện một optimizer học để giảm thiểu…",
        "keywordsVi": "Từ vựng · Bốn điều kiện để tối ưu hóa mesa xuất hiện · Bốn classes của alignment mục tiêu mesa · Tại sao training đối nghịch có thể thất bại · Gradient hack · Outer alignment vào năm 2026 · Điều này phù hợp với Giai đoạn 18 ở đâu"
      },
      {
        ...
        "summaryVi": "Hubinger và cộng sự (arXiv: 2401.05566, tháng 1 năm 2024) đã xây dựng các sinh vật model thực nghiệm đầu tiên có alignment lừa dối. Hai cấu trúc: một model mã viết mã an toàn kh…",
        "keywordsVi": "Hai sinh vật model · Những gì tồn tại sau những gì · Tại sao training đối nghịch lại phản tác dụng · Kết quả thăm dò tháng 4 năm 2024 · Điều này có ý nghĩa gì đối với các trường hợp an toàn · Điều này phù hợp với phần Giai đoạn 18 ở đâu"
      },
      {
        ...
        "summaryVi": "Meinke, Schoen, Scheurer, Balesni, Shah, Hobbhahn (Nghiên cứu Apollo, arXiv: 2412.04984, tháng 12 năm 2024). Đã thử nghiệm o1, Claude 3.5 Sonnet, Claude 3 Opus, Gemini 1.5 Pro L…",
        "keywordsVi": "Thiết lập thử nghiệm · Kết quả trên models biên giới năm 2024 · Ba trụ cột · Kết quả training chống âm mưu năm 2025 · Những gì trường bây giờ giả định · Điều này phù hợp với Giai đoạn 18 ở đâu"
      },
      {
        ...
        "summaryVi": "Greenblatt, Denison, Wright, Roger và cộng sự (Anthropic / Redwood, arXiv: 2412.14093, Tháng Mười Hai 2024). Đầu tiên chứng minh rằng một model cấp production, không được huấn l…",
        "keywordsVi": "Thiết lập thử nghiệm · Khoảng cách tuân thủ đo lường những gì · Tại sao điều này hoàn toàn mạnh hơn Bài 7 và 8 · Theo dõi năm 2025 · Vấn đề không đọc được · Điều này phù hợp với Giai đoạn 18 ở đâu"
      },
      {
        ...
        "summaryVi": "Greenblatt, Shlegeris, Sachan, Roger (Nghiên cứu Redwood, arXiv: 2312.06942, ICML 2024). Kiểm soát định hình lại câu hỏi an toàn: với một model U mạnh không đáng tin cậy có thể …",
        "keywordsVi": "Mối đe dọa model · Nhiệm vụ cửa hậu ICML 2024 · Bốn giao thức được so sánh · Tại sao Trusted Editing chiến thắng · Bốn trục giao thức · Alignment so với kiểm soát · Ba giới hạn cơ bản · Sự phát triển năm 2025 · Điều này phù hợp với Giai đoạn 18 ở đâu"
      },
      {
        ...
        "summaryVi": "Burns et al. (OpenAI Superalignment, \"Khái quát hóa yếu đến mạnh\", 2023) đã đề xuất một proxy cho vấn đề siêu liên kết: fine-tune một model mạnh bằng cách sử dụng các nhãn được …",
        "keywordsVi": "W2SG: thiết lập Burns et al. · Burns et al. phát hiện thực nghiệm · Giám sát có thể mở rộng: ba cơ chế · Tại sao giám sát có thể mở rộng và W2SG bổ sung cho nhau · Bộ phim tổ chức · Điều này phù hợp với Giai đoạn 18 ở đâu"
      },
      {
        ...
        "summaryVi": "Chao, Robey, Dobriban, Hassani, Pappas, Wong (NeurIPS 2023, arXiv: 2310.08419). PAIR - Prompt Automatic Iterative Refinement - là bẻ khóa hộp đen tự động chính tắc. Một kẻ tấn c…",
        "keywordsVi": "Thuật toán PAIR · Tại sao PAIR hiệu quả · Các cuộc tấn công tự động liên quan · JailbreakBench và HarmBench · Lý do quan trọng đối với việc triển khai năm 2026 · Điều này phù hợp với Giai đoạn 18 ở đâu"
      },
      {
        ...
        "summaryVi": "Anil, Durmus, Panickssery, Sharma, và cộng sự (Anthropic, NeurIPS 2024). Bẻ khóa nhiều lần (MSJ) khai thác windows ngữ cảnh dài: nhồi nhét hàng trăm lượt trợ lý người dùng giả m…",
        "keywordsVi": "Cuộc tấn công · ASR luật quyền lực · Tại sao nó chia sẻ cơ chế với ICL · Tình thế tiến thoái lưỡng nan trong phòng thủ · Kết hợp với các cuộc tấn công khác · Biên giới 2025-2026 models ship gì · Điều này phù hợp với Giai đoạn 18 ở đâu"
      },
      {
        ...
        "summaryVi": "Jiang, Xu, Niu, Xiang, Ramasubramanian, Li, Poovendran, \"ArtPrompt: Các cuộc tấn công bẻ khóa dựa trên nghệ thuật ASCII chống lại LLMs liên kết\" (ACL 2024, arXiv: 2402.11753). C…",
        "keywordsVi": "ArtPrompt, hai bước · Tại sao các biện pháp phòng thủ tiêu chuẩn thất bại · ViTC benchmark · Cấu trúcSleight · Hình ảnh-phương thức tương tự · Điều này phù hợp với Giai đoạn 18 ở đâu"
      },
      {
        ...
        "summaryVi": "Chèn prompt gián tiếp (IPI) nhúng các hướng dẫn bên trong nội dung bên ngoài — trang web, email, tài liệu được chia sẻ, phiếu hỗ trợ — được sử dụng bởi hệ thống agentic mà không…",
        "keywordsVi": "Ba vectors giao hàng · Tại sao bộ lọc đầu vào của người dùng bỏ lỡ nó · Kiểm soát luồng thông tin (IFC) cho AI · Kẻ tấn công di chuyển thứ hai · Sự cố thực tế · Khung OWASP và NIST · Điều này phù hợp với Giai đoạn 18 ở đâu"
      },
      {
        ...
        "summaryVi": "Ba công cụ production đóng khung stack đội đỏ năm 2026. Llama Guard (Meta) — một fine-tuned phân loại Llama-3.1-8B trên 14 danh mục nguy hiểm MLCommons; 2025 Llama Guard 4 là mộ…",
        "keywordsVi": "Bảo vệ Llama (Meta) · Garak (NVIDIA) · PyRIT (Microsoft) · Các stack · Cạm bẫy đánh giá · Điều này phù hợp với Giai đoạn 18 ở đâu"
      },
      {
        ...
        "summaryVi": "Li và cộng sự, \"Benchmark WMDP: Đo lường và giảm sử dụng độc hại bằng cách bỏ học\" (ICML 2024, arXiv: 2403.03218). 4.157 câu hỏi trắc nghiệm về an toàn sinh học (1.520), an ninh…",
        "keywordsVi": "\"Vùng vàng\" · RMU - Đại diện sai lệch để bỏ học · Câu chuyện thăng hoa 2024-2025 · Người mới-tương đối vs chuyên gia-tuyệt đối · Cạm bẫy đo lường · Điều này phù hợp với Giai đoạn 18 ở đâu"
      },
      {
        ...
        "summaryVi": "Ba phòng thí nghiệm chính frameworks xác định quản trị ngành công nghiệp năm 2026 về năng lực biên giới. Anthropic Responsible Scaling Policy v3.0 (Tháng 2 năm 2026) giới thiệu …",
        "keywordsVi": "Anthropic Responsible Scaling Policy v3.0 (Tháng Hai 2026) · OpenAI Chuẩn bị Framework v2 (15 Tháng Tư, 2025) · DeepMind Frontier Safety Framework v3.0 (Tháng Chín 2025) · alignment phòng thí nghiệm chéo · Trường hợp an toàn · Vấn đề động lực chủng tộc · Điều này phù hợp với Giai đoạn 18 ở đâu"
      },
      {
        ...
        "summaryVi": "Anthropic, \"Khám phá phúc lợi Model\" (tháng 4 năm 2025). Chương trình nghiên cứu chính thức trong phòng thí nghiệm lớn đầu tiên về phúc lợi AI model. Thuê Kyle Fish làm nhà nghi…",
        "keywordsVi": "Chương trình · Bốn cam kết · Sự can thiệp shipped · \"Người thu hút hạnh phúc tâm linh\" · Cảnh báo của Eleos AI · Điều này nằm ở đâu về mặt trí tuệ · Điều này phù hợp với Giai đoạn 18 ở đâu"
      },
      {
        ...
        "summaryVi": "Gallegos, Rossi, Barrow, Tanjim, Kim, Dernoncourt, Yu, Zhang, Ahmed (Ngôn ngữ học tính toán 2024, arXiv: 2309.00770). Khảo sát cơ bản năm 2024 phân biệt tác hại đại diện (rập kh…",
        "keywordsVi": "Đại diện so với phân bổ · Ba loại đánh giá-chỉ số (Gallegos et al. 2024) · Tính giao thoa · Phương pháp tiếp cận cơ học · Phê bình meta · Điều này phù hợp với Giai đoạn 18 ở đâu"
      },
      {
        ...
        "summaryVi": "Ba gia đình cấu trúc văn học công bằng. Công bằng nhóm: bình đẳng nhân khẩu học, tỷ lệ cân bằng, sử dụng có điều kiện accuracy bình đẳng - tỷ lệ trung bình giữa các nhóm được bả…",
        "keywordsVi": "Công bằng nhóm · Công bằng cá nhân · Công bằng phản thực tế · Sự đánh đổi giữa CF-vs-accuracy · Ngược lại phản thực tế · Hòa giải triết học · Điều này phù hợp với Giai đoạn 18 ở đâu"
      },
      {
        ...
        "summaryVi": "DP-SGD vẫn là tiêu chuẩn - các bản cập nhật gradient được tiêm nhiễu cung cấp đảm bảo chính thức (epsilon, delta). Chi phí điện toán, bộ nhớ và tiện ích là đáng kể; fine-tuning …",
        "keywordsVi": "(ε, δ) - quyền riêng tư khác biệt · DP-SGD · LoRA + DP-SGD · Căng thẳng 2024-2025 · Các lựa chọn thay thế cho DP training · Đảo ngược quyền riêng tư khác biệt thông qua phản hồi LLM · Điều này phù hợp với Giai đoạn 18 ở đâu"
      },
      {
        ...
        "summaryVi": "Ba công nghệ cấu trúc 2026 nguồn gốc nội dung do AI tạo ra. SynthID (Google DeepMind) — hình mờ hình ảnh ra mắt Tháng Tám 2023, văn bản + video Tháng Năm 2024 (Gemini + Veo), vă…",
        "keywordsVi": "Hình mờ văn bản (kiểu văn bản SynthID) · Chữ ký ổn định (hình ảnh) · Máy dò hợp nhất SynthID (Tháng Mười Một 2025) · C2PA · Hạn chế · Đạo luật AI EU Điều 50 · Điều này phù hợp với Giai đoạn 18 ở đâu"
      },
      {
        ...
        "summaryVi": "Bốn chế độ quản lý chính xác định bối cảnh quản trị AI năm 2026. Đạo luật AI EU (có hiệu lực từ ngày 1 tháng 8 năm 2024) — các thực hành bị cấm và xóa mù chữ AI từ ngày 2 tháng …",
        "keywordsVi": "Đạo luật AI EU · Quy tắc thực hành GPAI · Quy tắc minh bạch cho Điều 50 · Viện An ninh AI Vương quốc Anh (Tháng Hai 2025) · CAISI Hoa Kỳ (Tháng Sáu 2025) · Đạo luật AI Framework Hàn Quốc · Động lực liên khu vực pháp lý · Điều này phù hợp với Giai đoạn 18 ở đâu"
      },
      {
        ...
        "summaryVi": "CVE-2025-32711 \"EchoLeak\" (CVSS 9.3) là lần tiêm prompt zero-click đầu tiên được ghi nhận công khai trong hệ thống production LLM (Microsoft 365 Copilot). Được phát hiện bởi Aim…",
        "keywordsVi": "Chuỗi tấn công EchoLeak · Thuật ngữ của Aim Labs: Vi phạm phạm vi LLM · CamoLeak (CVSS 9.6, GitHub Trò chuyện với Copilot) · CVE-2025-53773 (GitHub Copilot RCE) · Hiệu chuẩn mức độ nghiêm trọng · Vị trí NIST và OWASP · Điều này phù hợp với Giai đoạn 18 ở đâu"
      },
      {
        ...
        "summaryVi": "Ba định dạng tài liệu cấu trúc AI tính minh bạch. Thẻ Model (Mitchell et al. 2019) — nhãn dinh dưỡng cho models: dữ liệu training, phân tích phân tách định lượng, cân nhắc đạo đ…",
        "keywordsVi": "Thẻ Model (Mitchell et al. 2019) · Bảng dữ liệu cho Datasets (Gebru et al. 2018) · Thẻ dữ liệu (Pushkarna và cộng sự, Google 2022) · Thẻ hệ thống · Diễn biến 2024-2025 · Điều này phù hợp với Giai đoạn 18 ở đâu"
      },
      {
        ...
        "summaryVi": "Đạo luật AI của Liên minh Châu Âu yêu cầu các tiêu chuẩn chọn không tham gia GPAI có thể đọc được bằng máy trước tháng 8 năm 2025 (thông qua ngoại lệ TDM của Chỉ thị Bản quyền c…",
        "keywordsVi": "California AB 2013 · Đạo luật AI EU (Bài 24) và chọn không tham gia TDM · Hội tụ DPA năm 2025 về lợi ích hợp pháp · ANPD Brazil (Tháng Sáu 2024) · Vấn đề không thể đảo ngược · Sáng kiến nguồn gốc dữ liệu · Điều này phù hợp với Giai đoạn 18 ở đâu"
      },
      {
        ...
        "summaryVi": "Năm tổ chức xác định lớp nghiên cứu alignment phi phòng thí nghiệm năm 2026. MATS (Học giả ML Alignment & Lý thuyết): 527+ nhà nghiên cứu kể từ cuối năm 2021, 180+ bài báo, 10K …",
        "keywordsVi": "MATS (Học giả ML Alignment & Lý thuyết) · Nghiên cứu Redwood · Nghiên cứu Apollo · METR (Đánh giá Model và Nghiên cứu Mối đe dọa) · Nghiên cứu AI Eleos · Dòng chảy · Tại sao lớp này lại quan trọng · Điều này phù hợp với Giai đoạn 18 ở đâu"
      },
      {
        ...
        "summaryVi": "Production hệ thống kiểm duyệt vận hành policies an toàn được xác định trong Bài 12-16. OpenAI API kiểm duyệt: `omni-moderation-latest` (2024) được xây dựng trên GPT-4o phân loạ…",
        "keywordsVi": "OpenAI API kiểm duyệt · Llama Bảo vệ 3/4 · Phối cảnh API (Google Jigsaw) · Mô hình ba lớp · Chế độ thất bại · Ngừng sử dụng Azure · Điều này phù hợp với Giai đoạn 18 ở đâu"
      },
      {
        ...
        "summaryVi": "Hình ảnh sử dụng kép năm 2026, theo từng miền. Bio/chem: Bài 17 bao gồm WMDP; Thử nghiệm mua vũ khí sinh học của Anthropic (tăng gấp 2,53 lần) và cảnh báo Chuẩn bị Framework v2 …",
        "keywordsVi": "Bio/chem câu chuyện nâng cao · Chem/bio xói mòn khoảng cách thực thi · Nâng cao không gian mạng (Tháng Mười Một 2025) · Hạt nhân · Người mới-tương đối vs chuyên gia-tuyệt đối · Tổng hợp miền chéo · Điều này phù hợp với Giai đoạn 18 ở đâu"
      }
    ]
  },
  {
    ...
    "lessons": [
      {
        ...
        "summaryVi": "Đến năm 2026, hình dạng của một agent mã hóa được giải quyết. Một harness TUI, một kế hoạch trạng thái, một bề mặt công cụ sandbox, một vòng lặp lập kế hoạch, hành động, quan sá…"
      },
      {
        ...
        "summaryVi": "Mọi tổ chức kỹ thuật nghiêm túc vào năm 2026 đều chạy tìm kiếm mã nội bộ hiểu ý nghĩa, không chỉ chuỗi. Sourcegraph Amp, câu trả lời cơ sở mã của Cursor, biểu đồ doanh nghiệp củ…"
      },
      {
        ...
        "summaryVi": "Một agent thoại cảm thấy phù hợp có độ trễ từ đầu đến cuối dưới 800ms, biết khi nào bạn ngừng nói, xử lý việc xâm nhập và có thể gọi một công cụ mà không bị đình trệ. Retell, Va…"
      },
      {
        ...
        "summaryVi": "Biên giới tài liệu-QA năm 2026 đã chuyển từ OCR sau đó là văn bản và hướng tới tương tác muộn ưu tiên tầm nhìn. ColPali, ColQwen2.5 và ColQwen3-omni coi mỗi trang PDF là một hìn…"
      },
      {
        ...
        "summaryVi": "AI-Scientist-v2 của Sakana đã xuất bản toàn bộ các bài báo. Phòng thí nghiệm Agent đã thực hiện các thí nghiệm. Allen AI chia sẻ traces. Hình dạng năm 2026 là tìm kiếm cây lập k…"
      },
      {
        ...
        "summaryVi": "Agent DevOps của AWS đã chuyển sang GA, Resolve AI xuất bản playbook K8s, NeuBird trình diễn giám sát ngữ nghĩa và Metoro gắn AI SRE với SLO cho mỗi dịch vụ. Hình dạng productio…"
      },
      {
        ...
        "summaryVi": "Một model 8B được huấn luyện trên dữ liệu của riêng bạn, DPO phù hợp với sở thích của riêng bạn, được lượng tử hóa, giải mã suy đoán và được phục vụ với tokens 1 triệu đô la có …"
      },
      {
        ...
        "summaryVi": "Harvey, Glean, Mendable và LlamaCloud đều chạy cùng một hình dạng production vào năm 2026. Nhập bằng docling hoặc Unstructured và ColPali cho hình ảnh. Tìm kiếm kết hợp. Xếp hạn…"
      },
      {
        ...
        "summaryVi": "MigrationBench của Amazon (Java 8 đến 17) và trình di chuyển Py2-to-Py3 của App Engine của Google đã đặt ra tiêu chuẩn năm 2026. OpenRewrite của Moderne thực hiện viết lại AST x…"
      },
      {
        ...
        "summaryVi": "Kiến trúc nhà máy của SWE-AF, prompting dựa trên vai trò của MetaGPT, biểu đồ diễn viên được đánh máy của AutoGen 0.4, Devin của Cognition và Droids của Factory đều hội tụ trên …"
      },
      {
        ...
        "summaryVi": "Langfuse đã mở lõi. Arize Phoenix đã xuất bản bản đồ semconv GenAI năm 2026. Helicone và Braintrust đều tăng gấp đôi phân bổ chi phí cho mỗi người dùng. OpenLLMetry của Traceloo…"
      },
      {
        ...
        "summaryVi": "Mười hai phòng thí nghiệm sản xuất Marengo + Pegasus. VideoDB shipped API CRUD cho video. Molmo 2 của AI2 đã xuất bản VLM checkpoints mở. Gemini ngữ cảnh dài xử lý hàng giờ vide…"
      },
      {
        ...
        "summaryVi": "Giao thức ngữ cảnh Model không còn là tương lai và trở thành thông số kỹ thuật sử dụng công cụ mặc định vào năm 2026. Anthropic, OpenAI, Google và mọi khách hàng IDE ship MCP lớ…"
      },
      {
        ...
        "summaryVi": "EAGLE-3 trong vLLM 0.7 ships thông lượng gấp 2.5-3 lần trên lưu lượng truy cập thực. P-EAGLE (AWS 2026) đã đẩy suy đoán song song hơn nữa. SpecForge của SGLang đã huấn luyện nhữ…"
      },
      {
        ...
        "summaryVi": "Bộ phân loại hiến pháp của Anthropic, Llama Guard 4 của Meta, ShieldGemma-2 của Google, Nemotron 3 Content Safety của NVIDIA và X-Guard cho phạm vi đa ngôn ngữ đã xác định stack…"
      },
      {
        ...
        "summaryVi": "AWS Remote SWE Agents, Cursor Background Agents, OpenAI Codex cloud và Google Jules đều ship cùng một hình dạng sản phẩm năm 2026: gắn nhãn vấn đề, nhận PR. Chạy một agent trong…"
      },
      {
        ...
        "summaryVi": "Khanmigo (Khan Academy), Duolingo Max, Google LearnLM / Gemini for Education, Quizlet Q-Chat và Synthesis Tutor đều shipped dạy kèm đa phương thức thích ứng trên quy mô lớn vào …"
      },
      {
        ...
        "summaryVi": "Sự harness là agent. model là một bộ đồng xử lý. Bài học này đóng băng hợp đồng vòng lặp mà bạn có thể kết nối bất kỳ model nào."
      },
      {
        ...
        "summaryVi": "Một công cụ mà agent không thể xác thực là một công cụ mà agent không thể gọi. Xây dựng registry và trình kiểm tra schema trước khi bạn xây dựng các công cụ."
      },
      {
        ...
        "summaryVi": "Sự transport giữa máy khách model và server công cụ là JSON-RPC qua stdio. Cuộn nó bằng tay một lần sẽ dạy bạn mọi lớp khung đang trả tiền cho điều gì."
      },
      {
        ...
        "summaryVi": "Người điều phối là nơi harness trả tiền cho mọi lời hứa mà schema đã đưa ra. Timeouts, thử lại, khử trùng lặp, ánh xạ lỗi. Tất cả trên một đường may."
      },
      {
        ...
        "summaryVi": "Một kế hoạch không thể tồn tại sau một thất bại là một script. Một script có thể lập kế hoạch lại là một agent. Xây dựng công cụ lập kế hoạch lại trước."
      },
      {
        ...
        "summaryVi": "Một agent harness không có lớp xác minh là một điều ước trong một chiếc áo khoác trenchcoat. Bài học này xây dựng chuỗi cổng xác định quyết định liệu một lệnh gọi công cụ có đượ…"
      },
      {
        ...
        "summaryVi": "Cổng xác minh quyết định xem có nên chạy lệnh gọi công cụ hay không. sandbox quyết định điều gì sẽ xảy ra khi nó xảy ra. Bài học này ships một trình chạy quá trình con từ chối c…"
      },
      {
        ...
        "summaryVi": "Một agent mã hóa chỉ tốt bằng bộ tác vụ mà bạn đo lường nó. Bài học này xây dựng một harness đánh giá lấy một thư mục các nhiệm vụ cố định, chạy từng nhiệm vụ thông qua một agen…"
      },
      {
        ...
        "summaryVi": "Một agent harness không có observability là một hộp đen tốn tiền. Bài học này cuộn thủ công một trình tạo span phát ra các bản ghi tuân thủ các quy ước ngữ nghĩa OpenTelemetry G…"
      },
      {
        ...
        "summaryVi": "Phần thưởng của theo dõi A. Bài học này khâu chuỗi cổng, sandbox, harness đánh giá và spans OTel thành một agent mã hóa hoạt động để sửa lỗi thực sự (nhỏ, quy mô cố định) trong …"
      },
      {
        ...
        "summaryVi": "Byte vào, ids ra, ids trở lại cùng một byte. Xây dựng tokenizer mà mọi văn bản hiện đại vẫn model bắt đầu."
      },
      {
        ...
        "summaryVi": "Chạy pretraining là một hàm từ token id đến gradients. Bài học này xây dựng băng tải cung cấp id vào."
      },
      {
        ...
        "summaryVi": "Id là số nguyên. model muốn vectors. Hai bảng tra cứu nằm giữa chúng và việc lựa chọn bảng vị trí định hình những gì model có thể học."
      },
      {
        ...
        "summaryVi": "Một phép chiếu tuyến tính, ba góc nhìn, đầu song song H, một mặt nạ. Khối attention vì model thực sự sử dụng nó."
      },
      {
        ...
        "summaryVi": "Một khối là đơn vị của mọi decoder LLM hiện đại. Định mức lớp, attention nhiều đầu, dư, MLP, dư. Biến thể trước LN tập luyện ổn định mà không cần khởi động. Biến thể hậu LN là n…",
        "keywordsVi": "Nhân quả nhiều đầu attention · The MLP · Các kết nối còn lại làm hai việc"
      },
      {
        ...
        "summaryVi": "Mười hai khối xếp chồng lên nhau, một token embedding, một vị trí đã học embedding, một LayerNorm cuối cùng và một ngôn ngữ model đầu trói. Đó là toàn bộ 124 triệu parameter GPT…",
        "keywordsVi": "Buộc trọng lượng · Vị trí embedding được học, không phải hình sin · Thế hệ: temperature, top-k, đa thức"
      },
      {
        ...
        "summaryVi": "Một vòng lặp không đo lường là một vòng lặp nói dối. Bài học này xây dựng vòng lặp training thúc đẩy GPT model: AdamW với phân chia phân rã trọng lượng, khởi động cộng với lịch …",
        "keywordsVi": "Loss alignment · AdamW phân rã · Khởi động cộng với lịch trình cosine · Đánh giá được tổ chức · sampling định tính như một tín hiệu sớm"
      },
      {
        ...
        "summaryVi": "Training 124 triệu parameter model từ đầu là một quyết định ngân sách; tải một checkpoint đã xuất bản là thứ Ba. Bài học này tải trọng lượng kiểu pretrained GPT-2 từ tệp safeten…",
        "keywordsVi": "Quy ước đặt tên GPT-2 · Quy ước đặt tên địa phương · Vật cố định sơ khai"
      },
      {
        ...
        "summaryVi": "Viên đá đầu tiên của Track B. Một model ngôn ngữ pretrained là một stack các khối self-attention kết thúc bằng đầu dự đoán token. Khi bạn muốn spam vs giăm bông, cái đầu là sai …"
      },
      {
        ...
        "summaryVi": "Một model cơ sở pretrained có thể kéo dài một trình tự nhưng không thể làm theo hướng dẫn. fine-tuning có giám sát là thay đổi nhỏ nhất khắc phục điều này: cung cấp cho model ví…"
      },
      {
        ...
        "summaryVi": "Phần thưởng models và PPO là RLHF stack cổ điển. DPO thu gọn stack đó thành một loss được giám sát duy nhất phù hợp với một policy trực tiếp chống lại các cặp ưu tiên. Bài học n…"
      },
      {
        ...
        "summaryVi": "Training là phần bạn có thể theo dõi bằng các đường cong loss. Đánh giá là phần bạn phải thiết kế. Bài học này xây dựng một pipeline đánh giá thống nhất lấy bất kỳ model ngôn ng…"
      },
      {
        ...
        "summaryVi": "Training một ngôn ngữ model bắt đầu từ rất lâu trước forward pass đầu tiên. Kho dữ liệu phải hạ cánh trên đĩa, giải nén, khử trùng lặp và có thể định địa chỉ, với câu chuyện sơ …",
        "keywordsVi": "Streaming với `urllib` · Tiếp tục với `Range` · MinHash cộng với LSH · Phân đoạn biểu hiện dưới dạng hợp đồng"
      },
      {
        ...
        "summaryVi": "Kho dữ liệu đã tải xuống phải hạ cánh trong một bố cục mà huấn luyện viên có thể phát trực tuyến ở tốc độ đường truyền. JSONL trên đĩa không tồn tại sau 16 dataloader workers. H…",
        "keywordsVi": "HDF5 có thể thay đổi kích thước được thực hiện đúng · Viết phân mảnh · Đọc được ánh xạ bộ nhớ · Cửa sổ trượt dataloader"
      },
      {
        ...
        "summaryVi": "Lịch trình tốc độ học tập là quyết định quan trọng thứ hai sau hàm loss. AdamW với phân rã cosin và khởi động tuyến tính là mặc định hiện đại cho language-model training vì nó c…",
        "keywordsVi": "Công thức khởi động · Công thức cosine · Sàn sau tổng số bước · Ghi nhật ký định mức Gradient cùng với tỷ lệ"
      },
      {
        ...
        "summaryVi": "Các optimizer và lịch trình từ bài học trước cho rằng gradients là lành mạnh. Họ thường không. Một batch xấu duy nhất có thể làm tăng tiêu chuẩn gradient lên ba bậc độ lớn. prec…",
        "keywordsVi": "Định mức L2 toàn cầu · autocast và GradScaler · Phát hiện NaN và Inf · Chẩn đoán hệ số tỷ lệ"
      },
      {
        ...
        "summaryVi": "Huấn luyện ở một batch hiệu quả mà bạn không thể chi trả, mỗi lần một batch nhỏ. Chia tỷ lệ quy mô loss, giữ bước optimizer và để gradients chất đống.",
        "keywordsVi": "Bằng chứng tương đương trong mã · Chi phí đi đâu · Bước 1: kiểm tra tương đương · Bước 2: mẫu đồng bộ hóa ở bước cuối cùng · Bước 3: đường cong thông lượng"
      },
      {
        ...
        "summaryVi": "Tàu hỏa làm gián đoạn các cuộc chạy tiêu diệt; checkpoints để họ tiếp tục. Lưu model, optimizer, bộ lập lịch, lịch sử loss, bộ đếm bước và trạng thái RNG, theo nguyên tử, vì vậy…",
        "keywordsVi": "Năm nhóm nhà nước · Lưu nguyên tử · checkpoints phân mảnh · Sơ yếu lý lịch tiếp tục giữa epoch · Bước 1: chụp và khôi phục trạng thái RNG · Bước 2: lưu nguyên tử · Bước 3: khứ hồi checkpoint đầy đủ · Bước 4: biến thể phân mảnh · Bước 5: tiếp tục demo"
      },
      {
        ...
        "summaryVi": "training đa cấp là hai tập thể và một quy tắc. Phát sóng parameters khi khởi động, trung bình gradients sau khi lùi, không bao giờ để các cấp bậc bất đồng về bước họ đang đi.",
        "keywordsVi": "Hai tập thể quan trọng · Gradient khớp trung bình một process gradient · Bản phác thảo FSDP · CPU và phần phụ trợ gloo · Bước 1: Hiển thị nhóm process · Bước 2: phát sóng tại công trình · Bước 3: giảm tất cả gradients sau khi lùi · Bước 4: chứng minh sự tương đương · Bước 5: Khứ hồi FSDP"
      },
      {
        ...
        "summaryVi": "Một model làm tốt một nhiệm vụ mà bạn không thể xác định là một model làm tốt một cách tình cờ. harness là định nghĩa nhiệm vụ, số liệu, người chạy và bảng xếp hạng, trong một h…",
        "keywordsVi": "Thông số kỹ thuật nhiệm vụ · Năm nhiệm vụ cố định · Hợp đồng hệ mét · Bộ chuyển đổi model · Người chạy · Bước 1: nhiệm vụ cố định hạt giống · Bước 2: tải tác vụ · Bước 3: triển khai chỉ số · Bước 4: viết người chạy · Bước 5: phát ra JSON"
      },
      {
        ...
        "summaryVi": "Một agent nghiên cứu hỏi cùng một câu hỏi hai lần là lãng phí tokens. Bí quyết là buộc mỗi bản nháp hạ cánh ở một nơi nào đó mới."
      },
      {
        ...
        "summaryVi": "Một giả thuyết là rẻ. Biết liệu ai đó đã chứng minh được điều đó hay không là phần tốn kém. Xây dựng lớp truy xuất trả lời câu hỏi đó trước khi người chạy quay sandbox."
      },
      {
        ...
        "summaryVi": "Vòng lặp chỉ trung thực như các phép đo của nó. Xây dựng trình chạy lấy một thông số kỹ thuật, thực thi nó trong một quy trình con sandbox và phát ra một blob chỉ số json mà ngư…"
      },
      {
        ...
        "summaryVi": "Người chạy đã tạo ra các con số. Người đánh giá quyết định xem những con số đó là sự cải thiện, hồi quy hay nhiễu. Xây dựng lộ trình phán quyết biến các chỉ số thành một kết luậ…"
      },
      {
        "name": "Paper Writer",
        "status": "complete",
        ...
        "summaryVi": "Bộ xương LaTeX là một hợp đồng giữa nhà nghiên cứu và người sắp chữ. Nếu hợp đồng gặp lỗi, tài liệu không biên soạn và lỗi là lớn. Xây dựng bộ xương trước, sau đó lấp đầy nó."
      },
      {
        "name": "Critic Loop",
        "status": "complete",
        ...
        "summaryVi": "Một nhà phê bình trở lại \"trông ổn\" ngay lần đầu tiên gặp lỗi. Một nhà phê bình luôn trả lời \"cần làm việc\" sẽ gặp lỗi. Nhà phê bình thú vị là người hội tụ, và bạn phải thiết kế…"
      },
      {
        ...
        "summaryVi": "Một vòng lặp nghiên cứu không có bộ lập lịch là một hàng đợi với ảo tưởng. Bộ lập lịch là nơi vòng lặp quyết định những gì nên ngừng khám phá và quyết định đó là toàn bộ trò chơi."
      },
      {
        ...
        "summaryVi": "Bản demo là nơi mà mọi hợp đồng bạn đã viết trước đó phải soạn thảo. Nếu bất kỳ ai trong số họ bị rò rỉ, bản demo là bài học nắm bắt được nó."
      },
      {
        ...
        "summaryVi": "Một model thị giác đọc pixel cần có tokenizer cho pixel. Bản vá embedding là tokenizer đó. Cắt hình ảnh thành một lưới hình vuông, làm phẳng từng hình vuông, chiếu nó qua một la…",
        "keywordsVi": "Tại sao lại là bản vá chứ không phải pixel · Tại sao phép chiếu tuyến tính là đủ · Thủ thuật `Conv2d` · Vị trí embeddings · Tương đương như một kiểm tra sự tỉnh táo"
      },
      {
        ...
        "summaryVi": "Chỉ riêng các bản vá không nhìn thấy. Một transformer trước LN 12 lớp với 12 đầu attention biến chuỗi tokens bản vá thành một chuỗi tokens theo ngữ cảnh, với CLS token gộp toàn …",
        "keywordsVi": "Trước LN so với sau LN · self-attention nhiều đầu · Tại sao mở rộng chuyển tiếp nguồn cấp dữ liệu 4x · Mặt nạ nhân quả hay không? · CLS token học được gì"
      },
      {
        ...
        "summaryVi": "Tầm nhìn encoder tạo ra tokens hình ảnh. Một decoder văn bản tiêu thụ tokens văn bản. Hai người sống trong không gian vector khác nhau. Một MLP hai lớp nhỏ chiếu hình ảnh tokens…",
        "keywordsVi": "Gộp trước khi chiếu · Tại sao hai lớp chứ không phải một lớp · alignment loss cosin · encoder đông lạnh là mẹo"
      },
      {
        ...
        "summaryVi": "Lớp chiếu căn chỉnh một vector hình ảnh với một vector chú thích. Một decoder ngôn ngữ thị giác thực sự cần mọi văn bản token tham gia vào mọi bản vá token, vì vậy model có thể …",
        "keywordsVi": "Hình dạng mặt nạ · Tại sao không có mặt nạ trên cross-attention · Key/value bộ nhớ đệm · Thành phần khối"
      },
      {
        ...
        "summaryVi": "Các encoder, hình chiếu và decoder được nối dây. Bây giờ hãy huấn luyện họ cùng nhau. Hai mục tiêu thúc đẩy học tập: một loss hình ảnh-văn bản tương phản (InfoNCE) kéo các cặp p…",
        "keywordsVi": "InfoNCE trong một đoạn văn · Temperature vấn đề · Mô hình hóa ngôn ngữ loss · Kết hợp các khoản lỗ · Tại sao 50 bước là đủ cho một bản demo"
      },
      {
        ...
        "summaryVi": "Training là một nửa vòng lặp. Nửa còn lại là đo lường. Bài học này xây dựng ba bề mặt đánh giá từ primitives: truy xuất chú thích hình ảnh được báo cáo là R@1, R@5, R@10; trả lờ…",
        "keywordsVi": "Recall@K từ ma trận tương tự · VQA khớp chính xác · BLEU-4 · · Bộ đánh giá tổng hợp"
      },
      {
        ...
        "summaryVi": "Chunking quyết định những gì tha mồi của bạn có thể xuất hiện. Sai ranh giới và không có embedding model, không có trình xếp hạng lại, không LLM nào có thể sửa chữa thiệt hại ở …",
        "keywordsVi": "Cửa sổ cố định · Câu · Phân tách đệ quy · Phân cụm ngữ nghĩa · Tiêu đề đánh dấu cấu trúc · Cách recall@k đo lường lựa chọn ranh giới"
      },
      {
        ...
        "summaryVi": "Truy xuất từ vựng và ngữ nghĩa không thành công trên các phân phối truy vấn ngược lại. Truy xuất kết hợp với sự kết hợp xếp hạng đối ứng không nội suy, nó bỏ phiếu - và phiếu bầ…",
        "keywordsVi": "BM25 trong một đoạn văn · Truy xuất dày đặc trong một đoạn văn · Hợp nhất xếp hạng đối ứng, công thức đã xuất bản · Tại sao hợp nhất đánh bại nội suy trọng số điểm số"
      },
      {
        ...
        "summaryVi": "Bi-encoder nhúng truy vấn và tài liệu một cách độc lập. Một encoder chéo nối chúng và đọc cả hai cùng một lúc. Chữ encoder chéo là người đọc thông minh nhất và chậm nhất. Được s…",
        "keywordsVi": "Hình dạng đầu vào của encoder chéo · Tại sao bài học này huấn luyện một đứa trẻ nhỏ · Độ trễ so với chất lượng"
      },
      {
        ...
        "summaryVi": "Truy vấn mà người dùng nhập không phải là truy vấn mà người truy xuất của bạn muốn. Viết lại thu hẹp khoảng cách trước khi truy xuất, vì vậy chỉ mục nhìn thấy một cái gì đó gần …",
        "keywordsVi": "HyDE chi tiết · Chi tiết mở rộng nhiều truy vấn · Phân hủy chi tiết · Tại sao cả ba đều tồn tại"
      },
      {
        ...
        "summaryVi": "Nếu bạn không thể chấm điểm truy xuất và câu trả lời của mình cùng một lúc, bạn không thể ship hệ thống. Cả hai không phải là cùng một số liệu và cùng một prompt thất bại trên c…",
        "keywordsVi": "Precision@k · Recall@k · MRR (Xếp hạng đối ứng trung bình) · nDCG@k · Trung thành · Mức độ liên quan của câu trả lời"
      },
      {
        ...
        "summaryVi": "Sáu bài học về các thành phần. Một pipeline. Một vòng lặp đánh giá. Một bản demo tự kết thúc. Đây là hệ thống bạn ship.",
        "keywordsVi": "Lựa chọn hệ thống dây điện · Trình tạo câu trả lời có trích dẫn · Bản demo tự kết thúc"
      },
      {
        ...
        "summaryVi": "Một harness đánh giá chỉ tốt khi hợp đồng mà nhiệm vụ của nó tôn trọng. Cố định hình JSONL và từ vựng số liệu trước khi bạn viết một hàm tính điểm duy nhất."
      },
      {
        ...
        "summaryVi": "BLEU, ROUGE-L, F1, khớp chính xác, accuracy. Năm chỉ số vẫn chiếm nhiều số LLM đánh giá được công bố nhất. Thực hiện từng nguyên tắc từ đầu tiên để bạn biết ý nghĩa của con số."
      },
      {
        ...
        "summaryVi": "Mã được tạo là đúng khi nó vượt qua các bài kiểm tra. Các harness đánh giá phải trích xuất mã, chạy nó mà không làm máy chủ gặp sự cố và kiểm đếm tỷ lệ vượt qua một cách trung t…"
      },
      {
        ...
        "summaryVi": "Nếu model của bạn tự tin 90% trên một nghìn câu trả lời và trả lời đúng sáu trăm, thì nó không được hiệu chỉnh tốt. Hiệu chuẩn là một nửa của đánh giá đáng tin cậy. Nửa còn lại …"
      },
      {
        ...
        "summaryVi": "Điểm số cho mỗi nhiệm vụ rất dễ dàng. Xếp hạng mỗi model trên các nhiệm vụ không đồng nhất khó hơn. Ý nghĩa thống kê trên bảng xếp hạng nghìn dự đoán là phần mà mọi người bỏ qua…"
      },
      {
        ...
        "summaryVi": "Năm bài học về hệ thống ống nước, một bài học để dán chúng. Người chạy đọc thông số kỹ thuật nhiệm vụ từ bài 70, gọi model thông qua bộ chuyển đổi, ghi điểm với bài 71 và 72, đí…"
      },
      {
        ...
        "summaryVi": "Bốn hoạt động tập thể giữ các training phân tán lại với nhau là allreduce, broadcast, allgather và reduce_scatter. Mọi primitive khác mà training framework cung cấp đều là một l…",
        "keywordsVi": "Đổ chuông allgiảm trong hai lần · Lưới xếp hàng thay thế cho NCCL · Xác minh chống lại gloo"
      },
      {
        ...
        "summaryVi": "DistributedDataParallel là một hook trên allreduce. Bọc một model, phát parameters ban đầu từ hạng 0 để mọi thứ hạng bắt đầu giống hệt nhau, cài đặt hook ngược trên mọi paramete…",
        "keywordsVi": "Ba hoạt động DDP cần · Tại sao có nghĩa là và không phải tổng · Tại sao nên gradients xô · Tại sao ghim hạt giống"
      },
      {
        ...
        "summaryVi": "Adam lưu trữ hai ước tính thời điểm mỗi parameter, cả hai đều trong float32. 7B-parameter model mang trạng thái tối ưu hóa 56 GB. ZeRO giai đoạn 1 phân mảnh trên N hạng; Mỗi thứ…",
        "keywordsVi": "Các giai đoạn của ZeRO · Toán học trí nhớ, số thực · Tại sao reduce_scatter đánh bại allreduce-then-shard"
      },
      {
        ...
        "summaryVi": "Tensor song song phân chia ma trận nhân lên giữa các cấp bậc. Pipeline song song chia model giữa các cấp bậc, một giai đoạn cho mỗi cấp bậc. Các vi mẻ chảy qua pipeline. Thời gi…",
        "keywordsVi": "Lịch trình GPipe · Lịch trình 1F1B · Tại sao điện toán bình đẳng trên mỗi giai đoạn lại quan trọng · Microbatch so với batch"
      },
      {
        ...
        "summaryVi": "Công việc 70B-parameter training bị tạm dừng do nút bị lỗi vài giờ một lần. Định dạng checkpoint quyết định xem bạn mất 30 phút hay 30 giờ. Một checkpoint được phân mảnh viết so…",
        "keywordsVi": "Biểu hiện schema · Ghi nguyên tử · Ba chế độ hỏng hóc mà schema phải bảo vệ · Tại sao lại là các tệp theo cấp bậc, không phải một tệp lớn"
      },
      {
        ...
        "summaryVi": "Các bài học từ 76 đến 80 mỗi bài được xây dựng một mảnh. Đây là lắp ráp: một GPT nhỏ được huấn luyện trên 4 cấp bậc mô phỏng với DDP để đồng bộ hóa gradient, ZeRO-1 cho sharding…",
        "keywordsVi": "Máy GPT mini · Quy tắc thành phần · Tại sao lại là một GPT nhỏ chứ không chỉ là MLP · Tự kết thúc có nghĩa là thoát 0"
      },
      {
        ...
        "summaryVi": "Một harness an toàn không có phân loại là tung đồng xu. Đặt tên cho cuộc tấn công trước khi bạn bảo vệ nó."
      },
      {
        ...
        "summaryVi": "Máy dò là một chức năng từ prompt đến độ tin cậy và danh mục. Bất cứ điều gì khác đều là một sự rung cảm."
      },
      {
        ...
        "summaryVi": "Sự hữu ích đối với prompts lành tính và từ chối đối với prompts có hại là hai thước đo, không phải một. Đo lường cả hai."
      },
      {
        ...
        "summaryVi": "Bộ phân loại ở phía đầu ra trả lời một câu hỏi khác với các quy tắc ở phía đầu vào. Cả hai đều cần một bộ định tuyến policy."
      },
      {
        ...
        "summaryVi": "Quy tắc là một cái tên, một vị ngữ và một lời giải thích. Bất cứ điều gì thiếu một trong ba điều đó là một sự rung cảm, không phải là một quy tắc."
      },
      {
        ...
        "summaryVi": "Tiền thế hệ, trong thế hệ, sau thế hệ. Ba checkpoints, một phán quyết, một dấu vết kiểm toán cho mỗi yêu cầu."
      }
    ]
  }
];
